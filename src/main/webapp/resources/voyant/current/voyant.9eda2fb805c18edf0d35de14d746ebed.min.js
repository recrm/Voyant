...
this.tx,this.y+this.ty);f.rotate(this.rotation);f.fillText(this.text,0,0);f.restore()}};function WordController(a){function b(q){for(var u=Math.log(10*q.relativeSize)*Math.LOG10E,x=(u+q.relativeSize)/2,z=0,H=0;H<q.text.length;H++){var I=q.text.charAt(H);z="f"==I||"i"==I||"j"==I||"l"==I||"r"==I||"t"==I?z+u/3:"m"==I||"w"==I?z+u/(4/3):z+u/1.9}return x*z}function c(){p.sort(function(q,u){return q.origSize>u.origSize?-1:q.origSize<u.origSize?1:0})}function d(){for(var q=0;q<p.length;q++){var u=p[q];var x=u;var z=f.sizeAdjustment;z*=b(x);x=(Math.sqrt(6)*Math.sqrt(6*Math.pow(x.text.length,
...
(x=90,u.ty=0):(x=-90,u.ty=u.height,u.tx=u.width));u.size=Math.max(u.height,u.width);u.rotation=Math.PI/180*x;g.context.fillStyle=g.canvas.style.backgroundColor;g.context.fillRect(0,0,g.canvas.width,g.canvas.height);u.draw(g.context);x=g.context.getImageData(u.x,u.y,u.width,u.height);z=[];for(var H=0;H<u.width;H++){var I=Math.floor(H/f.COARSENESS)*f.COARSENESS;null==z[I]&&(z[I]={});for(var F=0;F<u.height;F++){var K=Math.floor(F/f.COARSENESS)*f.COARSENESS;var G=4*(H+F*x.width);G=[x.data[G],x.data[G+
1],x.data[G+2],x.data[G+3]];"rgb("+G[0]+", "+G[1]+", "+G[2]+")"!=g.canvas.style.backgroundColor&&(z[I][K]=!0);z[I][K]&&(F=K+f.COARSENESS)}}u.mask=z}}function e(){g.clear();for(var q=p.length;q--;){var u=p[q];u.alpha=1;u.live&&u.draw(g.context)}q=$(g.canvas);if(null!=n){q.css("cursor","pointer");g.context.save();g.context.textBaseline="alphabetic";g.context.font="12px Arial";u=g.context.measureText(n.text).width;var x=g.context.measureText(n.value).width;u=(u>x?u:x)+20;x=r+15;var z=w+25,H=q.width();
q=q.height();x+u>=H&&(x-=u);z+40>=q&&(z-=40);g.context.fillStyle="rgba(255,255,255,0.9)";g.context.strokeStyle="rgba(100,100,100,0.9)";g.context.translate(x,z);g.context.fillRect(0,0,u,40);g.context.strokeRect(0,0,u,40);g.context.fillStyle="rgba(0,0,0,0.9)";g.context.fillText(n.text+":",8,18);g.context.fillText(n.value,8,30);g.context.restore()}else q.css("cursor","default")}var f=this,g=a;this.CIRCLE=0;this.ratio=1;var h=this.CIRCLE;this.getLayout=function(){return h};this.setLayout=function(q){h=
q};this.HORIZONTAL=0;var k=this.MIXED=1;this.getWordOrientation=function(){return k};this.setWordOrientation=function(q){k=q};this.UPDATE_RATE=25;this.COARSENESS=5;this.grid=[];var l=0,m;this.doingArrange=!1;this.wordsToArrange=5;var n=null,r=0,w=0,p=[];this.getWords=function(){return p};this.setWords=function(q){p=q};this.sizeAdjustment=100;this.minFontSize=12;this.largestWordSize=0;this.smallestWordSize=1E4;var v={};this.addWords=function(q){for(var u=!1,x=0;x<q.length;x++){var z=q[x];var H=null==
z.color||""==z.color?g.colors[Math.floor(Math.random()*g.colors.length)]:z.color;var I=null==z.size||""==z.size?Math.floor(40*Math.random()):parseFloat(z.size);var F=z.word,K=z.label,G=z.value;z=!1;null==v[F]&&(v[F]=!0,I>f.largestWordSize&&(f.largestWordSize=I,z=!0),I<f.smallestWordSize&&(f.smallestWordSize=.8*I,z=!0),F=new Word(F,I,H,K,G),p.push(F));u=z||u}c();this.setRelativeSizes();this.calculateSizeAdjustment();u?this.resizeWords():d()};this.resetWordCoordinates=function(){g.clear();clearTimeout(m);
...
function(){clearTimeout(m);g.clear();this.toggleLoadingText();if(0<p.length){var q=function(I,F,K){for(var G=0;G<K.width;G+=this.COARSENESS)for(var D=0;D<K.height;D+=this.COARSENESS)K.mask[G]&&K.mask[G][D]&&(this.grid[G+I]||(this.grid[G+I]=[]),this.grid[G+I][D+F]=K)},u=function(I){I.alpha+=.25;I.draw(g.context)},x=function(I,F,K,G){q(I,F,K);K.x=I;K.y=F;K.live=!0;G&&K.draw(g.context)},z=function(I,F,K,G,D){for(var L=0;L<=G;L+=this.COARSENESS)for(var N=0;N<=K;N+=this.COARSENESS)if(D[L]&&D[L][N]&&null!=
this.grid[L+I]&&null!=this.grid[L+I][N+F])return!0;return!1},H=function(){var I=this.wordsToArrange-1,F=g.canvas.width,K=g.canvas.height,G=.5*F,D=.5*K;do{var L=p[l];if(void 0!==L){for(var N=Math.random()*Math.PI,B=.25*Math.random()*L.size,O=.5*(Math.random()-.5),M=.5*L.width,A=.5*L.height;;){var E=Math.floor((G+Math.cos(N)*B*this.ratio-M)/this.COARSENESS)*this.COARSENESS;var J=Math.floor((D+Math.sin(N)*B-A)/this.COARSENESS)*this.COARSENESS;var P=E+M>=F||J+A>=K?!0:z(E,J,L.height,L.width,L.mask);if(!P)break;
N+=O;B+=.05}x(E,J,L);if(g.useFadeEffect)for(E=L.alpha=0;E<l;E++)J=p[E],1>J.alpha&&u(J);else L.alpha=1,L.draw(g.context)}l++;if(l>=p.length){clearTimeout(m);this.doingArrange=!1;this.toggleLoadingText(!1);e();break}}while(I--)};this.grid=[];l=0;H=H.createDelegate(this);z=z.createDelegate(this);x=x.createDelegate(this);u=u.createDelegate(this);q=q.createDelegate(this);this.doingArrange=!0;m=setInterval(H,50)}else alert("Error: There are no words to arrange.")};this.toggleLoadingText=function(q){g.context.save();
...
v=function(B){return doubletree.fieldText(B,"POS")},q=function(B){return"rgba(255,255,255,1)"},u=function(B){return"rgba(255,255,255,1)"},x=function(B){return"red"},z={node:{fill:"white",stroke:"steelblue","stroke-width":"1.5px"},branch:{stroke:"#aaa","stroke-width":"1.5px"}},H=!1,I=d3.dispatch("idsUpdated");I.on("idsUpdated",function(){this==G?(D.setIds(G.continuationIDs),D.updateContinuations()):this==D&&(G.setIds(D.continuationIDs),G.updateContinuations())});var F,K,G,D,L,N;e.init=function(B){d3.select(d3.selectAll(B)).call(this);
return e};e.redraw=function(){void 0!==F&&void 0!==K&&e.setupFromTries(F,K);return e};e.setupFromTries=function(B,O){F=B.getUniqRoot();K=O.getUniqRoot();var M=F.toTree(l.left),A=K.toTree(l.right);B=!0;0<Object.keys(A.pruned).length&&(a(A,A.pruned,B),a(M,A.pruned,B),B=!1);0<Object.keys(M.pruned).length&&(a(M,M.pruned,B),a(A,M.pruned,B));B={};for(var E in A.info)"continuations"!=E&&"ids"!=E&&"count"!=E&&(B[E]=A.info[E]);B["right continuations"]=A.info.continuations;B["left continuations"]=M.info.continuations;
B.ids={};c(B.ids,A.info.ids);c(B.ids,M.info.ids);B.count=Object.keys(B.ids).length;L=Object.keys(B.ids);if(A.info.origIDs||M.info.origIDs)B.origIDs={},c(B.origIDs,A.info.origIDs),c(B.origIDs,M.info.origIDs),B.origCount=Object.keys(B.origIDs).length;A.info=B;M.info=B;E=Math.max(M.maxChildren,A.maxChildren);if(isNaN(E)||0==E)return H=!1,e;r?N=d3.scaleLog().range([8,14]):(N=function(){return 14},N.domain=function(){});N.domain([Math.min(M.minCount,A.minCount),M.info.count]);var J=g-20-20,P=h-20-20;f.forEach(function(Q,
C){C=d3.select(Q).select("svg");null==C.node()?(C=d3.select(Q).append("svg").attr("width",J+20+20).attr("height",P+20+20).attr("cursor","move").call(d3.zoom().scaleExtent([1,1]).on("zoom",function(R){var S=R.transform.x+J/2;R=R.transform.y+P/2;d3.select(Q).select("svg \x3e g").attr("transform","translate("+S+","+R+")")})),C.append("g").attr("transform","translate("+J/2+","+P/2+")")):(C.attr("width",J+20+20).attr("height",P+20+20),C.selectAll("g *").remove());G=new doubletree.Tree(C.select("g"),g,
h,M,!0,w,I,N,n,p,v,q,u,x,z);D=new doubletree.Tree(C.select("g"),g,h,A,!1,w,I,N,n,p,v,q,u,x,z)});G.handleAltPress=m.alt;D.handleAltPress=m.alt;G.handleShiftPress=m.shift;D.handleShiftPress=m.shift;G.handleClick=m.click;D.handleClick=m.click;H=!0;return e};e.setupFromArrays=function(B,O,M,A,E,J,P,Q){void 0==E&&F&&(E=F.caseSensitive());void 0==J&&F&&(J=F.fieldNames());void 0==P&&F&&(P=F.fieldDelim());void 0==Q&&F&&(Q=F.distinguishingFieldsArray());F=new doubletree.Trie(E,J,P,Q);K=new doubletree.Trie(E,
J,P,Q);E=O.length;for(J=0;J<E;J++){P=A?A[J]:J;Q=O[J];var C=B[J].slice(),R=M[J].slice();C.push(Q);C.reverse();R.unshift(Q);k?(K.addNgram(C,P),F.addNgram(R,P)):(F.addNgram(C,P),K.addNgram(R,P))}e.setupFromTries(F,K);return e};e.filteredIDs=function(){return L};e.search=function(B){G.search(B);D.search(B);B=d3.select(f[0]);var O=B.selectAll("text.foundText");if(O.empty())return 0;O=O[0].length;null!=B.selectAll("text.rtNdText.foundText").node()&&O--;return O};e.clearSearch=function(){G.clearSearch();
D.clearSearch();return e};e.updateTokenExtras=function(){G.showTokenExtras(n);D.showTokenExtras(n);var B=d3.select(f[0]).select('.tokenExtra[display\x3d"inline"]');B.empty()||"0px"==B.style("height")&&e.redraw();return e};e.visWidth=function(B){if(!arguments.length)return g;g=B;return e};e.visHeight=function(B){if(!arguments.length)return h;h=B;return e};e.prefixesOnRight=function(B){if(!arguments.length)return k;k=B;return e};e.filters=function(B){if(!arguments.length)return l;l=B;return e};e.handlers=
function(B){if(!arguments.length)return m;m=B;return e};e.showTokenExtra=function(B){if(!arguments.length)return n;n=B;return e};e.scaleLabels=function(B){if(!arguments.length)return r;r=B;return e};e.succeeded=function(){return H};e.sortFun=function(B){if(!arguments.length)return w;w=B;return e};e.nodeText=function(B){if(!arguments.length)return p;p=B;return e};e.tokenExtraText=function(B){if(!arguments.length)return v;v=B;return e};e.rectColor=function(B){if(!arguments.length)return q;q=B;return e};
e.rectBorderColor=function(B){if(!arguments.length)return u;u=B;return e};e.continuationColor=function(B){if(!arguments.length)return x;x=B;return e};e.basicStyles=function(B){if(!arguments.length)return z;Object.keys(z).forEach(function(O){O in B&&Object.keys(z[O]).forEach(function(M){M in B[O]&&(z[O][M]=B[O][M])})});return e};return e};doubletree.Tree=function(e,f,g,h,k,l,m,n,r,w,p,v,q,u,x){function z(A){A.children&&(A._children=A.children,A._children.forEach(z),A.children=null)}function H(A){A.parent&&
A.parent.children.forEach(function(E){E!=A&&z(E)})}function I(A,E,J){A.altKey?M.handleAltPress(E,J):A.shiftKey?M.handleShiftPress(E,J):(M.handleClick(E,J),E.parent&&(M.continuationIDs!=E.data.info.ids&&(M.setIds(E.data.info.ids),M.clickedNode=E.id,m.call("idsUpdated",M)),H(E),F(E,!0)))}function F(A,E){A.children?(A.children&&1==A.children.length&&F(A.children[0],!0),A._children=A.children,A.children=null):(A.children=A._children,A._children=null,A.children&&1==A.children.length&&F(A.children[0],!1));
E&&M.update(A)}function K(A){return k?-A:A}var G=r,D=v;f=f-20-20;g=g-20-20;var L=0,N;l||(l=doubletree.sortByStrFld("token"));L=0;var B=d3.tree().size([g,f]).nodeSize([40,40]),O=d3.linkHorizontal().x(function(A){return K(A.y)}).y(function(A){return A.x});e=e.append("g").attr("transform","translate(20,20)");this.readJSONTree=function(A){N=d3.hierarchy(A);N.x0=0;N.y0=0;N.children.forEach(z);this.update(N)};this.update=function(A){var E=B(N).descendants();E.forEach(function(C){var R=C.textSize;if(void 0==
R){R=0;for(var S=C.parent;null!=S;){var T=Ext.draw.TextMeasurer.measureText(S.data.name,"arial").width;R+=T;S=S.parent}C.textSize=R}C.y=25*C.depth+R});var J=e.selectAll("g.node_"+k).data(E,function(C){return C.id||(C.id=++L)}),P=J.enter().append("g").attr("class","node node_"+k).attr("cursor","pointer").attr("transform",function(C){return"translate("+K(A.y0)+","+A.x0+")"}).on("click",I);P.append("title").text(function(C){return doubletree.infoToText(C.data.info)});P.append("circle").attr("r",1E-6).style("fill",
...
1>C.depth)}).style("fill-opacity",1E-6);Q.append("tspan").attr("dx",".35em").attr("class","tokenExtra").text(function(C){return p(C.data.info,1>C.depth)}).style("fill-opacity",1E-6);this.drawRects();P=P.merge(J);P.transition().duration(200).attr("transform",function(C){return"translate("+K(C.y)+","+C.x+")"});P.select("circle").attr("r",function(C){return C.children||C._children?1E-6:4.5}).style("fill",function(C){return C._children?"#fff":x.node.fill}).style("stroke-width",x.node["stroke-width"]);
P.selectAll("tspan").style("fill-opacity",1);J=J.exit().transition().duration(200).attr("transform",function(C){return"translate("+K(A.y)+","+A.x+")"}).remove();J.select("circle").attr("r",1E-6);J.selectAll("tspan").style("fill-opacity",1E-6);J=e.selectAll("path.link_"+k).data(N.links(),function(C){return C.source.id+"-"+C.target.id});J.enter().insert("path","g").attr("class","link link_"+k).attr("d",function(C){C={x:A.x0,y:A.y0};return O({source:C,target:C})}).style("fill","none").style("stroke",
x.branch.stroke).style("stroke-width",x.branch["stroke-width"]).merge(J).transition().duration(200).attr("d",O);J.exit().transition().duration(200).attr("d",function(C){C={x:A.x0,y:A.y0};return O({source:C,target:C})}).remove();E.forEach(function(C){C.x0=C.x;C.y0=C.y});this.updateContinuations()};this.drawRects=function(){var A=G?"inline":"none";e.selectAll(".tokenExtra").attr("display",A);A=e.selectAll("g.node_"+k);A.selectAll("rect").remove();A.insert("rect","text").attr("class","nodeRect").attr("height",
function(){var E=this.parentElement.getBBox().height;6>E&&(E=6.1);return E-6}).attr("y",function(E){return E.parent?-.5*this.parentElement.getBBox().height/2:-.5*this.parentElement.getBBox().height/2-2}).attr("width",function(){return this.parentElement.getBBox().width}).attr("x",function(E){var J=this.parentElement.getBBox().width;return E.parent?k?-.5*J:0:-.33333*J}).style("stroke-opacity",1).style("stroke-width",1).style("stroke",function(E){return q(E.data.info)}).style("fill",function(E){return D(E.data.info)}).style("fill-opacity",
function(E){return 1})};var M=this;this.setIds=function(A){M.continuationIDs=A};this.updateContinuations=function(){e.selectAll("g.node_"+k+" text").classed("continuation",function(A){a:{A=A.data.info.ids;var E=M.continuationIDs||{};for(J in A)if(J in E){var J=!0;break a}J=!1}return J}).style("fill",function(A){return d3.select(this).classed("continuation")?u(A.data.info):"#444"})};this.search=function(A){e.selectAll("g.node text").classed("foundText",function(E){return A.test(w(E.data.info))})};
this.clearSearch=function(){e.selectAll("g.node text").classed("foundText",!1)};this.showTokenExtras=function(A){if(0==arguments.length)return G;G=A;this.drawRects();return this};this.setRectColor=function(A){if(0==arguments.length)return D;D=A;this.drawRects();return this};this.handleAltPress=function(){};this.handleShifttPress=function(){};this.handleClick=function(){};this.readJSONTree(h);return this};doubletree.sortByStrFld=function(e){return function(f,g){var h=void 0==f.data.info[e],k=void 0==
...
(function(){doubletree.Trie=function(a,b,c,d,e){function f(v,q,u){this.id=q;this.count=u;this.info={count:u,ids:{}};if(null==v)this.item=k;else{this.item=v;this.info.ids={};this.info.ids[q]=!0;v=v.split(n);for(var x in v)this.info[m[x]]=[v[x]]}this.nodes={};this.addNgram=function(z,H,I){I||(I=1);if(0<z.length){var F=z.shift();var K=F.split(n);var G=w&&this.item==k?"":K.filter(function(N,B){return-1<r.indexOf(m[B])}).map(function(N){return l?N.toLocaleLowerCase():N}).join(n)}else G=F=h;if(G in this.nodes&&
this.nodes[G]instanceof f){var D=this.nodes[G];D.info.count+=I;D.info.ids[H]=!0;for(var L in K)G=K[L],-1==D.info[m[L]].indexOf(G)&&D.info[m[L]].push(G)}else D=new f(F,H,I),this.nodes[G]=D;F!=h&&D.addNgram(z,H,I)};this.getUniqRoot=function(){if(this.item==k){var z=Object.keys(this.nodes);if(1==z.length)return this.nodes[z[0]]}return this};this.toTree=function(z){function H(F,K,G){var D={children:[]};D.name=G.item;D.info={};for(var L in G.info)if("Object"===typeof G.info[L]){D.info[L]={};for(var N in G.info[L])D.info[L][N]=
this.info[L][N]}else D.info[L]=G.info[L];D.pruned={};for(var B in G.nodes)L=G.nodes[B],N=F[K],!N||N&&N(L.info)?(D.children.push(H(F,K+1,L)),L.pruned!={}&&g(D.pruned,L.pruned)):g(D.pruned,L.info.ids);D.info.continuations=D.children.length;0==D.children.length?(D.children=null,D.maxChildren=0,D.maxLen=D.name?D.name.length:0,D.minCount=D.info.count):(F=d3.max(D.children.map(function(O){return O.maxChildren})),D.maxChildren=Math.max(D.children.length,F),F=d3.max(D.children.map(function(O){return O.maxLen})),
D.maxLen=Math.max(F,D.name.length),D.minCount=d3.min(D.children.map(function(O){return O.minCount})));return D}z||(z=[]);var I=JSON.parse(JSON.stringify(this));return H(z,0,I)}}function g(v,q){for(var u in q)v[u]=q[u]}var h=" ",k="_root_",l=!a&&!0;b||(b=["item"]);var m=b;n||(n="\t");var n=c;r||(r=[m[0]]);var r=d,w=e;void 0==w&&(w=!0);var p=new f(k,-1,0);this.addNgram=function(v,q,u){p.addNgram(v,q,u)};this.getUniqRoot=function(){var v=new doubletree.Trie(!l,m,n,r);v.trie(p.getUniqRoot());return v};
...
return"translate(0, 0) rotate(-20 "+a.xScale(c)+" "+a.yScale(b)+")"}).style("font-size",function(b){return a.fontScale(b.freq)+"px"}).style("fill-opacity",function(b){return a.opacityScale(b.freq)}).text(function(b){return b.wordString}).on("mouseover",function(b,c){d3.select(this).style("cursor","pointer").style("font-size",function(d){return a.fontScale(d.freq)*a.maxFont/a.fontScale(d.freq)+"px"});b=a.buildParamsBundle(c);a.manageOverlaySlippery(b)}).on("mouseout",function(b,c){d3.select(this).style("cursor",
"auto").style("font-size",function(d){return a.fontScale(d.freq)+"px"});b=a.buildParamsBundle(c);a.manageOverlaySlippery(b)}).on("click",function(b,c){b=a.buildParamsBundle(c);a.manageOverlaySticky(b)}).append("title").text(function(b){return b.wordString})},redrawChart:function(){this.chart.selectAll("g[class\x3dsection]").remove();this.drawChart()},drawVerticalSlider:function(){},redrawVerticalSlider:function(){this.chart.selectAll("rect[class\x3dminimap]").remove();this.drawVerticalSlider()},drawSlider:function(){this.container.getHeight();
...
"move");var d=this;c=d3.drag().on("drag",function(e,f){if(!d.isTransitioning){this.drag=!0;f=d.parent.getWidth();var g=parseInt(e.dx),h,k;d.sliderDragSum+=e.dx;d.chart.selectAll("#before").attr("x1",function(){h=parseInt(this.getAttribute("x1"));parseInt(this.getAttribute("x1"));return parseInt(this.getAttribute("x1"))});d.chart.selectAll("#after").attr("x1",function(){k=parseInt(this.getAttribute("x1"));return parseInt(this.getAttribute("x1"))});if(h+g<d.lPadding||k+g>f-d.rPadding)g=0;d.chart.select("#boxBefore").attr("width",
function(){return parseInt(this.getAttribute("width"))+g});d.chart.select("#boxAfter").attr("x",function(){return parseInt(this.getAttribute("x"))+g}).attr("width",function(){return Math.max(0,parseInt(this.getAttribute("width"))-g)});d.chart.selectAll("#before").attr("x1",function(){return parseInt(this.getAttribute("x1"))+g}).attr("x2",function(){return parseInt(this.getAttribute("x2"))+g});d.chart.selectAll("#after").attr("x1",function(){return parseInt(this.getAttribute("x1"))+g}).attr("x2",function(){return parseInt(this.getAttribute("x2"))+
g})}}).on("end",function(e,f){if(this.drag){this.drag=!1;e=d3.scaleLinear().domain([0,d.container.getWidth()-(d.lPadding+d.rPadding)]).range([0,d.numDataPoints])(d.sliderDragSum);var g;f=d.shiftCount;0<e&&(g=Math.floor(e));0>e&&(g=Math.ceil(e));d.shiftCount+=g;0>d.shiftCount&&(d.shiftCount=0);d.shiftCount>d.numDataPoints-1&&(d.shiftCount=d.numDataPoints-1);d.shiftCount!==f&&(d.sliderDragSum=0,d.parent.setApiParams({position:d.shiftCount}),d.prepareData(),d.redraw())}});b.call(c);a.call(c)},removeSlider:function(a){this.chart.selectAll("rect[class\x3dslider]").remove();
this.chart.selectAll("line[class~\x3dslider]").remove();a&&this.chart.selectAll("g[class\x3dslider]").remove()},redrawSlider:function(){this.removeSlider();this.drawSlider()},animateVis:function(){var a=this;this.parent.getApiParam("mode");this.container.getHeight();var b=this.container.getWidth(),c=this.getDuration();if("left"===this.transitionCall||"right"===this.transitionCall){this.xAxisEl.transition().duration(c).ease(d3.easeLinear).call(this.xAxis);this.styleXAxis();this.drawChart();this.chart.selectAll(".frequencies").transition().duration(c).ease(d3.easeLinear).selectAll("text").attr("x",
...
this.shiftCount)/(this.numDataPoints-1))}this.redrawChartOverlay()},callTransition:function(){"left"===this.transitionCall&&this.toggleLeftCheck();"right"===this.transitionCall&&this.toggleRightCheck()},buildParamsBundle:function(a){var b=a.wordString,c={};if("document"===this.parent.getApiParam("mode")){a=a.docId;var d=this.parent.getCorpus().getDocument(a).getLexicalTokensCount()-1;c.tokenIdStart=parseInt(d/this.numDataPoints);c.docIdType=a+":"+b}return{params:c,type:b}},manageOverlaySlippery:function(a){for(var b=
a.type,c=this.getSelectorFromTerm(a.type),d="on",e=this.overlayQueue.length;0<=--e;)c===this.overlayQueue[e].selector&&(d="off");c===this.lastSticky&&(d="off",this.lastSticky=null);"on"===d&&(c!==this.lastSlippery?(d=this.prepareFullPath(b),a={word:b,selector:c,params:a,fullPath:d.path,pathMin:d.min,pathMax:d.max,colour:"red"},null!==this.lastSlippery&&(this.chartOverlayOff(this.lastSlippery),this.isSliderVisible&&this.sliderOverlayOff(this.lastSlippery),this.lastSlippery=null),this.chartOverlayOn(a),
this.isSliderVisible&&this.sliderOverlayOn(a),this.lastSlippery=c):(this.chartOverlayOff(c),this.isSliderVisible&&this.sliderOverlayOff(this.lastSlippery),this.lastSlippery=null))},manageOverlaySticky:function(a){a=a.type;this.transitionCall="draw";this.isTermSelected(a)?this.doTermDeselect(a,!0):this.doTermSelect(a,!0)},getTermIndex:function(a){var b=-1;a=this.getSelectorFromTerm(a);for(var c=this.overlayQueue.length;0<=--c;)a===this.overlayQueue[c].selector&&(b=c);return b},isTermSelected:function(a){return-1!==
this.getTermIndex(a)},doTermSelect:function(a,b){var c=this.getSelectorFromTerm(a),d=this.parent.getApiParam("selectedWords");d.push(a);this.parent.setApiParams({selectedWords:d});d=this.parent.getApplication().getColorForTerm(a,!0);if(!0===b)b=this.parent.query("[xtype\x3dlegend]")[0],b.getStore().add({name:a,mark:d,selector:c}),b.refresh();else{b=this.parent.query("[xtype\x3dlegend]")[0];var e=b.getStore().findRecord("name",a);null!==e&&(e.set("mark",d),b.refresh())}b=this.prepareFullPath(a);a=
{word:a,selector:c,params:{params:{},type:a},fullPath:b.path,pathMin:b.min,pathMax:b.max,colour:d};c===this.lastSlippery&&(this.isSliderVisible&&this.sliderOverlayOff(c),this.lastSlippery=null);this.chart.select("g[class\x3dfrequency-line-"+c+"]").remove();this.overlayQueue.push(a);this.chartOverlayOn(a);this.isSliderVisible&&this.sliderOverlayOn(a)},doTermDeselect:function(a,b){var c=this.getSelectorFromTerm(a),d=this.getTermIndex(a);!0===b&&(b=this.parent.query("[xtype\x3dlegend]")[0],d=b.getStore().findExact("name",
a),b.getStore().removeAt(d),b.refresh());a=this.parent.getApiParam("selectedWords");b=0;for(var e=a.length;b<e;b++)a[b]===c&&(a.splice(b,1),this.parent.setApiParams({selectedWords:a}));this.chartOverlayOff(c);this.overlayQueue.splice(d,1);this.isSliderVisible&&this.sliderOverlayOff(c);this.lastSticky=c},prepareFullPath:function(a){for(var b=[],c=this.absMaxFreq,d=this.absMinFreq,e=0,f=this.allData.length;e<f;e++){for(var g=foundB=0,h=this.allData[e].allDataInternal.length;g<h;g++)for(var k=0,l=this.allData[e].allDataInternal[g].frequencyArray.length;k<
...
exportSvg:function(a){if(a=this.getTargetEl().dom.querySelector("svg"))a=d3.select(a).attr("version",1.1).attr("xmlns","http://www.w3.org/2000/svg").attr("xmlns:xlink","http://www.w3.org/1999/xlink").node().parentNode.innerHTML,Ext.Msg.show({title:this.localize("exportSvgTitle"),message:'\x3cimg src\x3d"data:image/svg+xml;base64,'+btoa(unescape(encodeURIComponent(a)))+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportSvgMessage"),
buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:a})},exportPngData:function(a){Ext.Msg.show({title:this.localize("exportPngTitle"),message:'\x3cimg class\x3d"thumb" src\x3d"'+a+'" style\x3d"float: right; max-width: 200px; max-height: 200px; border: thin dotted #ccc;"/\x3e'+this.localize("exportPngMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:'\x3cimg src\x3d"'+a+'" /\x3e'})},exportPng:function(a,b){var c=1;b&&(b.mask(a.localize("loading")),(a=b.queryById("scale"))&&
a.getValue&&(c=a.getValue()));var d=this.down("draw")||this.down("chart");if(d&&(d.isChart||d.isCanvas)){var e=d.innerElement.getSize();a=Array.prototype.slice.call(d.items.items);var f=d.surfaceZIndexes,g;for(g=1;g<a.length;g++){var h=a[g];var k=f[h.type];for(d=g-1;0<=d&&f[a[d].type]>k;)a[d+1]=a[d],d--;a[d+1]=h}var l=document.createElement("canvas");f=Ext.getClassName(a[0]);c*=a[0].devicePixelRatio;var m=l.getContext("2d");l.width=Math.ceil(e.width*c);l.height=Math.ceil(e.height*c);for(d=0;d<a.length;d++)if(h=
a[d],Ext.getClassName(h)===f)for(e=h.getRect(),surfaceSize=h.el.getSize(),g=0;g<h.canvases.length;g++){var n=h.canvases[g];k=n.getOffsetsTo(n.getParent());m.drawImage(n.dom,(e[0]+k[0])*c,(e[1]+k[1])*c,surfaceSize.width*c,surfaceSize.height*c)}b&&b.isVisible()&&b.unmask();return this.exportPngData(l.toDataURL())}d=this.getTargetEl().dom;if(n=d.querySelector("canvas")){if(1==c)return c=n.toDataURL("image/png"),b&&b.isVisible()&&b.unmask(),this.exportPngData(c);l=document.createElement("canvas");m=l.getContext("2d");
l.width=Math.ceil(n.width*c);l.height=Math.ceil(n.height*c);var r=new Image;r.src=n.toDataURL("image/png");r.panel=this;r.onload=function(){m.drawImage(r,0,0,l.width,l.height);p=l.toDataURL("image/png");b&&b.isVisible()&&b.unmask();this.panel.exportPngData.call(this.panel,p)}}else if(g=d.querySelector("svg")){a=d.offsetWidth*c;d=d.offsetHeight*c;g=g.cloneNode(!0);g.setAttribute("version",1.1);g.setAttribute("xmlns","http://www.w3.org/2000/svg");g.setAttribute("xmlns:xlink","http://www.w3.org/1999/xlink");
g.setAttribute("width",a);g.setAttribute("height",d);for(h=[];0<g.children.length;)h.push(g.removeChild(g.children[0]));var w=document.createElement("g");w.setAttribute("style","transform-box: fill-box;");w.setAttribute("transform","scale("+c+")");g.appendChild(w);h.forEach(function(q){w.appendChild(q)});var p="data:image/svg+xml;base64,"+btoa(unescape(encodeURIComponent(g.outerHTML)));n=Ext.DomHelper.createDom({tag:"canvas",width:a,height:d});var v=n.getContext("2d");r=new Image(a,d);r.src=p;r.panel=
this;r.onload=function(){v.drawImage(r,0,0);p=n.toDataURL("image/png");b&&b.isVisible()&&b.unmask();return this.panel.exportPngData.call(this.panel,p)}}},exportUrl:function(){this.openUrl(this.getExportUrl())},exportEmbed:function(){var a=0==this.isXType("voyantheader");Ext.Msg.show({title:this.localize("exportViewEmbedTitle"),message:this.localize("exportViewEmbedMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:"\x3c!--\tExported from Voyant Tools (voyant-tools.org).\nThe iframe src attribute below uses a relative protocol to better function with both\nhttp and https sites, but if you're embedding this into a local web page (file protocol)\nyou should add an explicit protocol (https if you're using voyant-tools.org, otherwise\nit depends on this server.\nFeel free to change the height and width values or other styling below: --\x3e\n\x3ciframe style\x3d'width: "+
...
Ext.define("Voyant.categories.CategoriesBuilder",{extend:"Ext.window.Window",requires:["Voyant.widget.FontFamilyOption"],mixins:["Voyant.util.Localization","Voyant.util.Api"],alias:"widget.categoriesbuilder",statics:{i18n:{title:"Categories Builder",terms:"Terms",term:"Term",rawFreq:"Count",relativeFreq:"Relative",categories:"Categories",addCategory:"Add Category",removeCategory:"Remove Category",editCategory:"Edit Category",editCategoryMessage:"This is the category list, one term per line.",removeTerms:"Remove Selected Terms",
categoryName:"Category Name",add:"Add",cancel:"Cancel",exists:"Category already exists",confirmRemove:"Are you sure you want to remove the category?",save:"Save",features:"Features",category:"Category",increaseCategory:"Increase Category Priority",decreaseCategory:"Decrease Category Priority",setColorsFromPalette:"Set Colors From Palette",loadingCategories:"Loading Categories",errorLoadingCategories:"Error loading Categories",color:"Color",font:"Font",orientation:"Orientation"},api:{stopList:"auto",
query:void 0},features:{color:{xtype:"colorfield",format:"#hex6"},font:{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",store:{fields:["name","value"],data:Voyant.widget.FontFamilyOption.fonts}},orientation:{xtype:"combobox",queryMode:"local",displayField:"name",valueField:"value",store:{fields:["name","value"],data:[{name:"Horizontal",value:0},{name:"Vertical",value:90}]}}}},config:{corpus:void 0,builderWin:void 0,addCategoryWin:void 0,categoriesId:void 0},closeAction:"hide",
modal:!0,height:250,width:500,constructor:function(a){a=a||{};a.panel?(this.panel=a.panel,this.app=this.panel.getApplication(),this.categoriesManager=this.app.getCategoriesManager()):console.warn("CategoriesBuilder cannot find panel!");a.height=.75*this.app.getViewport().getHeight();a.width=.75*this.app.getViewport().getWidth();this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);this.callParent(arguments)},initComponent:function(){Ext.apply(this,{header:!1,layout:"fit",onEsc:Ext.emptyFn,
items:{xtype:"tabpanel",title:this.localize("title"),tabBarHeaderPosition:1,items:[{layout:"border",title:this.localize("categories"),items:[{title:this.localize("terms"),split:!0,width:250,region:"west",layout:"fit",items:{itemId:"terms",xtype:"grid",store:Ext.create("Voyant.data.store.CorpusTermsBuffered",{parentPanel:this}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",copy:!0,enableDrop:!1,dragZone:{getDragText:function(){var a="";this.dragData.records.forEach(function(b){a+=b.get("term")+
", "});a=a.substr(0,a.length-2);20<a.length&&(a=a.substr(0,20)+"...");return a}}}},selModel:{mode:"MULTI"},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",width:"autoSize",sortable:!0},{text:this.localize("relativeFreq"),dataIndex:"relativeFreq",renderer:function(a){return Ext.util.Format.number(1E6*a,"0,000")},width:"autoSize",hidden:!0,sortable:!0}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",
items:[{xtype:"querysearchfield"}]}],listeners:{query:function(a,b){this.setApiParam("query",b);a=this.queryById("terms").getStore();a.removeAll();a.load()},scope:this}}},{title:this.localize("categories"),itemId:"categories",region:"center",xtype:"panel",layout:{type:"hbox",align:"stretch"},scrollable:"x",dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"textfield",itemId:"categoryFilter",fieldLabel:"Category Filter",labelAlign:"right",enableKeyEvents:!0,listeners:{keyup:function(a,
b){var c=a.getValue().trim();this.queryById("categories").query("grid").forEach(function(d){""===c?d.getStore().clearFilter():d.getStore().filter("term",c)},this)},scope:this}},"-",{text:this.localize("addCategory"),handler:function(){this.getAddCategoryWin().show()},scope:this},{text:this.localize("removeTerms"),handler:function(){this.queryById("categories").query("grid").forEach(function(a){var b=a.getSelection();b.forEach(function(c){this.categoriesManager.removeTerm(a.category,c.get("term"))},
this);a.getStore().remove(b)},this)},scope:this}]}],items:[]}]},{layout:"fit",itemId:"features",title:this.localize("features"),xtype:"grid",scrollable:"y",store:Ext.create("Ext.data.JsonStore",{fields:["category"]}),columns:[{text:this.localize("category"),dataIndex:"category",sortable:!1,hideable:!1,flex:1}],bbar:[{xtype:"colorpaletteoption"}," ",{text:this.localize("setColorsFromPalette"),handler:function(a){a=a.up().down("colorpaletteoption").down("combo").getValue();var b=this.app.getColorPalette(a,
!0);0<b.length&&(Object.keys(this.categoriesManager.getCategories()).forEach(function(c,d){this.categoriesManager.setCategoryFeature(c,"color",b[d%b.length])},this),this.buildFeatures())},scope:this}]}]},buttons:[{text:this.localize("cancel"),ui:"default-toolbar",handler:function(a){this.setCategoriesId(void 0);a.up("window").close()},scope:this},{text:this.localize("save"),handler:function(a){this.processFeatures();this.setColorTermsFromCategoryFeatures();this.app.saveCategoryData().then(function(b){this.setCategoriesId(b);
a.up("window").close()}.bind(this),function(){this.setCategoriesId(void 0);a.up("window").close()}.bind(this))},scope:this}],listeners:{show:function(){this.down("tabpanel").setActiveTab(0);this.queryById("categoryFilter").setValue("");this.getCategoriesId()!==this.panel.getApiParam("categories")?(this.queryById("categories").mask(this.localize("loadingCategories")),this.app.loadCategoryData(this.getCategoriesId()).then(function(a){this.queryById("categories").unmask();this.setColorTermsFromCategoryFeatures();
this.buildCategories();this.buildFeatures()}.bind(this),function(a){this.queryById("categories").unmask();this.panel.showError(this.localize("errorLoadingCategories"))}.bind(this))):(this.buildCategories(),this.buildFeatures())},afterrender:function(a){a.on("loadedCorpus",function(b,c){this.setCorpus(c);this.queryById("terms").getStore().load()},a);this.panel.on("loadedCorpus",function(b,c){a.fireEvent("loadedCorpus",b,c)},a);this.panel.getCorpus&&this.panel.getCorpus()?a.fireEvent("loadedCorpus",
a,this.panel.getCorpus()):this.panel.getStore&&this.panel.getStore()&&this.panel.getStore().getCorpus&&this.panel.getStore().getCorpus()&&a.fireEvent("loadedCorpus",a,this.panel.getStore().getCorpus())},scope:this}});this.setAddCategoryWin(Ext.create("Ext.window.Window",{title:this.localize("addCategory"),modal:!0,closeAction:"hide",layout:"fit",items:{xtype:"form",width:300,bodyPadding:"10 5 5",defaults:{labelAlign:"right"},items:[{xtype:"textfield",fieldLabel:this.localize("categoryName"),name:"categoryName",
...
this.addCategory(b),a.up("window").close())},scope:this}]},listeners:{show:function(a){a=a.down("form").getForm();a.reset();a.clearInvalid()}}}));this.callParent(arguments)},addCategory:function(a){this.categoriesManager.addCategory(a);this.queryById("features").getStore().add({category:a});var b=[],c=this.categoriesManager.getCategoryTerms(a);if(void 0!==c)for(var d=0;d<c.length;d++)b.push({term:c[d]});var e=this.queryById("categories").add({xtype:"grid",category:a,title:a,frame:!0,width:150,margin:"10 0 10 10",
layout:"fit",tools:[{type:"gear",tooltip:this.localize("editCategory"),callback:function(g){var h=this.categoriesManager.getCategoryTerms(a).join("\n");Ext.Msg.show({title:this.localize("editCategory"),message:this.localize("editCategoryMessage"),buttons:Ext.Msg.OKCANCEL,prompt:!0,multiline:!0,value:h,fn:function(k,l,m){"ok"===k&&(k=l.split("\n").map(function(n){return n.trim()}).filter(function(n){return""!==n}),l=k.map(function(n){return{term:n}}),g.getStore().loadData(l,!1),this.categoriesManager.categories[a]=
k)},scope:this})},scope:this},{type:"close",tooltip:this.localize("removeCategory"),callback:function(g){Ext.Msg.confirm(this.localize("removeCategory"),this.localize("confirmRemove"),function(h){"yes"===h&&this.removeCategory(a)},this)},scope:this}],bbar:[{xtype:"button",text:"",tooltip:this.localize("increaseCategory"),glyph:"xf067@FontAwesome",handler:function(g){g=g.findParentByType("grid");var h=this.queryById("categories"),k=h.prevChild(g);null!==k&&(h.moveBefore(g,k),this.app.getCategoriesManager().setCategoryRanking(g.getTitle(),
h.items.indexOf(g)))},scope:this},"-\x3e",{xtype:"button",text:"",tooltip:this.localize("decreaseCategory"),glyph:"xf068@FontAwesome",handler:function(g){g=g.findParentByType("grid");var h=this.queryById("categories"),k=h.nextChild(g);null!==k&&(h.moveAfter(g,k),this.app.getCategoriesManager().setCategoryRanking(g.getTitle(),h.items.indexOf(g)))},scope:this}],store:Ext.create("Ext.data.JsonStore",{data:b,fields:["term"]}),viewConfig:{plugins:{ptype:"gridviewdragdrop",ddGroup:"terms",dragZone:{getDragText:function(){var g=
"";this.dragData.records.forEach(function(h){g+=h.get("term")+", "});return g.substr(0,g.length-2)}}}},selModel:{mode:"MULTI"},columns:[{dataIndex:"term",flex:1,sortable:!0}],listeners:{beforedrop:function(g,h){g=this.up("categoriesbuilder").categoriesManager;var k=h.view.up("grid");if(void 0!==k.category)for(var l=h.records.length-1;0<=l;l--){var m=h.records[l].get("term");g.removeTerm(k.category,m)}},drop:function(g,h){h.view.getSelectionModel().deselectAll();this.getSelectionModel().deselectAll();
g=this.up("categoriesbuilder").categoriesManager;for(var k=[],l=0;l<h.records.length;l++){var m=h.records[l].get("term");k.push(m)}g.addTerms(a,k)}}}),f=new Ext.Editor({updateEl:!0,alignment:"l-l",autoSize:{width:"boundEl"},field:{xtype:"textfield",allowBlank:!1,validator:function(g){return void 0===this.categoriesManager.getCategoryTerms(g)||g===e.getTitle()?!0:this.localize("exists")}.bind(this)},listeners:{complete:function(g,h,k){this.categoriesManager.renameCategory(k,h);this.buildFeatures()},
scope:this}});e.header.getTitle().textEl.on("dblclick",function(g,h){f.startEdit(h)})},removeCategory:function(a){var b=this.queryById("categories"),c=b.queryBy(function(d){return d.category&&d.category==a?!0:!1});b.remove(c[0]);b=this.queryById("features").getStore();b.removeAt(b.findExact("category",a));this.categoriesManager.removeCategory(a)},addFeature:function(a){this.categoriesManager.addFeature(a);this.buildFeatures()},buildFeatures:function(){this.queryById("features").getStore().removeAll();
var a=["category"],b=[{sortable:!1,text:this.localize("category"),dataIndex:"category",flex:1}],c=[],d;for(d in this.categoriesManager.getCategories())c.push({category:d});var e=this.categoriesManager.getFeatures(),f=Ext.ClassManager.getClass(this).features;if(0===Object.entries(e).length)for(var g in f)for(d in e[g]={},this.categoriesManager.getCategories())e[g][d]=void 0;for(g in e){a.push(g);e=f[g];var h=Ext.applyIf({feature:g,listeners:{change:function(k,l){if(k.rendered){var m=k.up("gridview").indexOf(k.el.up("table")),
...
.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));a=d3.select(a.dom).append("svg").attr("width",b).attr("height",c);var e=a.append("g");b=d3.zoom().scaleExtent(this.getZoomExtent()).on("zoom",function(f){e.attr("transform",f.transform)});this.setZoom(b);a.call(b);this.setEdgeSelection(e.append("g").attr("class","edges").selectAll(".edge"));this.setNodeSelection(e.append("g").attr("class","nodes").selectAll(".node"));
this.setVis(e)},resetGraph:function(){this.setNodeData([]);this.setEdgeData([]);this.refreshGraph()},refreshGraph:function(){if(void 0!==this.getVisLayout()){var a=this.getEdgeData(),b=this.getNodeData(),c=d3.extent(b,function(g){return g.value}),d=d3.extent(a,function(g){return g.value}),e=this.getEdgeScaling();void 0===e.scalingFunction&&(e.scalingFunction=d3.scaleLinear().domain(d).range([e.minSize,e.maxSize]));var f=this.getNodeScaling();void 0===f.scalingFunction&&(f.scalingFunction=d3.scaleLog().domain(c).range([f.minSize,
f.maxSize]));c=this.getEdgeSelection().data(a,function(g){return g.id});c.exit().remove();d=c.enter().append("line").attr("class","edge").attr("id",function(g){return g.id}).style("cursor","pointer").style("stroke-width",function(g){return e.scalingFunction(g.value)}).on("mouseover",this.edgeMouseOver.bind(this)).on("mouseout",this.edgeMouseOut.bind(this)).on("click",function(g,h){g.stopImmediatePropagation();g.preventDefault();this.setCurrentEdge(h);this.fireEvent("edgeclicked",this,h)}.bind(this));
this.setEdgeSelection(d.merge(c));c=this.getNodeSelection().data(b,function(g){return g.id});c.exit().remove();d=c.enter().append("g").attr("class","node").attr("id",function(g){return g.id}).style("cursor","pointer").on("mouseover",this.nodeMouseOver.bind(this)).on("mouseout",this.nodeMouseOut.bind(this)).on("click",function(g,h){g.stopImmediatePropagation();g.preventDefault();this.setCurrentNode(h);this.fireEvent("nodeclicked",this,h)}.bind(this)).on("dblclick",function(g,h){g.stopImmediatePropagation();
g.preventDefault();this.fireEvent("nodedblclicked",this,h)}.bind(this)).on("contextmenu",function(g,h){g.stopImmediatePropagation();g.preventDefault();this.fireEvent("nodecontextclicked",this,h)}.bind(this)).call(d3.drag().on("start",function(g,h){this.setDragging(!0);g.active||this.getVisLayout().alpha(.3).restart();h.fx=h.x;h.fy=h.y;h.fixed=!0;this.fireEvent("nodedragstart",this,h)}.bind(this)).on("drag",function(g,h){this.getVisLayout().alpha(.3);h.fx=g.x;h.fy=g.y;this.fireEvent("nodedrag",this,
h)}.bind(this)).on("end",function(g,h){this.setDragging(!1);1!=h.fixed&&(h.fx=null,h.fy=null);this.fireEvent("nodedragend",this,h)}.bind(this)));d.append("rect");d.append("text").text(function(g){return g.term}).attr("font-family",function(g){return Voyant.application.getCategoriesManager().getFeatureForTerm("font",g.term)}).attr("font-size",function(g){return f.scalingFunction(g.value)+"px"}).attr("dominant-baseline","middle").style("user-select","none").each(function(g){g.bbox=this.getBBox()});
this.setNodeSelection(d.merge(c));this.getNodeSelection().selectAll("rect").attr("width",function(g){return g.bbox.width+16}).attr("height",function(g){return g.bbox.height+8}).attr("rx",function(g){return Math.max(2,.2*g.bbox.height)}).attr("ry",function(g){return Math.max(2,.2*g.bbox.height)});this.getNodeSelection().selectAll("text").attr("dx",8).attr("dy",function(g){return.5*g.bbox.height+4});this.getEdgeSelection().call(this.applyEdgeStyle.bind(this));this.getNodeSelection().call(this.applyNodeStyle.bind(this));
this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(a);this.getVisLayout().alpha(1).restart()}},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2;c=this.getVis().node().parentElement;var h=c.getBoundingClientRect(),k=h.width;h=h.height;a=(a||.8)/Math.max(d/k,e/h);f=[k/2-a*f,h/2-a*g];1>d||d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(a))},nodeScaling:function(a,
b,c,d){return a===b?.5:Math.max(0,1/(b-a)*(d-a))},applyNodeStyle:function(a,b){b=void 0===b?"normal":b;var c=this.getGraphStyle().node[b];a.selectAll("rect").style("fill",function(d){return c.fill}.bind(this)).style("fill-opacity",function(d){return c.fillOpacity}.bind(this)).style("stroke",function(d){return c.stroke}.bind(this)).style("stroke-opacity",function(d){return c.strokeOpacity}.bind(this)).style("stroke-width",function(d){return c.strokeWidth}.bind(this))},applyEdgeStyle:function(a,b){b=
void 0===b?"normal":b;var c=this.getGraphStyle().edge[b];a.style("stroke",function(d){return c.stroke}.bind(this)).style("stroke-opacity",function(d){return c.strokeOpacity}.bind(this))},edgeMouseOver:function(a,b){this.getEdgeSelection().call(this.applyEdgeStyle.bind(this));this.getVis().select("#"+b.id).call(this.applyEdgeStyle.bind(this),"highlight")},edgeMouseOut:function(a,b){this.getEdgeSelection().call(this.applyEdgeStyle.bind(this))},nodeMouseOver:function(a,b){this.setCurrentNode(b);this.getNodeSelection().call(this.applyNodeStyle.bind(this));
this.getEdgeSelection().each(function(c){if(c.source.id==b.id)var d=c.target.id;else c.target.id==b.id&&(d=c.source.id);void 0!==d&&(this.getVis().select("#"+d).call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+c.id).call(this.applyEdgeStyle.bind(this),"highlight"))}.bind(this));this.getVis().select("#"+b.id).call(this.applyNodeStyle.bind(this),"highlight")},nodeMouseOut:function(a,b){this.getNodeSelection().call(this.applyNodeStyle.bind(this));this.getEdgeSelection().call(this.applyEdgeStyle.bind(this))}});Ext.define("Voyant.widget.ReaderGraph",{extend:"Ext.container.Container",mixins:["Voyant.util.Localization"],alias:"widget.readergraph",statics:{i18n:{}},config:{parentPanel:void 0,documentsStore:void 0,locationMarker:void 0,isDetailedGraph:!0,seriesToolTip:void 0},locationMarkerColor:"#157fcc",DETAILED_GRAPH_DOC_LIMIT:25,LOCATION_UPDATE_FREQ:100,SCROLL_UP:-1,SCROLL_EQ:0,SCROLL_DOWN:1,RESERVED_KEYS:["id","docIndex","readerGraphPadding","readerGraphTotal"],constructor:function(a){this.callParent(arguments)},
...
w+="\x3ca href\x3d'#' class\x3d'cataloguedoctitle' data\x3d'"+n+"'\x3e"+r.getTitle()+"\x3c/a\x3e";for(facet in b)if(0!=b[facet].length){var p="";if("facet.title"!=facet){var v=facet.replace(/^.+?\./,"");if(n=r.get(v)){var q=Ext.isArray(n);q?p+="\x3cli\x3e"+v+"\x3cul\x3e":n=[n];n.forEach(function(u){var x=!1;b[facet].forEach(function(z){z.label==u?x=!0:-1==z.facet.indexOf("facet")&&z.label.split(/\W+/).forEach(function(H){0<H.trim().length&&-1<u.toLowerCase().indexOf(H.toLowerCase())&&(x=!0)})});p+=
...
"middle").attr("data-freq",function(h){return h.rawFreq}).attr("transform",function(h){return"translate("+[h.x,h.y]+")rotate("+h.rotate+")"}).style("font-family",function(h){return c.getApplication().getCategoriesManager().getFeatureForTerm("font",h.text)}).style("fill",function(h){return c.getApplication().getColorForTerm(h.text,!0)}).style("font-size","1px").on("click",function(h,k){c.dispatchEvent("termsClicked",c,[k.text])}).on("mouseover",function(h,k){this.getTip().show()}.bind(this)).on("mousemove",
function(h,k){var l=this.getTip();l.update(k.text+": "+k.rawFreq);k=Ext.get(this.getCirrusId()).dom;h=d3.pointer(h,k);h[1]+=30;l.setPosition(h)}.bind(this)).on("mouseout",function(h,k){this.getTip().hide()}.bind(this));a.merge(g).transition(f).style("font-family",function(h){return c.getApplication().getCategoriesManager().getFeatureForTerm("font",h.text)}).style("fill",function(h){return c.getApplication().getColorForTerm(h.text,!0)}).attr("transform",function(h){return"translate("+[h.x,h.y]+")rotate("+
...
b.split(",").length);this.getCorpus().getCorpusTerms({autoLoad:!1,parentPanel:this}).load({params:{limit:a,query:b,stopList:this.getApiParam("stopList"),categories:this.getApiParam("categories")},callback:function(c,d,e){e&&this.loadFromCorpusTermRecords(c)},scope:this})}},loadFromQuery:function(a){if(Ext.isArray(a)&&0==a.length)this.setApiParam("query",void 0),this.resetGraph();else{this.setApiParams({query:a});var b=this.getApiParams();b.noCache=!0;(Ext.isString(a)?[a]:a).forEach(function(c){this.getCorpus().getCorpusCollocates({autoLoad:!1,
parentPanel:this}).load({params:Ext.apply(Ext.clone(b),{query:c}),callback:function(d,e,f){f&&this.loadFromCorpusCollocateRecords(d)},scope:this})},this)}},loadFromCorpusTermRecords:function(a){if(Ext.isArray(a)&&0<a.length){var b=[];a.forEach(function(c){b.push(c.getTerm())});this.loadFromQuery(b)}},loadFromCorpusCollocateRecords:function(a,b){if(Ext.isArray(a)){var c=this.getApiParam("limit"),d=this.getLayout().getRenderTarget(),e=d.getWidth()/2,f=d.getHeight()/2,g={};this.getNodeData().forEach(function(l){g[l.id]=
!0},this);var h=[],k=[];a.forEach(function(l,m){var n=l.getTerm(),r=l.getContextTerm(),w=l.getKeywordRawFreq(),p=l.getContextTermRawFreq(),v=w,q=p;this.getNetworkMode()===this.CENTRALIZED_MODE&&(v=0,q=Math.log(p));0==m&&(void 0===b&&(b=this.idGet(n)),void 0!==g[b]?this.updateDataForNode(b,{title:n+" ("+w+")",type:"keyword",value:v}):(g[b]=!0,m={id:b,term:n,title:n+" ("+w+")",type:"keyword",value:v,start:c,fixed:!1,x:e,y:f},h.push(m)));if(n!=r){n=this.idGet(r);void 0===g[n]&&(g[n]=!0,r={id:n,term:r,
title:r+" ("+p+")",type:"context",value:q,start:0,fixed:!1,x:e,y:f},h.push(r));r=null;p=this.getLinkData();for(q=0;q<p.length;q++)if(m=p[q],m.source.id==b&&m.target.id==n||m.source.id==n&&m.target.id==b){r=m;break}l=l.getContextTermRawFreq();null===r&&k.push({source:b,target:n,value:l,id:b+"-"+n})}},this);this.setNodeData(this.getNodeData().concat(h));this.setLinkData(this.getLinkData().concat(k));this.refresh()}},idGet:function(a){return"links_"+a.replace(/\W/g,"_")},updateDataForNode:function(a,
b){for(var c=this.getNodeData(),d=0;d<c.length;d++)if(c[d].id===a){Ext.apply(c[d],b);break}},removeNode:function(a,b){b=this.getNodeData();for(var c=0;c<b.length;c++)if(b[c].id===a){b.splice(c,1);break}b=this.getLinkData();for(c=b.length-1;0<=c;c--)b[c].source.id!==a&&b[c].target.id!==a||b.splice(c,1);this.setApiParam("query",Ext.Array.remove(Ext.Array.from(this.getApiParam("query")),a));this.refresh()},doCentralize:function(a){this.setApiParam("centralize",a);this.resetGraph();this.setNetworkMode(this.CENTRALIZED_MODE);
a={id:this.idGet(a),term:a,title:a+" (1)",type:"keyword",value:1E3,start:0};this.setNodeData([a]);this.refresh();var b=this.getApiParam("limit");this.setApiParam("limit",150);this.fetchCollocatesForNode(a);this.setApiParam("limit",b)},applyNetworkMode:function(a){if(this.getVisLayout()){if(a===this.DEFAULT_MODE){var b=this.getGraphPhysics().defaultMode;this.getVisLayout().velocityDecay(b.damping).force("link",d3.forceLink().id(function(c){return c.id}).distance(b.springLength).strength(b.springStrength)).force("charge",
d3.forceManyBody().strength(b.nodeGravity)).force("collide",d3.forceCollide(function(c){return Math.sqrt(c.bbox.width*c.bbox.height)*b.collisionScale}))}else b=this.getGraphPhysics().centralizedMode,this.getVisLayout().velocityDecay(b.damping).force("link",d3.forceLink().id(function(c){return c.id}).distance(b.springLength).strength(b.springStrength)).force("charge",d3.forceManyBody().strength(function(c){return"keyword"===c.type?-1E4:0})).force("collide",d3.forceCollide(function(c){return"keyword"===
c.type?c.value:Math.sqrt(c.bbox.width*c.bbox.height)*b.collisionScale}));this.getVisLayout().force("x").strength(b.centralGravity);this.getVisLayout().force("y").strength(b.centralGravity)}return a},initGraph:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.forceSimulation().force("x",d3.forceX(b/2)).force("y",d3.forceY(c/2)).on("tick",function(){this.getLinks().attr("x1",function(e){return e.source.x}).attr("y1",function(e){return e.source.y}).attr("x2",
function(e){return e.target.x}).attr("y2",function(e){return e.target.y});this.getNodes().attr("transform",function(e){var f=e.x,g=e.y;if(this.getNetworkMode()===this.DEFAULT_MODE||"keyword"!==e.type)f-=.5*e.bbox.width,g-=.5*e.bbox.height;return"translate("+f+","+g+")"}.bind(this));!this.getDragging()&&.075>this.getVisLayout().alpha()&&this.getVisLayout().alpha(-1)}.bind(this)).on("end",function(){Ext.Function.defer(this.zoomToFit,100,this)}.bind(this)));a=d3.select(a.dom).append("svg").attr("id",
this.getVisId()).attr("class","linksGraph").attr("width",b).attr("height",c);var d=a.append("g");b=d3.zoom().scaleExtent([.25,4]).on("zoom",function(e){d.attr("transform",e.transform)});this.setZoom(b);a.call(b);a.on("click",function(){this.getContextMenu().hide()}.bind(this));this.setLinks(d.append("g").attr("class","links").selectAll(".link"));this.setNodes(d.append("g").attr("class","nodes").selectAll(".node"));this.setVis(d)},resetGraph:function(){this.setNodeData([]);this.setLinkData([]);this.setNetworkMode(this.DEFAULT_MODE);
this.refresh()},refresh:function(){var a=this,b=this.getNodeData(),c=this.getLinkData(),d=this.getLinks().data(c,function(f){return f.id});d.exit().remove();var e=d.enter().append("line").attr("class","link").attr("id",function(f){return f.id}).on("mouseover",a.linkMouseOver.bind(a)).on("mouseout",a.linkMouseOut.bind(a)).on("click",function(f,g){f.stopImmediatePropagation();f.preventDefault();this.dispatchEvent("termsClicked",this,['"'+g.source.term+" "+g.target.term+'"~'+this.getApiParam("context")])}.bind(a)).style("cursor",
"pointer").style("stroke-width",function(f){return a.getNetworkMode()===a.DEFAULT_MODE?Math.max(1,Math.min(15,Math.sqrt(f.value))):1});this.setLinks(e.merge(d));d=this.getNodes().data(b,function(f){return f.id});d.exit().remove();e=d.enter().append("g").attr("class",function(f){return"node "+f.type}).attr("id",function(f){return f.id}).on("mouseover",a.nodeMouseOver.bind(a)).on("mouseout",a.nodeMouseOut.bind(a)).on("click",function(f,g){f.stopImmediatePropagation();f.preventDefault();this.dispatchEvent("termsClicked",
this,[g.term])}.bind(a)).on("dblclick",function(f,g){f.stopImmediatePropagation();f.preventDefault();this.fetchCollocatesForNode(g)}.bind(a)).on("contextmenu",function(f,g,h){f.preventDefault();h=a.getContextMenu();h.queryById("label").setHtml(g.term);h.queryById("fixed").setChecked(g.fixed);h.showAt(f.pageX+10,f.pageY-50)}).call(d3.drag().on("start",function(f,g){a.setDragging(!0);f.active||a.getVisLayout().alpha(.3).restart();g.fx=g.x;g.fy=g.y;g.fixed=!0}).on("drag",function(f,g){a.getVisLayout().alpha(.3);
g.fx=f.x;g.fy=f.y;a.isMasked()?a.isOffCanvas(f.x,f.y)||a.unmask():a.isOffCanvas(f.x,f.y)&&a.mask(a.localize("releaseToRemove"))}).on("end",function(f,g){a.setDragging(!1);1!=g.fixed&&(g.fx=null,g.fy=null);a.isOffCanvas(f.x,f.y)&&(a.unmask(),a.mask(a.localize("cleaning")),a.removeNode(g.id),a.unmask())}));e.append("title");this.getNetworkMode()===this.DEFAULT_MODE?e.append("rect").style("stroke-width",1).style("stroke-opacity",1):e.filter(function(f){return"keyword"===f.type}).append("circle").style("stroke-width",
1).style("stroke-opacity",1);e.append("text").attr("font-family",function(f){return a.getApplication().getCategoriesManager().getFeatureForTerm("font",f.term)}).text(function(f){return f.term}).style("cursor","pointer").style("user-select","none").attr("dominant-baseline","middle");d=e.merge(d);d.selectAll("title").text(function(f){return f.title});d.selectAll("text").attr("font-size",function(f){return Math.max(10,Math.sqrt(f.value))}).each(function(f){f.bbox=this.getBBox()});this.setNodes(d);this.getNetworkMode()===
this.DEFAULT_MODE?(this.getVis().selectAll("rect").attr("width",function(f){return f.bbox.width+16}).attr("height",function(f){return f.bbox.height+8}).attr("rx",function(f){return Math.max(2,.2*f.bbox.height)}).attr("ry",function(f){return Math.max(2,.2*f.bbox.height)}).call(this.applyNodeStyle.bind(this)),this.getVis().selectAll("text").attr("dx",8).attr("dy",function(f){return.5*f.bbox.height+4})):(this.getVis().selectAll("circle").attr("r",function(f){return Math.min(150,f.bbox.width)}).call(this.applyNodeStyle.bind(this)),
this.getVis().selectAll("text").attr("dx",function(f){return"keyword"===f.type?.5*-f.bbox.width:8}).attr("dy",function(f){return"keyword"===f.type?0:.5*f.bbox.height+4}));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVisLayout().nodes(b);this.getVisLayout().force("link").links(c);this.getVisLayout().alpha(1).restart()},isOffCanvas:function(a,b){var c=Ext.get(this.getVisId());return 0>a||0>b||a>c.getWidth()||b>c.getHeight()},zoomToFit:function(a,b){var c=this.getVis().node().getBBox(),
d=c.width,e=c.height,f=c.x+d/2,g=c.y+e/2;c=this.getVis().node().parentElement;var h=c.getBoundingClientRect(),k=h.width;h=h.height;a=(a||.8)/Math.max(d/k,e/h);f=[k/2-a*f,h/2-a*g];1>d||d3.select(c).transition().duration(b||500).call(this.getZoom().transform,d3.zoomIdentity.translate(f[0],f[1]).scale(a))},applyNodeStyle:function(a,b){var c=void 0===b?"normal":b;a.style("fill",function(d){d=d.type+"Node";return this.getGraphStyle()[d][c].fill}.bind(this));a.style("stroke",function(d){d=d.type+"Node";
return this.getGraphStyle()[d][c].stroke}.bind(this))},applyLinkStyle:function(a,b){var c=void 0===b?"normal":b;a.style("stroke",function(d){return this.getGraphStyle().link[c].stroke}.bind(this));a.style("stroke-opacity",function(d){return this.getGraphStyle().link[c].strokeOpacity}.bind(this))},linkMouseOver:function(a,b){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this));this.getVis().select("#"+b.id).call(this.applyLinkStyle.bind(this),"highlight")},linkMouseOut:function(a,b){this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},
nodeMouseOver:function(a,b){this.setCurrentNode(b);this.getVis().selectAll("rect").call(this.applyNodeStyle.bind(this));this.getLinks().each(function(c){if(c.source.id==b.id)var d=c.target.id;else c.target.id==b.id&&(d=c.source.id);void 0!==d&&(this.getVis().select("#"+d+" rect").call(this.applyNodeStyle.bind(this),"highlight"),this.getVis().select("#"+c.id).call(this.applyLinkStyle.bind(this),"highlight"))}.bind(this));this.getVis().select("#"+b.id+" rect").style("stroke-width",3).call(this.applyNodeStyle.bind(this),
"highlight")},nodeMouseOut:function(a,b){this.getContextMenu().isVisible()||this.setCurrentNode(void 0);this.getVis().selectAll("rect").style("stroke-width",1).call(this.applyNodeStyle.bind(this));this.getVis().selectAll("line").call(this.applyLinkStyle.bind(this))},fetchCollocatesForNode:function(a){var b=this.getApiParam("limit"),c=this.getApiParam("query");c=Ext.Array.from(this.getApiParam("query"));Ext.Array.include(c,a.term);this.setApiParam("query",c);this.getCorpus().getCorpusCollocates({autoLoad:!1,
parentPanel:this}).load({params:Ext.apply(this.getApiParams(),{query:a.term,start:a.start,limit:b}),callback:function(d,e,f){f&&(this.updateDataForNode(a.id,{start:a.start+b}),this.loadFromCorpusCollocateRecords(d,a.id))},scope:this})}});Ext.define("Voyant.panel.Constellation",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.constellation",statics:{i18n:{title:"Constellation",options:"Options",selectedTerms:"Selected Terms",hideUnselected:"Hide Unselected Terms",cutoff:"Similarity Threshold",numTerms:"Terms",analysis:"Analysis",ca:"Correspondence Analysis",pca:"Principal Component Analysis",tsne:"t-SNE",distance:"Distance Metric",cosine:"Cosine Similarity",euclidean:"Euclidean",maxStrength:"Max Strength",maxConnections:"Max Connections",
linkStrength:"Link Strength",bodyStrength:"Body Strength",help:"Constellation produces a specialized network graph of high frequency terms that are connected by similar word vectors.",helpTip:"Constellation produces a specialized network graph of high frequency terms that are connected by similar word vectors."},api:{analysis:"ca",docId:void 0,limit:150,dimensions:3,stopList:"auto"},glyph:"xf1e0@FontAwesome"},config:{caStore:void 0,pcaStore:void 0,tsneStore:void 0,jsLoaded:!1,corpusLoaded:!1,chartData:void 0,
metric:"cosine",maxStrength:1E3,maxConnections:50,linkStrength:1500,bodyStrength:-1500,options:[{xtype:"stoplistoption"}]},constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){this.setCaStore(Ext.create("Voyant.data.store.CAAnalysis",{parentPanel:this,listeners:{load:this.handleData,scope:this}}));this.setPcaStore(Ext.create("Voyant.data.store.PCAAnalysis",{parentPanel:this,listeners:{load:this.handleData,
scope:this}}));this.setTsneStore(Ext.create("Voyant.data.store.TSNEAnalysis",{parentPanel:this,listeners:{load:this.handleData,scope:this}}));Ext.apply(this,{title:this.localize("title"),layout:"border",items:[{xtype:"container",region:"center",layout:"fit",style:"backgroundColor: #fff",items:{xtype:"component",itemId:"visParent",listeners:{resize:function(a,b,c){if(a=a.getEl().down("svg"))d3.select(a.dom).attr("width",b).attr("height",c),Ext.Function.defer(this.zoomToFit,50,this)},scope:this}}},
{title:this.localize("options"),xtype:"panel",width:200,minWidth:150,region:"west",split:!0,collapsible:!0,scrollable:"y",layout:{type:"vbox",align:"stretch"},defaults:{xtype:"button",margin:"5",labelAlign:"top"},items:[{xtype:"documentselectorbutton"},{text:this.localize("analysis"),itemId:"analysis",glyph:"xf1ec@FontAwesome",menu:{items:[{text:this.localize("ca"),itemId:"analysis_ca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("pca"),itemId:"analysis_pca",group:"analysis",xtype:"menucheckitem"},
{text:this.localize("tsne"),itemId:"analysis_tsne",group:"analysis",xtype:"menucheckitem"}],listeners:{render:function(a){a.child("#analysis_"+this.getApiParam("analysis")).setChecked(!0)},click:function(a,b){void 0!==b&&(a=b.getItemId().split("_")[1],a!==this.getApiParam("analysis")&&(this.setApiParam("analysis",a),this.loadFromApis()))},scope:this}}},{xtype:"slider",fieldLabel:this.localize("numTerms"),minValue:10,maxValue:1E3,increment:5,listeners:{render:function(a){a.setValue(this.getApiParam("limit"))},
changecomplete:function(a,b){this.setApiParam("limit",b);this.loadFromApis()},scope:this}},{xtype:"container",html:'\x3chr style\x3d"border: none; border-top: 1px solid #cfcfcf;"/\x3e'},{text:this.localize("distance"),menu:{items:[{text:this.localize("cosine"),itemId:"metric_cosine",group:"metric",xtype:"menucheckitem"},{text:this.localize("euclidean"),itemId:"metric_euclidean",group:"metric",xtype:"menucheckitem"}],listeners:{render:function(a){a.child("#metric_"+this.getMetric()).setChecked(!0)},
click:function(a,b){void 0!==b&&(a=b.getItemId().split("_")[1],a!==this.getMetric()&&(this.setMetric(a),this.loadFromApis()))},scope:this}}},{xtype:"slider",fieldLabel:this.localize("maxStrength"),minValue:0,maxValue:8E3,increment:1,listeners:{render:function(a){a.setValue(this.getMaxStrength())},changecomplete:function(a,b){this.setMaxStrength(b);this.updateGraph()},scope:this}},{xtype:"slider",fieldLabel:this.localize("maxConnections"),minValue:2,maxValue:100,increment:1,listeners:{render:function(a){a.setValue(this.getMaxConnections())},
changecomplete:function(a,b){this.setMaxConnections(b);this.updateGraph()},scope:this}},{xtype:"slider",fieldLabel:this.localize("linkStrength"),value:this.getLinkStrength(),minValue:1,maxValue:3E3,increment:1,listeners:{change:function(a,b){this.setLinkStrength(b);this.getChartData().simulation.force("link").distance(function(c){return c.sim*b});this.getChartData().simulation.alpha(1).restart()},scope:this}},{xtype:"slider",fieldLabel:this.localize("bodyStrength"),value:this.getBodyStrength(),minValue:-3E3,
maxValue:-1,increment:1,listeners:{change:function(a,b){this.setBodyStrength(b);this.getChartData().simulation.force("body").strength(b);this.getChartData().simulation.alpha(1).restart()},scope:this}},{xtype:"container",html:'\x3chr style\x3d"border: none; border-top: 1px solid #cfcfcf;"/\x3e'},{xtype:"checkbox",itemId:"hideUnselected",boxLabel:this.localize("hideUnselected"),listeners:{change:function(a,b){this.getChartData().hide_unselected=b;Voyant.panel.Constellation.constellation.update_graph(this.getChartData())},
scope:this}},{xtype:"multiselector",title:this.localize("selectedTerms"),itemId:"selectedTerms",fieldName:"label",fieldTitle:"Term",disableSelection:!0,search:{xtype:"multiselector-search",width:200,height:200,store:Ext.create("Ext.data.JsonStore",{fields:["id","label"],data:[]})},store:Ext.create("Ext.data.JsonStore",{fields:["id","label"],data:[],listeners:{add:function(a,b){a=this.parseSelection(b[0].get("label"));this.getChartData().selection.add(a.id);Voyant.panel.Constellation.constellation.update_graph(this.getChartData(),
!1)},remove:function(a,b){a=b[0];this.getChartData().selection.delete(a.get("id"));Voyant.panel.Constellation.constellation.update_graph(this.getChartData(),!1)},scope:this}})}]}]});this.on("boxready",function(a,b){console.log("boxready");d3.select("head").insert("script").attr("type","module").attr("onload",function(){this.setJsLoaded(!0);this.getCorpusLoaded()&&(console.log("br load"),this.loadFromApis())}.bind(this)).attr("src",Voyant.application.getBaseUrl()+"resources/constellation/main.js");
d3.select("head").insert("link").attr("rel","stylesheet").attr("type","text/css").attr("href",Voyant.application.getBaseUrl()+"resources/constellation/style.css")},this);this.on("loadedCorpus",function(a,b){this.isVisible()&&(console.log("loadedCorpus"),this.getCaStore().setCorpus(b),this.getPcaStore().setCorpus(b),this.getTsneStore().setCorpus(b),this.setCorpusLoaded(!0),this.getJsLoaded()&&(console.log("lc load"),this.loadFromApis()))},this);this.on("corpusSelected",function(a,b){this.setApiParam("docId",
void 0);this.loadFromApis()},this);this.on("documentsSelected",function(a,b){this.setApiParam("docId",b);this.loadFromApis()},this);this.on("activate",function(){this.getCorpus()},this);this.on("query",function(a,b){this.loadFromQuery(b)},this);this.on("constellationJSLoaded",function(){console.log("constellationJSLoaded");this.getJsLoaded()&&this.getCorpusLoaded()&&this.loadFromApis()});this.callParent(arguments)},initGraph:function(a,b){var c=this,d=this.down("#visParent").getEl();d.update("");
var e=d.getWidth(),f=d.getHeight();d=d3.select(d.dom).append("svg").attr("width",e).attr("height",f).attr("id","constellationGraph");e=$jscomp.makeIterator(Voyant.panel.Constellation.constellation.init_graph(e,f,"constellationGraph"));d=e.next().value;simulation=e.next().value;simulation.force("link").distance(function(h){return h.sim*c.getLinkStrength()});simulation.force("body").strength(this.getBodyStrength());d.select("#nodes").on("click",function(h){this.down("#selectedTerms").getStore().loadRawData([h.target.__data__],
!0)}.bind(this));e="cosine"===this.getMetric()?Voyant.panel.Constellation.vec.cosine_similarity:Voyant.panel.Constellation.vec.distance;var g=new Set;this.down("#selectedTerms").getStore().each(function(h){g.add(h.get("id"))});this.setChartData({svg:d,simulation:simulation,metric:e,cutoff:this.getMaxStrength(),connections:this.getMaxConnections(),hidden:!1,hide_unselected:this.down("#hideUnselected").getValue(),selection:g,nodes:a,edges:b})},updateGraph:function(){var a=this.getChartData();a.cutoff=
this.getMaxStrength();a.connections=this.getMaxConnections();Voyant.panel.Constellation.constellation.update_graph(a)},handleNodeClick:function(a,b){a.stopImmediatePropagation();a.preventDefault();this.dispatchEvent("termsClicked",this,[b.id])},loadFromApis:function(){if(void 0!==Voyant.panel.Constellation.vec){var a={};Ext.apply(a,this.getApiParams());delete a.analysis;"tsne"===this.getApiParam("analysis")?this.getTsneStore().load({params:a}):"pca"===this.getApiParam("analysis")?this.getPcaStore().load({params:a}):
this.getCaStore().load({params:a})}},handleData:function(a){a=a.getAt(0).getTokens().map(function(e){return e.getData()});"ca"===this.getApiParam("analysis")&&(a=a.filter(function(e){return"term"===e.category}));var b=a.map(function(e){return{id:e.term,label:e.term,vector:e.vector}}),c=[],d=this.down("#selectedTerms").getStore();d.each(function(e){var f=e.get("id");void 0===b.find(function(g){return g.id===f})&&c.push(e)});c.forEach(function(e){d.remove(e)});this.down("#selectedTerms").getSearch().store.loadRawData(b);
a="cosine"===this.getMetric()?Voyant.panel.Constellation.vec.cosine_similarity:Voyant.panel.Constellation.vec.distance;a=Voyant.panel.Constellation.constellation.generate_edges(b,a);this.initGraph(b,a);this.updateGraph()},parseSelection:function(a){var b=this.getChartData(),c=Voyant.panel.Constellation.vec,d=c.get_from_array(a,b.nodes);if(!1!==d)return d;var e=a.split(" ");d=null;var f=c.add;e=$jscomp.makeIterator(e);for(var g=e.next();!g.done;g=e.next()){g=g.value;var h=c.get_from_array(g,b.nodes).vector;
"+"===g?f=c.add:"-"===g?f=c.subtract:void 0!==h?d=f(d,h):console.log("unknown word",g)}return null===d?!1:Voyant.panel.Constellation.constellation.insert_node(a,a,d,b)}});Ext.define("Voyant.panel.Contexts",{extend:"Ext.grid.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Contexts"],alias:"widget.contexts",isConsumptive:!0,statics:{i18n:{},api:{query:void 0,docId:void 0,docIndex:void 0,stopList:"auto",context:5,expand:50,columns:void 0,sort:void 0,dir:void 0,termColors:"categories"},glyph:"xf0ce@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"},{xtype:"termcolorsoption"}]},constructor:function(){this.mixins["Voyant.util.Api"].constructor.apply(this,
...
if("city"==e){this.handleLocationClick(a,d);break}else if("connection"==e){this.handleConnectionClick(d,a.pixel[0],a.pixel[1]);break}else if("annotation"==e){this.editAnnotation(d);break}}},handleConnectionClick:function(a,b,c){Ext.create("Ext.menu.Menu",{items:[{text:this.localize("viewConnections"),tooltip:this.localize("viewConnectionsTip"),glyph:"xf02d@FontAwesome",handler:function(){this.mask("loadingConnections");var d=this;Ext.Ajax.request({url:this.getTromboneUrl(),params:{forTool:"dreamscape",
tool:"corpus.Dreamscape",corpus:this.getCorpus().getId(),suppressLocations:!0,suppressConnections:!0,sourceId:a.get("source"),targetId:a.get("target"),context:2,limit:25},scope:this}).then(function(e){d.unmask();if((e=Ext.JSON.decode(e.responseText))&&e.dreamscape&&e.dreamscape.connectionOccurrences){var f="\x3ctable style\x3d'font-size:smaller'\x3e";e.dreamscape.connectionOccurrences.connectionOccurrences.forEach(function(g){f+="\x3ctr\x3e\x3ctd style\x3d'text-align: right'\x3e"+g.source.left+"\x3c/td\x3e\x3ctd class\x3d'keyword' style\x3d'text-align: center'\x3e"+
...
this.getApiParam("docId"))},searchEntities:function(a){a=a.trim().toLowerCase();var b=this.down("entitieslist");0<a.length?(b.getStore().filterBy(function(c){return-1!==c.getTerm().toLowerCase().indexOf(a)}),b.getView().findFeature("grouping").expandAll()):(b.getStore().clearFilter(),b.getView().findFeature("grouping").collapseAll())}});Ext.define("Voyant.panel.Knots",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.knots",statics:{i18n:{},api:{query:void 0,stopList:"auto",docId:void 0,audio:!1},glyph:"xf06e@FontAwesome"},config:{knots:void 0,termStore:void 0,docTermStore:void 0,tokensStore:void 0,options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"},{xtype:"colorpaletteoption"}],refreshInterval:100,startAngle:315,angleIncrement:15,currentTerm:void 0},termTpl:new Ext.XTemplate('\x3ctpl for\x3d"."\x3e',
'\x3cdiv class\x3d"term" style\x3d"color: rgb({color});float: left;padding: 3px;margin: 2px;"\x3e{term}\x3c/div\x3e',"\x3c/tpl\x3e"),constructor:function(){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(a,b){a=this.getApiParam("docId");void 0===a&&(a=b.getDocument(0).getId(),this.setApiParam("docId",a));a=this.processDocument(b.getDocument(a));this.getKnots().setCurrentDoc(a);this.getDocTermStore().getProxy().setExtraParam("corpus",
b.getId());this.getTokensStore().setCorpus(b);b=5;a=this.getApiParam("query");void 0!=a&&""!=a&&(b=Array.isArray(a)?a.length:a.split(",").length);this.getDocTermStore().load({params:{query:a,limit:b,stopList:this.getApiParams("stopList")}})},this);this.on("activate",function(){this.getCorpus()&&Ext.Function.defer(function(){this.getDocTermStore().load({params:{limit:5,stopList:this.getApiParams("stopList")}})},100,this)},this);this.on("query",function(a,b){void 0!==b&&""!=b&&this.getDocTermsFromQuery(b)},
this);this.on("documentSelected",function(a,b){a=this.getCorpus().getDocument(b);this.setApiParam("docId",a.getId());var c=this.getKnots().currentDoc.terms;b=[];for(var d in c)b.push(d);this.setApiParams({query:b});d=b.length;0===d&&(d=5);this.getKnots().setCurrentDoc(this.processDocument(a));this.getDocTermStore().load({params:{query:b,limit:d,stopList:this.getApiParams("stopList")}})},this);this.on("termsClicked",function(a,b){var c=[];b.forEach(function(d){Ext.isString(d)?c.push(d):d.term?c.push(d.term):
d.getTerm&&c.push(d.getTerm())});0<c.length&&this.getDocTermsFromQuery(c)},this);this.on("corpusTermsClicked",function(a,b){var c=[];b.forEach(function(d){d.getTerm()&&c.push(d.getTerm())});this.getDocTermsFromQuery(c)},this);this.on("documentTermsClicked",function(a,b){var c=[];b.forEach(function(d){d.getTerm()&&c.push(d.getTerm())});this.getDocTermsFromQuery(c)},this)},initComponent:function(){this.setTermStore(Ext.create("Ext.data.ArrayStore",{fields:["term","color"]}));this.setDocTermStore(Ext.create("Ext.data.Store",
{model:"Voyant.data.model.DocumentTerm",autoLoad:!1,remoteSort:!1,proxy:{type:"ajax",url:Voyant.application.getTromboneUrl(),extraParams:{forTool:"knots",tool:"corpus.DocumentTerms",withDistributions:"raw",withPositions:!0},reader:{type:"json",rootProperty:"documentTerms.terms",totalProperty:"documentTerms.total"},simpleSortMode:!0},listeners:{beforeload:function(a){a.getProxy().setExtraParam("docId",this.getApiParam("docId"))},load:function(a,b,c,d){var e={};b&&0<b.length?(b.forEach(function(f){var g=
this.processTerms(f);f.get("docId");f=f.get("term");e[f]=g},this),this.getKnots().addTerms(e),this.getKnots().buildGraph()):this.toastInfo({html:this.localize("noTermsFound"),align:"bl"})},scope:this}}));this.setTokensStore(Ext.create("Voyant.data.store.Tokens",{stripTags:"all",listeners:{beforeload:function(a){a.getProxy().setExtraParam("docId",this.getApiParam("docId"))},load:function(a,b,c,d){var e="",f=this.getCurrentTerm();b.forEach(function(g){e=g.getPosition()==f.tokenId?e+("\x3cstrong\x3e"+
g.getTerm()+"\x3c/strong\x3e"):e+g.getTerm()});Ext.Msg.show({title:this.localize("context"),message:e,buttons:Ext.Msg.OK,icon:Ext.Msg.INFO})},scope:this}}));Ext.apply(this,{title:this.localize("title"),dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"querysearchfield"},{text:this.localize("clearTerms"),glyph:"xf00d@FontAwesome",handler:function(){this.down("#termsView").getSelectionModel().deselectAll(!0);this.getTermStore().removeAll();this.setApiParams({query:null});
this.getKnots().removeAllTerms();this.getKnots().drawGraph()},scope:this},{xtype:"documentselectorbutton",singleSelect:!0},{xtype:"slider",itemId:"speed",fieldLabel:this.localize("speed"),labelAlign:"right",labelWidth:50,width:100,increment:50,minValue:0,maxValue:500,value:500-this.getRefreshInterval(),listeners:{changecomplete:function(a,b){this.setRefreshInterval(500-b);this.getKnots()&&this.getKnots().buildGraph()},scope:this}},{xtype:"slider",itemId:"startAngle",fieldLabel:this.localize("startAngle"),
labelAlign:"right",labelWidth:35,width:85,increment:15,minValue:0,maxValue:360,value:this.getStartAngle(),listeners:{changecomplete:function(a,b){this.setStartAngle(b);this.getKnots()&&this.getKnots().buildGraph()},scope:this}},{xtype:"slider",itemId:"tangles",fieldLabel:this.localize("tangles"),labelAlign:"right",labelWidth:30,width:80,increment:5,minValue:5,maxValue:90,value:this.getAngleIncrement(),listeners:{changecomplete:function(a,b){this.setAngleIncrement(b);this.getKnots()&&this.getKnots().buildGraph()},
scope:this}},{xtype:"checkbox",boxLabel:this.localize("sound"),listeners:{render:function(a){a.setValue(!0===this.getApiParam("audio")||"true"==this.getApiParam("audio"));Ext.tip.QuickTipManager.register({target:a.getEl(),text:this.localize("soundTip")})},beforedestroy:function(a){Ext.tip.QuickTipManager.unregister(a.getEl())},change:function(a,b){this.getKnots()&&this.getKnots().setAudio(b)},scope:this}}]}],border:!1,layout:"fit",items:{layout:{type:"vbox",align:"stretch"},defaults:{border:!1},items:[{height:30,
itemId:"termsView",xtype:"dataview",store:this.getTermStore(),tpl:this.termTpl,itemSelector:"div.term",overItemCls:"over",selectedItemCls:"selected",selectionModel:{mode:"SIMPLE"},focusCls:"",listeners:{beforeitemclick:function(a,b,c,d,e,f){e.preventDefault();e.stopPropagation();a.fireEvent("itemcontextmenu",a,b,c,d,e,f);return!1},beforecontainerclick:function(){event.preventDefault();event.stopPropagation();return!1},selectionchange:function(a,b){var c=this.down("#termsView"),d=[];c.getStore().each(function(e){-1!==
b.indexOf(e)?(d.push(e.get("term")),Ext.fly(c.getNodeByRecord(e)).removeCls("unselected").addCls("selected")):Ext.fly(c.getNodeByRecord(e)).removeCls("selected").addCls("unselected")});this.getKnots().termsFilter=d;this.getKnots().drawGraph()},itemcontextmenu:function(a,b,c,d,e){e.preventDefault();e.stopPropagation();var f=a.isSelected(c);(new Ext.menu.Menu({floating:!0,items:[{text:f?this.localize("hideTerm"):this.localize("showTerm"),handler:function(){f?a.deselect(d):a.select(d,!0)},scope:this},
{text:this.localize("removeTerm"),handler:function(){a.deselect(d);var g=this.getTermStore().getAt(d).get("term");this.getTermStore().removeAt(d);a.refresh();this.getKnots().removeTerm(g);this.getKnots().drawGraph()},scope:this}]})).showAt(e.getXY())},scope:this}},{flex:1,xtype:"container",autoEl:"div",itemId:"canvasParent",layout:"fit",overflowY:"auto",overflowX:"hidden"}],listeners:{render:function(a){a=this.down("#canvasParent");this.setKnots(new Knots({container:a,clickHandler:this.knotClickHandler.bind(this),
audio:!0===this.getApiParam("audio")||"true"==this.getApiParam("audio")}))},afterlayout:function(a){!1===this.getKnots().initialized&&this.getKnots().initializeCanvas()},resize:function(a,b,c){this.getKnots().doLayout()},scope:this}}});this.callParent(arguments)},updateRefreshInterval:function(a){this.getKnots()&&(50>a?(a=50,this.getKnots().progressiveDraw=!1):this.getKnots().progressiveDraw=!0,this.getKnots().refreshInterval=a,this.getKnots().buildGraph(this.getKnots().drawStep))},updateStartAngle:function(a){this.getKnots()&&
(this.getKnots().startAngle=a,this.getKnots().recache(),this.getKnots().buildGraph())},updateAngleIncrement:function(a){this.getKnots()&&(this.getKnots().angleIncrement=a,this.getKnots().recache(),this.getKnots().buildGraph())},loadFromCorpusTerms:function(a){this.getKnots()&&(this.getKnots().removeAllTerms(),this.getTermStore().removeAll(!0));a.load({callback:function(b,c,d){var e=[];"string"==typeof e&&(e=[e]);b.forEach(function(f,g){e.push(f.get("term"))},this);this.getDocTermsFromQuery(e)},scope:this,
params:{limit:5,stopList:this.getApiParams("stopList")}})},getDocTermsFromQuery:function(a){a&&this.setApiParam("query",a);this.getCorpus()&&this.isVisible()&&(this.setApiParams({query:a}),this.getDocTermStore().load({params:this.getApiParams()}))},filterDocuments:function(){var a=this.getApiParam("docId");""==a&&(a=[],this.getCorpus().getDocuments().each(function(d,e){a.push(d.getId())}),this.setApiParams({docId:a}));"string"==typeof a&&(a=[a]);if(null==a){this.selectedDocs=this.getCorpus().getDocuments().clone();
var b=this.selectedDocs.getCount();if(10<b)for(var c=10;c<b;c++)this.selectedDocs.removeAt(10);a=[];this.selectedDocs.eachKey(function(d,e){a.push(d)},this);this.setApiParams({docId:a})}else this.selectedDocs=this.getCorpus().getDocuments().filterBy(function(d,e){return-1!=a.indexOf(e)},this)},processDocument:function(a){var b=a.getShortTitle();b=b.replace("\x26hellip;","...");return{id:a.getId(),index:a.get("index"),title:b,totalTokens:a.get("tokensCount-lexical"),terms:{},lineLength:void 0}},processTerms:function(a){var b=
a.get("term");var c=a.get("rawFreq"),d=a.get("positions");if(0<c){var e=this.getApplication().getColorForTerm(b);if(-1===this.getTermStore().find("term",b)){this.getTermStore().loadData([[b,e]],!0);var f=this.getTermStore().find("term",b);this.down("#termsView").select(f,!0)}a=a.get("distributions");b={term:b,positions:d,distributions:a,rawFreq:c,color:e}}else b=!1;return b},knotClickHandler:function(a){this.setCurrentTerm(a);var b=a.tokenId-10;0>b&&(b=0);this.getTokensStore().load({start:b,limit:21});
...
a)}});Ext.define("Voyant.panel.Embedder",{extend:"Ext.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.embedder",statics:{i18n:{title:"Embedder",url:"URL",go:"Go",help:"Embedder provides a way to embed a web page into your Voyant Tools experience.\x3cbr\x3eNB: modern security practices will prevent many URLs from being embedded.",helpTip:"Embedder provides a way to embed a web page into your Voyant Tools experience."},api:{url:void 0},glyph:"xf0c1@FontAwesome"},constructor:function(a){this.mixins["Voyant.util.Api"].constructor.apply(this,
arguments);a.url&&this.setApiParam("url",a.url);this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){Ext.apply(this,{title:this.localize("title"),layout:{type:"fit"},items:{xtype:"uxiframe",src:this.getApiParam("url")},tbar:[{xtype:"textfield",value:this.getApiParam("url"),emptyText:this.localize("url"),listeners:{specialkey:function(a,b){b.getKey()==b.ENTER&&a.up("panel").loadUrl(a.getValue())}}},{xtype:"button",text:this.localize("go"),
handler:function(a){var b=a.prev("textfield").getValue();a.up("panel").loadUrl(b)}}]});this.callParent()},loadUrl:function(a){this.down("uxiframe").load(a)}});Ext.define("Voyant.panel.Fountain",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.fountain",statics:{i18n:{title:"FountainMeter"},api:{stopList:"auto",docIndex:0,speed:30,groups:void 0},glyph:"xf06e@FontAwesome"},config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}],audio:!1,words:[],groups:{},moveWordsTimeout:void 0},constructor:function(){this.mixins["Voyant.util.Localization"].constructor.apply(this,arguments);Ext.apply(this,{title:this.localize("title"),
...
b);f<d;)e.push(a.slice(f,f+=c));else if(c)for(;f<d;)c=Math.ceil((d-f)/b--),e.push(a.slice(f,f+=c));else{b--;c=Math.floor(d/b);for(0===d%c&&c--;f<c*b;)e.push(a.slice(f,f+=c));e.push(a.slice(c*b))}return e},initComponent:function(){this.callParent(arguments)}});Ext.define("Voyant.panel.RezoViz",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.rezoviz",statics:{i18n:{timedOut:"The entities call took too long and has timed out. Retry?",maxLinks:"Max. Links",nerService:"Entity Identification Service"},api:{limit:50,type:["organization","location","person"],minEdgeCount:2,docId:void 0,nerService:"spacy"},glyph:"xf1e0@FontAwesome"},config:{graphStyle:{link:{normal:{stroke:"#000000",strokeOpacity:.1},highlight:{stroke:"#000000",strokeOpacity:.5}}}},
constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(){var a=this,b={};["person","location","organization"].forEach(function(c){var d=a.getApplication().getColorForEntityType(c,!0),e=d3.hsl(d);e.s*=.85;e.l*=1.15;var f=d3.hsl(d);f.s*=.85;var g=d3.hsl(d);d=d3.hsl(d);d.l*=.75;b[c+"Node"]={normal:{fill:e.toString(),stroke:f.toString()},highlight:{fill:g.toString(),stroke:d.toString()}}});this.setGraphStyle(Ext.apply(this.getGraphStyle(),
b));Ext.apply(a,{title:this.localize("title"),layout:"fit",items:{xtype:"voyantnetworkgraph",applyNodeStyle:function(c,d){var e=void 0===d?"normal":d;this.getGraphStyle();c.selectAll("rect").style("fill",function(f){f=f.type+"Node";return a.getGraphStyle()[f][e].fill}).style("stroke",function(f){f=f.type+"Node";return a.getGraphStyle()[f][e].stroke})},listeners:{nodeclicked:function(c,d){a.dispatchEvent("termsClicked",a,[d.term])},edgeclicked:function(c,d){a.dispatchEvent("termsClicked",a,['"'+d.source.term+
" "+d.target.term+'"~'+a.getApiParam("context")])}}},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"corpusdocumentselector"},{xtype:"button",text:this.localize("categories"),menu:{items:[{xtype:"menucheckitem",text:this.localize("people"),itemId:"person",checked:!0},{xtype:"menucheckitem",text:this.localize("locations"),itemId:"location",checked:!0},{xtype:"menucheckitem",text:this.localize("organizations"),itemId:"organization",checked:!0},{xtype:"button",text:this.localize("reload"),
style:"margin: 5px;",handler:this.categoriesHandler,scope:this}]}},{xtype:"button",text:this.localize("nerService"),menu:{items:[{xtype:"menucheckitem",group:"nerService",text:"SpaCy",itemId:"spacy",checked:!0,handler:this.serviceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:"NSSI",itemId:"nssi",checked:!0,handler:this.serviceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:"Voyant",itemId:"voyant",checked:!1,handler:this.serviceHandler,scope:this}]}},{xtype:"numberfield",
itemId:"minEdgeCount",fieldLabel:this.localize("minEdgeCount"),labelAlign:"right",labelWidth:120,width:170,maxValue:10,minValue:1,allowDecimals:!1,allowExponential:!1,allowOnlyWhitespace:!1,listeners:{render:function(c){c.setRawValue(this.getApiParam("minEdgeCount"))},change:function(c,d){c.isValid()&&(this.setApiParam("minEdgeCount",d),this.preloadEntities())},scope:this}},{xtype:"slider",fieldLabel:this.localize("maxLinks"),labelAlign:"right",labelWidth:100,width:170,minValue:10,maxValue:1E3,increment:10,
listeners:{render:function(c){c.setValue(this.getApiParam("limit"))},changecomplete:function(c,d){this.setApiParam("limit",d);this.preloadEntities()},scope:this}}]}],listeners:{entityResults:function(c,d){this.getEntities()},scope:this}});this.on("loadedCorpus",function(c,d){this.isVisible()&&this.preloadEntities()},this);this.on("corpusSelected",function(c,d){this.setApiParam("docId",void 0);this.preloadEntities()},this);this.on("documentsSelected",function(c,d){this.setApiParam("docId",d);this.preloadEntities()},
this);this.on("activate",function(){this.getCorpus()&&0===this.down("voyantnetworkgraph").getNodeData().length&&Ext.Function.defer(this.preloadEntities,100,this)},this);a.callParent(arguments)},categoriesHandler:function(a){var b=[];a.up("menu").items.each(function(c){c.checked&&b.push(c.itemId)});this.setApiParam("type",b);this.preloadEntities()},serviceHandler:function(a){this.setApiParam("nerService",a.itemId);this.preloadEntities()},preloadEntities:function(){var a=this.getApiParam("type");"spacy"===
this.getApiParam("nerService")&&(a=a.map(function(b){return Voyant.data.util.DocumentEntities.getSpacyTypesFromStanfordType(b)},this).flat(),this.setApiParam("type",a));new Voyant.data.util.DocumentEntities({annotator:this.getApiParam("nerService")})},getEntities:function(){this.down("voyantnetworkgraph").resetGraph();var a=this.getLayout().getRenderTarget();a.mask(this.localize("loadingEntities"));Ext.Ajax.request({url:this.getApplication().getTromboneUrl(),method:"POST",params:{tool:"corpus.EntityCollocationsGraph",
annotator:this.getApiParam("nerService"),type:this.getApiParam("type"),limit:this.getApiParam("limit"),minEdgeCount:this.getApiParam("minEdgeCount"),corpus:this.getCorpus().getId(),docId:this.getApiParam("docId"),noCache:!0},timeout:12E4,success:function(b){a.unmask();b=Ext.decode(b.responseText);if(0==b.entityCollocationsGraph.edges.length){this.showError({msg:this.localize("noEntities")});var c=this.getApiParam("minEdgeCount");1<c&&Ext.Msg.confirm(this.localize("error"),this.localize("noEntitiesForEdgeCount"),
...
yFisheye=d3.fisheye.scale(d3.scaleIdentity).domain([0,h]);var r=this;e.on("mousemove",function(w){var p=d3.pointer(w);currentItem=Math.round(p[1]*terms.length/h);currentItem=Math.min(currentItem,terms.length-1);n.focus(p[1]);yFisheye.focus(p[1]);w=m.nodes();w[currentItem]&&r.fireEvent("termHovered",r,w[currentItem].textContent);var v=14,q=Math.max(p[1],v),u=1;d3.select(w[currentItem]).attr("y",function(H){return q}).attr("font-size",v).attr("fill-opacity",u);for(var x=void 0,z=currentItem-1;-1<z;z--)8<=
v?(q-=v,v-=.5):(void 0==x&&(x=q/z),q-=x),.1<u&&(u-=.05),d3.select(w[z]).attr("y",function(H){return q}).attr("font-size",v).attr("fill-opacity",u);v=14;q=Math.max(p[1],v);u=1;x=void 0;z=currentItem+1;for(p=terms.length;z<p;z++)8<=v?(q+=v,v-=.5):(void 0==x&&(x=(h-q)/(p-z)),q+=x),.1<u&&(u-=.05),d3.select(w[z]).attr("y",function(H){return q}).attr("font-size",v).attr("fill-opacity",u)})}}},{itemId:"threads",layout:"fit",flex:1,listeners:{filterchange:function(e){var f=this.getTargetEl(),g=f.getWidth(),
...
v.term).attr("d",n).on("mouseover",function(u){d3.select(this).attr("opacity",1);u=d3.pointer(u);r.attr("opacity",1);w.attr("x",u[0]-35).attr("y",u[1]-8+(u[1]>h/2?-18:18));p.text(v.term).attr("fill",q).attr("x",u[0]).attr("y",u[1]+(u[1]>h/2?-18:18))}).on("mouseout",function(){d3.select(this).attr("opacity",0);r.attr("opacity",0)});r.raise()},this)}}}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[d[0],d[2],d[3],d[4],d[5],{fieldLabel:this.localize("visibleTerms"),labelWidth:70,
width:120,xtype:"slider",increment:25,minValue:25,maxValue:5E3,listeners:{afterrender:function(e){e.setValue(parseInt(this.getApiParam("limit")))},changecomplete:function(e,f){this.setApiParams({limit:f});this.fireEvent("loadedCorpus",this,this.getCorpus())},scope:this}},{text:this.localize("scaling"),menu:{defaults:{xtype:"menucheckitem",handler:function(e){this.setApiParam("scaling",e.getItemId());this.getComponent("threads").fireEventArgs("filterchange",[this.getStore()])},scope:this,listeners:{afterrender:function(e){e.setChecked(e.getItemId()==
this.getApiParam("scaling"))},scope:this},group:"scaling"},items:[{text:this.localize("scaleLinear"),itemId:"linear"},{text:this.localize("scaleLog"),itemId:"log"},{text:this.localize("scaleSqrt"),itemId:"sqrt"}]}}]}]});this.on("loadedCorpus",function(e,f){e=1==f.getDocumentsCount()?f.getDocumentTerms({parentPanel:this}):f.getCorpusTerms({parentPanel:this});e.on("load",function(){this.updateControlsFromStore();this.filterRecords()},this);e.on("filterchange",function(){this.getComponent("terms").fireEventArgs("filterchange",
...
this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("loadedCorpus",function(b,c){if(this.rendered)this.initialize();else this.on("afterrender",function(){this.initialize()},this)});this.on("query",function(b,c){this.setApiParam("query",c);this.updateSearchResults()});this.on("resize",function(b,c,d){this.getCorpus()&&this.initialize()})},initialize:function(){var a=this.getTargetEl(),b=this.getCorpus();this.setMaxVerticalLines(Math.floor((a.getHeight()-
10)/5));var c=b.getDocumentsCount(),d=10*c,e=Math.floor((a.getWidth()-d-10)/c);200<e&&(e=200);d=Math.floor(e/3);1>d&&(d=1);this.setMaxSegments(d*this.getMaxVerticalLines());b=b.getDocuments();this.setMaxTokens(b.max("tokensCount-lexical"));this.setTokensPerSegment(this.getMaxTokens()<this.getMaxSegments()?1:Math.ceil(this.getMaxTokens()/this.getMaxSegments()));var f="\x3ctable cellpadding\x3d'0' cellspacing\x3d'0' style\x3d'height: 100%'\x3e\x3ctr\x3e";this.segments=[];b.each(function(h){docIndex=
h.getIndex();f+='\x3ctd style\x3d"overflow: hidden; vertical-align: top; width: '+e+'px;"\x3e\x3cdiv class\x3d"docLabel" style\x3d"white-space: nowrap; width: '+e+'px;" data-qtip\x3d"'+h.getFullLabel()+'"\x3e'+h.getFullLabel()+'\x3c/div\x3e\x3ccanvas style\x3d"display: block;" width\x3d"'+e+'" height\x3d"'+a.getHeight()+'" id\x3d"'+this.body.id+"-"+docIndex+'"\x3e\x3c/td\x3e';docIndex+1<c&&(f+='\x3ctd style\x3d"width: 10px;"\x3e\x26nbsp;\x3c/td\x3e')},this);f+="\x3c/tr\x3e\x3c/table\x3e";a.update(f);
this.updateSearchResults();if(!this.getApiParam("query")){var g=this;return this.getCorpus().loadCorpusTerms({forTool:"microsearch",limit:1,stopList:this.getApiParam("stopList"),categories:this.getApiParam("categories")}).then(function(h){h=h.getAt(0).getTerm();g.down("querysearchfield").addValue(new Voyant.data.model.CorpusTerm({term:h}));g.fireEvent("query",g,[h])})}},updateSearchResults:function(){query=this.getApiParam("query");this.getCorpus().getDocuments().each(function(a){var b=this.redistributeDistributions(a,
Array(this.getMaxSegments()));this.drawDocumentDistributions(a,null,b)},this);0<Ext.Array.from(query).length&&(this.mask(this.localize("loading")),this.getCorpus().getDocumentTerms({parentPanel:this}).load({params:{query:Ext.Array.from(query),withDistributions:"relative",bins:this.getMaxSegments(),categories:this.getApiParam("categories")},callback:function(a,b,c){this.unmask();var d=0,e=Number.MAX_VALUE,f=[];a.forEach(function(g){var h=this.getCorpus().getDocument(g.getDocIndex()),k=this.redistributeDistributions(h,
g.getDistributions()),l=Ext.Array.max(k);l>d&&(d=l);k.forEach(function(m){m&&m<e&&(e=m)});void 0===f[g.getDocIndex()]&&(f[g.getDocIndex()]={});f[g.getDocIndex()][g.getTerm()]=this.redistributeDistributions(h,g.getDistributions())},this);f.forEach(function(g,h){for(var k in g){var l=g[k];this.drawDocumentDistributions(this.getCorpus().getDocument(h),k,l,e||Ext.Array.min(l),d||Ext.Array.max(l))}},this)},scope:this}))},redistributeDistributions:function(a,b){a=Math.ceil(a.getLexicalTokensCount()/this.getTokensPerSegment());
if(b.length>a){for(var c=[],d=0;d<b.length;d++){var e=parseInt(d*a/b.length);c[e]?c[e].push(b[d]):c[e]=[b[d]]}b=c;for(d=0;d<b.length;d++)b[d]=Ext.Array.mean(b[d])}return b},drawDocumentDistributions:function(a,b,c,d,e){var f=this.getTargetEl().dom.querySelector("#"+this.body.id+"-"+a.getIndex());a=f.getContext("2d");var g=0;f=f.clientWidth;var h=0,k=null===b,l=[230,230,230];k||(l=this.getApplication().getColorForTerm(b));for(b=0;b<c.length;b++)k?(a.fillStyle="rgb(230,230,230)",a.fillRect(g,h,3,3)):
c[b]&&(a.fillStyle="rgba("+l[0]+","+l[1]+","+l[2]+","+(.7*(c[b]-d)/(e-d)+.3)+")",a.fillRect(g,h,3,3)),g+=3,g>=f&&(g=0,h+=5)}});Ext.define("Voyant.panel.Mandala",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.mandala",statics:{i18n:{},api:{stopList:"auto",query:void 0,labels:!0},glyph:"xf1db@FontAwesome"},gutter:5,textFont:"12px sans-serif",config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}]},constructor:function(){this.mixins["Voyant.util.Localization"].constructor.apply(this,arguments);Ext.apply(this,{title:this.localize("title"),html:'\x3cdiv style\x3d"text-align: center"\x3e\x3ccanvas width\x3d"800" height\x3d"600"\x3e\x3c/canvas\x3e\x3c/div\x3e',
dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{text:this.localize("add"),glyph:"xf067@FontAwesome",handler:function(){this.editMagnet()},scope:this},{text:this.localize("clear"),glyph:"xf014@FontAwesome",handler:function(){this.setApiParam("query",void 0);this.updateFromQueries(!0);this.editMagnet()},scope:this},{xtype:"checkbox",boxLabel:this.localize("labels"),listeners:{render:function(a){a.setValue(!0===this.getApiParam("labels")||"true"==this.getApiParam("labels"));
Ext.tip.QuickTipManager.register({target:a.getEl(),text:this.localize("labelsTip")})},beforedestroy:function(a){Ext.tip.QuickTipManager.unregister(a.getEl())},change:function(a,b){this.setApiParam("labels",b);this.draw()},scope:this}}]}]});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.on("boxready",function(a){var b=this.getTargetEl().dom.querySelector("canvas"),c=this;b.addEventListener("mousemove",function(d){var e=b.getBoundingClientRect(),
f=d.clientX-e.left,g=d.clientY-e.top,h=!1,k=parseInt(c.textFont)/2;c.documents&&c.documents.forEach(function(l){var m=f>l.x-k&&f<l.x+k&&g>l.y-k&&g<l.y+k;m!=l.isHovering&&(h=!0);l.isHovering=m});radius=parseInt(c.textFont)/2;for(term in c.magnets)d=f>c.magnets[term].x-radius&&f<c.magnets[term].x+radius&&g>c.magnets[term].y-radius&&g<c.magnets[term].y+radius,d!=c.magnets[term].isHovering&&(h=!0),c.magnets[term].isHovering=d;h&&c.draw()},!1);b.addEventListener("click",function(d){var e=b.getBoundingClientRect(),
f=d.clientX-e.left;d=d.clientY-e.top;parseInt(c.textFont);for(term in c.magnets)f>c.magnets[term].x-radius&&f<c.magnets[term].x+radius&&d>c.magnets[term].y-radius&&d<c.magnets[term].y+radius&&c.editMagnet(term)},!1)});this.on("loadedCorpus",function(a,b){this.documents=[];a=this.getTargetEl().dom.querySelector("canvas");var c=a.getContext("2d"),d=a.width/2;c.font=this.textFont;b.getDocuments().each(function(e){var f=e.getTinyTitle();this.documents.push({doc:e,label:f,width:c.measureText(f).width,
x:d,y:d,matches:[],isHovering:!1})},this);this.updateDocs(a);this.draw();this.updateFromQueries()},this);this.on("resize",function(){var a=this.getTargetEl().dom.querySelector("canvas"),b=Math.min(this.getTargetEl().getWidth(),this.getTargetEl().getHeight());a.width=b;a.height=b;this.updateMagnets();this.updateDocs();this.draw(a)})},editMagnet:function(a){var b=this,c=Ext.Array.from(b.getApiParam("query"));Ext.create("Ext.window.Window",{title:this.localize("EditMagnet"),modal:!0,items:{xtype:"form",
width:300,items:[{xtype:"querysearchfield",corpus:this.getCorpus(),store:this.getCorpus().getCorpusTerms({parentPanel:this,proxy:{extraParams:{stopList:this.getApiParam("stopList")}}}),stopList:this.getApiParam("stopList"),listeners:{afterrender:function(d){if(a){var e=new Ext.create("Voyant.data.model.CorpusTerm",{term:a});d.getStore().loadData(e,!0);d.setValue(e)}}}},{xtype:"numberfield",fieldLabel:b.localize("rotateClockwise"),minValue:0,maxValue:c.length-1,value:0,stepValue:1,width:200,name:"rotate"}],
buttons:[{text:this.localize("remove"),glyph:"xf0e2@FontAwesome",flex:1,ui:"default-toolbar",handler:function(d){var e=Ext.Array.filter(Ext.Array.from(b.getApiParam("query")),function(f){return f!=a});b.setApiParam("query",e);b.updateFromQueries(0==e.length);d.up("window").close()},scope:this},{xtype:"tbfill"},{text:this.localize("cancel"),ui:"default-toolbar",glyph:"xf00d@FontAwesome",flex:1,handler:function(d){d.up("window").close()}},{text:this.localize("update"),glyph:"xf00c@FontAwesome",flex:1,
handler:function(d){var e=d.up("window").down("querysearchfield").getValue().join("|");if(e){for(var f=-1,g=0;g<c.length;g++)if(a==c[g]){f=g;c[g]=e;var h=d.up("window").down("numberfield").getValue();h&&(c.splice(g,1),g+=h,g>c.length&&(g-=c.length+1),c.splice(g,0,e));break}-1==f&&c.push(e)}b.setApiParam("query",c);b.updateFromQueries(0==c.length);d.up("window").close()},scope:this}]},bodyPadding:5}).show()},updateFromQueries:function(a){this.magnets=void 0;this.documents.forEach(function(d){d.matches=
[]});this.updateDocs();this.draw();if(this.documents){var b=this.getApiParams();b.query||(b.limit=10);var c=Ext.Array.from(this.getApiParam("query"));(!a||0<c.length)&&this.getCorpus().getCorpusTerms({parentPanel:this}).load({params:Ext.apply(b,{withDistributions:!0}),callback:function(d){var e=this.getTargetEl().dom.querySelector("canvas"),f=e.getContext("2d");diam=e.width;rad=diam/2;f.font=this.textFont;var g={};e=0;for(var h=d.length;e<h;e++){var k=d[e].getTerm();d[e].getDistributions().forEach(function(l,
m){0<l&&this.documents[m].matches.push(k)},this);g[k]={record:d[e],colour:this.getApplication().getColor(e),width:f.measureText(k).width,isHovering:!1}}this.magnets={};c.forEach(function(l){g[l]&&(this.magnets[l]=g[l],delete g[l])},this);for(k in g)this.magnets[k]=g[k];this.setApiParam("query",Object.keys(this.magnets));this.updateMagnets();this.updateDocs();this.draw()},scope:this})}},updateMagnets:function(a){a=this.getTargetEl().dom.querySelector("canvas");a=a.width/2;var b=Object.keys(this.magnets||
{}).length,c=0,d;for(d in this.magnets)Ext.apply(this.magnets[d],{x:a+(a-this.gutter-50)*Math.cos(2*Math.PI*c/b),y:a+(a-this.gutter-50)*Math.sin(2*Math.PI*c/b)}),c++},updateDocs:function(a){a=a||this.getTargetEl().dom.querySelector("canvas");diam=a.width;rad=diam/2;var b=[];if(this.documents){this.documents.forEach(function(d,e){if(0==Ext.Array.from(d.matches).length)b.push(e);else if(1==Ext.Array.from(d.matches).length){var f=15*Math.random()+15,g=15*Math.random()+15;d.targetX=this.magnets[d.matches[0]].x+
(0==Math.round(Math.random())?f:-f);d.targetY=this.magnets[d.matches[0]].y+(0==Math.round(Math.random())?g:-g)}else{g=f=0;var h=d.matches.map(function(n){return this.magnets[n].record.getDistributions()[e]},this),k=Ext.Array.min(h),l=Ext.Array.max(h),m=0;d.matches.forEach(function(n,r){weight=l==k?1:(h[r]-k+k)/(l-k+k);m+=weight;f+=this.magnets[n].x*weight;g+=this.magnets[n].y*weight},this);d.targetX=f/m;d.targetY=g/m}},this);a=0;for(var c=b.length;a<c;a++)Ext.apply(this.documents[a],{targetX:rad+
(rad-this.gutter)*Math.cos(2*Math.PI*a/c),targetY:rad+(rad-this.gutter)*Math.sin(2*Math.PI*a/c)})}},draw:function(a,b){a=a||this.getTargetEl().dom.querySelector("canvas");b=b||a.getContext("2d");b.font=this.textFont;var c=a.width/2;b.clearRect(0,0,a.width,a.height);var d=!0===this.getApiParam("labels")||"true"==this.getApiParam("labels");b.beginPath();b.strokeStyle="rgba(0,0,0,.1)";b.fillStyle="rgba(0,0,0,.02)";b.arc(c,c,c-this.gutter,0,2*Math.PI,!1);b.fill();b.lineWidth=2;b.stroke();var e=!1;if(this.documents&&
0<this.documents.length){var f=Ext.Array.each(this.documents,function(p){return!p.isHovering},this);!0===f&&(f=Ext.Array.each(Object.keys(this.magnets||{}),function(p){return!this.magnets[p].isHovering},this));var g={};hoveringDocs=[];this.documents.forEach(function(p,v){p.matches.forEach(function(q,u){b.beginPath();b.moveTo(p.x,p.y);b.lineTo(this.magnets[q].x,this.magnets[q].y);!0===f?b.strokeStyle="rgba("+this.magnets[q].colour.join(",")+",.1)":p.isHovering||this.magnets[q].isHovering?(hoveringDocs[v]=
!0,g[q]=!0,b.strokeStyle="rgba("+this.magnets[q].colour.join(",")+",.5)"):b.strokeStyle="rgba(0,0,0,.02)";b.stroke()},this)},this);var h=parseInt(this.textFont)/2,k=parseInt(this.textFont)+4;this.documents.forEach(function(p,v){if(d||p.isHovering||1==hoveringDocs[v]){var q=p.width+4;b.fillStyle=p.isHovering||1==hoveringDocs[v]||!0===f?"white":"rgba(255,255,255,.05)";b.fillRect(p.x-q/2,p.y-k/2,q,k);b.strokeStyle=p.isHovering||1==hoveringDocs[v]||!0===f?"rgba(0,0,0,.2)":"rgba(0,0,0,.05)";b.strokeRect(p.x-
q/2,p.y-k/2,q,k);b.textAlign="center";b.fillStyle=p.isHovering||1==hoveringDocs[v]||!0===f?"rgba(0,0,0,.8)":"rgba(0,0,0,.05)";b.fillText(p.label,p.x,p.y)}else b.beginPath(),b.fillStyle="rgba(0,0,0,.8)",b.arc(p.x,p.y,h,0,2*Math.PI),b.fill(),b.stroke();v=Math.abs(p.x-p.targetX);q=Math.abs(p.y-p.targetY);if(0!=v||0!=q)1>v?p.x=p.targetX:(v/=2,p.x=p.x>p.targetX?p.x-v:p.x+v),1>q?p.y=p.targetY:(q/=2,p.y=p.y>p.targetY?p.y-q:p.y+q),e=!0},this);a=0;k=parseInt(this.textFont)+4;b.textAlign="center";b.textBaseline=
"middle";for(var l in this.magnets)d||l in g||this.magnets[l].isHovering?(a=this.magnets[l].width+4,b.fillStyle=l in g||this.magnets[l].isHovering||!0===f?"white":"rgba(255,255,255,.05)",b.fillRect(this.magnets[l].x-a/2,this.magnets[l].y-k/2,a,k),b.strokeStyle=l in g||this.magnets[l].isHovering||!0===f?"rgb("+this.magnets[l].colour.join(",")+")":"rgba(0,0,0,.05)",b.strokeRect(this.magnets[l].x-a/2,this.magnets[l].y-k/2,a,k),b.textAlign="center",b.fillStyle=l in g||this.magnets[l].isHovering||!0===
f?"rgba(0,0,0,.8)":"rgba(0,0,0,.05)",b.fillText(l,this.magnets[l].x,this.magnets[l].y)):(b.beginPath(),b.fillStyle="rgb("+this.magnets[l].colour.join(",")+")",b.strokeStyle="rgb("+this.magnets[l].colour.join(",")+")",b.arc(this.magnets[l].x,this.magnets[l].y,12,0,2*Math.PI),b.fill(),b.stroke())}if(e){var m=this;setTimeout(function(){m.draw()},100)}else if(this.documents){c=Math.max(c/this.documents.length,50);a=0;for(l=this.documents.length;a<l;a++)for(var n=0;n<l;n++)if(a<n){var r=this.documents[a].x-
this.documents[n].x,w=this.documents[a].y-this.documents[n].y;Math.sqrt(r*r+w*w)<c&&(r*=.1,w*=.1,this.documents[a].targetX+=r,this.documents[n].targetX-=r,this.documents[a].targetY+=w,this.documents[n].targetY-=w,e=!0)}e&&(m=this,setTimeout(function(){m.draw()},100))}}});Ext.define("Voyant.panel.MicroOcp",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.microocp",statics:{i18n:{title:"MicroOCP"},api:{config:void 0,stopList:"auto",uri:void 0},glyph:"xf1ea@FontAwesome"},config:{editor:void 0},constructor:function(a){a=a||{};this.mixins["Voyant.util.Api"].constructor.apply(this,arguments);var b=Ext.create("Ext.data.Store",{fields:[{name:"cocoa",type:"string"}]});Ext.apply(this,{title:this.localize("title"),layout:"border",dockedItems:[{dock:"bottom",
...
e))},this);this.getCorpus()&&(void 0===this.getApiParam("skipToDocId")&&this.setApiParam("skipToDocId",this.getCorpus().getDocument(0).getId()),this.load(),(d=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(d)?[d]:d));this.on("loadedCorpus",function(){void 0===this.getApiParam("skipToDocId")&&this.setApiParam("skipToDocId",this.getCorpus().getDocument(0).getId());this.load(!0);var e=this.getApiParam("query");e&&this.loadQueryTerms(Ext.isString(e)?[e]:e)},this)},this);Ext.apply(this,{title:this.localize("title"),
cls:"voyant-reader",layout:"fit",items:{layout:"border",items:[{bodyPadding:10,region:"center",border:!1,autoScroll:!0,html:'\x3cdiv class\x3d"readerContainer"\x3e\x3c/div\x3e'},{xtype:"readergraph",region:"south",weight:0,height:30,split:{size:2},splitterResize:!0,border:!1,listeners:{documentRelativePositionSelected:function(d,e){d=this.getDocumentsStore().getAt(e.docIndex);var f=d.get("tokensCount-lexical");e=Math.floor(f*e.fraction)-this.getApiParam("limit")/2;this.setApiParams({skipToDocId:d.getId(),
start:0>e?0:e});this.load(!0)},scope:this}},{xtype:"entitieslist",region:"east",weight:10,width:"40%",split:{size:2},splitterResize:!0,border:!1,hidden:!0,collapsible:!0,animCollapse:!1}]},dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{glyph:"xf060@FontAwesome",handler:function(){this.fetchPrevious(!0)},scope:this},{glyph:"xf061@FontAwesome",handler:function(){this.fetchNext(!0)},scope:this},{xtype:"tbseparator"},{xtype:"querysearchfield"},"-\x3e",{glyph:"xf0eb@FontAwesome",
tooltip:this.localize("highlightEntities"),itemId:"nerServiceParent",menu:{items:[{xtype:"menucheckitem",group:"nerService",text:this.localize("nerSpacy"),itemId:"spacy",checked:!0,handler:this.nerServiceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:this.localize("nerNssi"),itemId:"nssi",checked:!1,handler:this.nerServiceHandler,scope:this},{xtype:"menucheckitem",group:"nerService",text:this.localize("nerVoyant"),itemId:"stanford",checked:!1,handler:this.nerServiceHandler,scope:this}],
listeners:{beforeshow:function(d,e){if(this.down("#nerServiceParent").hasCls("x-btn-disabled"))return!1},scope:this}}}]}],listeners:{loadedCorpus:function(d,e){this.getTokensStore().setCorpus(e);this.getDocumentTermsStore().getProxy().setExtraParam("corpus",e.getId());d=e.getDocuments();this.setDocumentsStore(d);this.rendered&&(this.load(),0==this.hasCorpusAccess(e)&&this.mask(this.localize("limitedAccess"),"mask-no-spinner"),(e=this.getApiParam("query"))&&this.loadQueryTerms(Ext.isString(e)?[e]:
e))},termsClicked:function(d,e){var f=[];e.forEach(function(g){Ext.isString(g)?f.push(g):g.term?f.push(g.term):g.getTerm&&f.push(g.getTerm())});0<f.length&&this.loadQueryTerms(f)},corpusTermsClicked:function(d,e){var f=[];e.forEach(function(g){g.getTerm()&&f.push(g.getTerm())});this.loadQueryTerms(f)},documentTermsClicked:function(d,e){var f=[];e.forEach(function(g){g.getTerm()&&f.push(g.getTerm())});this.loadQueryTerms(f)},documentSelected:function(d,e){d=this.getTokensStore().getCorpus().getDocument(e);
this.setApiParams({skipToDocId:d.getId(),start:0});this.load(!0)},documentsClicked:function(d,e,f){0<e.length&&(this.setApiParams({skipToDocId:e[0].getId(),start:0}),this.load(!0))},termLocationClicked:function(d,e){if(void 0!==e[0]){d=e[0];e=d.get("docIndex");var f=d.get("position");this.showTermLocation(e,f,d)}},documentIndexTermsClicked:function(d,e){void 0!==e[0]&&(d=Ext.create("Voyant.data.model.Token",e[0]),this.fireEvent("termLocationClicked",this,[d]))},entityResults:function(d,e){null!==
e&&(this.clearEntityHighlights(),this.setDocumentEntitiesStore(e),this.highlightEntities(),this.getEnableEntitiesList()&&this.down("entitieslist").expand().show())},entitiesClicked:function(d,e){if(void 0!==e[0]){d=e[0];e=d.get("docIndex");var f=d.get("positions")[0];Array.isArray(f)&&(f=f[0]);this.showTermLocation(e,f,d)}},entityLocationClicked:function(d,e,f){d=e.get("docIndex");f=e.get("positions")[f];Array.isArray(f)&&(f=f[0]);this.showTermLocation(d,f,e)},scope:this}});this.callParent(arguments)},
loadQueryTerms:function(a){if(a&&0<a.length){var b=this.getApiParam("skipToDocId");if(void 0===b){b=0;var c=this.getLocationInfo();c&&(b=c[0].docIndex);b=this.getCorpus().getDocument(b).getId()}this.getDocumentTermsStore().load({params:{query:a,docId:b,categories:this.getApiParam("categories"),limit:-1}});this.down("readergraph").loadQueryTerms(a)}},showTermLocation:function(a,b,c){var d=b-this.getApiParam("limit")/2,e=this.getCorpus().getDocument(a);this.setApiParams({skipToDocId:e.getId(),start:0>
d?0:d});this.load(!0,{callback:function(){var f=this.body.dom.querySelector("#_"+a+"_"+b);f&&(f.scrollIntoView({block:"center"}),Ext.fly(f).frame("#f80"));c.get("type")?this.highlightEntities():this.highlightKeywords(c,!1)},scope:this})},highlightKeywords:function(a,b){var c=this.getInnerContainer().first();c.select("span[class*\x3dkeyword]").removeCls("keyword").applyStyles({backgroundColor:"transparent",color:"black"});void 0===a&&0<this.getDocumentTermsStore().getCount()&&(a=this.getDocumentTermsStore().getData().items);
void 0!==a&&(Ext.isArray(a)||(a=[a]),a.forEach(function(d){var e=d.get("term"),f=this.getApplication().getColorForTerm(e),g=this.getApplication().getTextColorForBackground(f);f="rgb("+f.join(",")+") !important";g="rgb("+g.join(",")+") !important";var h="background-color:"+f+";color:"+g+";";if(d.get("positions")){e=d.get("positions");var k=d.get("docIndex");e.forEach(function(m){(m=c.dom.querySelector("#_"+k+"_"+m))&&Ext.fly(m).addCls("keyword").dom.setAttribute("style",h)})}else{var l=new RegExp("^"+
e+"$","i");c.select("span.word").each(function(m,n,r){m.dom.firstChild&&m.dom.firstChild.nodeValue.match(l)&&m.addCls("keyword").dom.setAttribute("style",h)})}},this))},nerServiceHandler:function(a){a=a.itemId;var b=[],c=this.getLocationInfo();if(c)for(var d=c[0].docIndex;d<=c[1].docIndex;d++)b.push(d);else b.push(0);this.clearEntityHighlights();c=this.down("entitieslist");c.clearEntities();c.getEntities(a,b)},clearEntityHighlights:function(){this.getInnerContainer().first().select(".entity").each(function(a){a.removeCls("entity start middle end location person organization misc money time percent date duration set unknown");
a.dom.setAttribute("data-qtip",a.dom.getAttribute("data-qtip").replace(/<div class="entity">.*?<\/div>/g,""))})},highlightEntities:function(){var a=this.getInnerContainer().first(),b=this.getDocumentEntitiesStore(),c=this.localize("entityType");b.forEach(function(d){var e=d.positions;e?e.forEach(function(f){var g=1<f.length;if(g&&2===f.length&&1<f[1]-f[0])for(var h=f[1],k=f[0]+1,l=1;k<h;)f.splice(l,0,k),k++,l++;h=0;for(k=f.length;h<k;h++)if(l=f[h],-1===l)console.warn("missing position for: "+d.term);
else if(l=a.selectNode("#_"+d.docIndex+"_"+l,!1)){var m="";g&&(m=0===h?"start ":h===k-1?"end ":"middle ");l.addCls("entity "+m+d.type);m=l.dom.getAttribute("data-qtip");-1===m.indexOf('class\x3d"entity"')&&l.dom.setAttribute("data-qtip",m+'\x3cdiv class\x3d"entity"\x3e'+c+": "+d.type+"\x3c/div\x3e")}}):console.warn("no positions for: "+d.term)})},fetchPrevious:function(a){var b=this.getInnerContainer().first(),c=b.first(".word");if(null!=c&&!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){b=
Voyant.data.model.Token.getInfoFromElement(c);var d=b.docIndex;b=b.position;var e=this.getDocumentsStore().getAt(d),f=this.getApiParam("limit"),g=!1;if(0===d&&0===b){a=this.down('panel[region\x3d"center"]').body;0!=c.getScrollIntoViewXY(a,a.dom.scrollTop,a.dom.scrollLeft).y&&c.dom.scrollIntoView();c.frame("red");break}0<d&&0===b?(g=!0,d--,e=this.getDocumentsStore().getAt(d),d=e.get("tokensCount-lexical"),b=d-f,0>b&&(b=0,this.setApiParam("limit",d))):(f--,b-=f);0>b&&(b=0);c.insertSibling("\x3cdiv class\x3d'loading'\x3e"+
this.localize("loading")+"\x3c/div\x3e","before",!1).mask();g||c.destroy();c=e.getId();this.setApiParams({skipToDocId:c,start:b});this.setInsertWhere("afterBegin");this.setScrollIntoView(a);this.load();this.setApiParam("limit",this.INITIAL_LIMIT);break}c.destroy();c=b.first()}},fetchNext:function(a){var b=this.getInnerContainer().first(),c=b.last();if(!1===c.hasCls("loading"))for(;c;){if(c.hasCls("word")){b=Voyant.data.model.Token.getInfoFromElement(c);var d=b.docIndex,e=b.position,f=this.getDocumentsStore().getAt(b.docIndex),
...
this.load();this.setApiParam("limit",this.INITIAL_LIMIT);break}c.destroy();c=b.last()}},load:function(a,b){a&&(this.getInnerContainer().first().destroy(),this.getInnerContainer().setHtml('\x3cdiv class\x3d"readerContainer"\x3e\x3cdiv class\x3d"loading"\x3e'+this.localize("loading")+"\x3c/div\x3e\x3c/div\x3e"),this.getInnerContainer().first().first().mask());a=this.getTokensStore();a.lastOptions&&a.lastOptions.params.skipToDocId&&a.lastOptions.params.skipToDocId!==this.getApiParam("skipToDocId")&&
(a=this.getDocumentTermsStore(),a.lastOptions&&this.loadQueryTerms(a.lastOptions.params.query));this.getTokensStore().load(Ext.apply(b||{},{params:Ext.apply(this.getApiParams(),{stripTags:"blocksOnly",stopList:""})}))},updateText:function(a){var b=this.getInnerContainer().down(".loading");b&&b.destroy();var c=this.getInnerContainer().first().insertHtml(this.getInsertWhere(),a,!0);c&&this.getScrollIntoView()&&(c.dom.scrollIntoView(),Ext.Function.defer(function(){var d=Ext.get(c.id);d&&d.frame("red")},
100));a=this.down('panel[region\x3d"center"]').body.dom;this.updateLocationMarker(0==a.scrollTop?0:a.scrollHeight-a.scrollTop==a.clientHeight?1:(a.scrollTop+.5*a.clientHeight)/a.scrollHeight)},updateLocationMarker:function(a,b){var c=this.getLocationInfo();if(c){var d=c[0],e=c[1];c=this.getCorpus();var f=!1;0!==d.position&&(f=!0);for(var g={},h=0,k=this.getEnableEntitiesList()&&this.getApplication().getEntitiesEnabled?this.getApplication().getEntitiesEnabled():!1,l=d.docIndex;l<=e.docIndex;){var m=
c.getDocument(l).get("tokensCount-lexical");m>this.MAX_TOKENS_FOR_NER&&(k=!1);l===e.docIndex&&(m=e.position);l===d.docIndex&&(m-=d.position);h+=m;g[l]=m;l++}l=this.down("#nerServiceParent");k?l.removeCls("x-btn-disabled").setTooltip(""):l.addCls("x-btn-disabled").setTooltip(this.localize("nerDisabled"));h=Math.round(h*a);k=a=0;for(l=d.docIndex;l<=e.docIndex&&!(a=l,k+=g[l],k>=h);l++);e=g[a]-(k-h);f&&a===d.docIndex&&(e+=d.position);d=e/c.getDocument(a).get("tokensCount-lexical");this.down("readergraph").moveLocationMarker(a,
...
arguments)},initComponent:function(){this.setCaStore(Ext.create("Voyant.data.store.CAAnalysis",{parentPanel:this,listeners:{load:this.maskAndBuildChart,scope:this}}));this.setPcaStore(Ext.create("Voyant.data.store.PCAAnalysis",{parentPanel:this,listeners:{load:this.maskAndBuildChart,scope:this}}));this.setTsneStore(Ext.create("Voyant.data.store.TSNEAnalysis",{parentPanel:this,listeners:{load:this.maskAndBuildChart,scope:this}}));this.setDocSimStore(Ext.create("Voyant.data.store.DocSimAnalysis",{parentPanel:this,
...
listeners:{hide:function(){var a=this.down("#chart").getSeries();a[0].enableToolTips();a[1].enableToolTips()},scope:this}}));this.tokenFreqTipTemplate=new Ext.Template(this.localize("tokenFreqTip"));this.docFreqTipTemplate=new Ext.Template(this.localize("docFreqTip"));Ext.apply(this,{title:this.localize("title"),layout:"border",autoDestroy:!0,items:[{itemId:"chartParent",region:"center",layout:"fit",tbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield",itemId:"filterTerms",width:150},
{text:this.localize("labels"),itemId:"labels",glyph:"xf02b@FontAwesome",menu:{items:[{text:this.localize("summaryLabel"),itemId:"summary",xtype:"menucheckitem"},{text:this.localize("docsLabel"),itemId:"docs",xtype:"menucheckitem"},{text:this.localize("termsLabel"),itemId:"terms",xtype:"menucheckitem"}],listeners:{afterrender:function(a){var b=this.getApiParam("label");a.items.each(function(c){c.setChecked(-1<b.indexOf(c.getItemId()))})},click:function(a,b){a=this.getApiParam("label");var c=b.getItemId();
Ext.isString(a)&&(a=[a]);b.checked&&-1==a.indexOf(c)?a.push(c):!b.checked&&-1<a.indexOf(c)&&(a=a.filter(function(d){return d!=c}));this.setApiParam("label",a);this.doLabels();this.queryById("chart").redraw()},scope:this}}}]},listeners:{query:function(a,b){this.getTermStore().filter([{property:"term",value:b,anyMatch:!0}]);this.filterChart(b)},scope:this}},{itemId:"optionsPanel",title:this.localize("options"),region:"west",split:!0,collapsible:!0,collapseMode:"header",width:135,scrollable:"y",layout:{type:"vbox",
align:"stretch"},defaults:{xtype:"button",margin:"5",labelAlign:"top"},items:[{xtype:"label",text:this.localize("input")},{xtype:"documentselectorbutton"},{text:this.localize("freqsMode"),itemId:"comparisonType",glyph:"xf201@FontAwesome",tooltip:this.localize("freqsModeTip"),menu:{items:[{text:this.localize("rawFrequencies"),itemId:"comparisonType_raw",group:"freqsMode",xtype:"menucheckitem"},{text:this.localize("relativeFrequencies"),itemId:"comparisonType_relative",group:"freqsMode",xtype:"menucheckitem"},
{text:this.localize("tfidf"),itemId:"comparisonType_tfidf",group:"freqsMode",xtype:"menucheckitem"}],listeners:{click:function(a,b){void 0!==b&&(a=b.getItemId().split("_")[1],a!==this.getApiParam("comparisonType")&&(this.setApiParam("comparisonType",a),this.loadFromApis(!0)))},scope:this}}},{fieldLabel:this.localize("numTerms"),itemId:"limit",xtype:"numberfield",minValue:5,listeners:{change:function(a,b,c){function d(){this.setApiParam("limit",b);this.loadFromApis()}!1===this.getIgnoreTermsLimitChange()&&
(null!==this.getTermsLimitTimeout()&&clearTimeout(this.getTermsLimitTimeout()),a.isValid()&&this.setTermsLimitTimeout(setTimeout(d.bind(this),500)))},scope:this}},{xtype:"container",html:'\x3chr style\x3d"border: none; border-top: 1px solid #cfcfcf;"/\x3e'},{xtype:"label",text:this.localize("output")},{text:this.localize("analysis"),itemId:"analysis",glyph:"xf1ec@FontAwesome",overflowHandler:"scroller",menu:{items:[{text:this.localize("pca"),itemId:"analysis_pca",group:"analysis",xtype:"menucheckitem"},
{text:this.localize("ca"),itemId:"analysis_ca",group:"analysis",xtype:"menucheckitem"},{text:this.localize("tsne"),itemId:"analysis_tsne",group:"analysis",xtype:"menucheckitem"},{text:this.localize("docSim"),itemId:"analysis_docSim",group:"analysis",xtype:"menucheckitem"}],listeners:{click:function(a,b){void 0!==b&&(a=b.getItemId().split("_")[1],a!==this.getApiParam("analysis")&&(this.doAnalysisChange(a),this.loadFromApis(!0)))},scope:this}}},{fieldLabel:this.localize("perplexity"),itemId:"perplexity",
xtype:"slider",minValue:5,maxValue:100,increment:1,listeners:{changecomplete:function(a,b){this.setApiParam("perplexity",b);this.loadFromApis(!0)},scope:this}},{fieldLabel:this.localize("iterations"),itemId:"iterations",xtype:"slider",minValue:100,maxValue:5E3,increment:100,listeners:{changecomplete:function(a,b){this.setApiParam("iterations",b);this.loadFromApis(!0)},scope:this}},{text:this.localize("clusters"),itemId:"clusters",glyph:"xf192@FontAwesome",menu:{items:[{text:"1",itemId:"clusters_1",
group:"clusters",xtype:"menucheckitem"},{text:"2",itemId:"clusters_2",group:"clusters",xtype:"menucheckitem"},{text:"3",itemId:"clusters_3",group:"clusters",xtype:"menucheckitem"},{text:"4",itemId:"clusters_4",group:"clusters",xtype:"menucheckitem"},{text:"5",itemId:"clusters_5",group:"clusters",xtype:"menucheckitem"}],listeners:{click:function(a,b){void 0!==b&&(a=parseInt(b.getItemId().split("_")[1]),a!==this.getApiParam("clusters")&&(this.setApiParam("clusters",a),this.loadFromApis(!0)))},scope:this}}},
{text:this.localize("dimensions"),itemId:"dimensions",glyph:"xf1b2@FontAwesome",menu:{items:[{text:"2",itemId:"dimensions_2",group:"dimensions",xtype:"menucheckitem"},{text:"3",itemId:"dimensions_3",group:"dimensions",xtype:"menucheckitem"}],listeners:{click:function(a,b){if(void 0!==b&&(a=parseInt(b.getItemId().split("_")[1]),a!==this.getApiParam("dimensions"))){if(3==a&&"ca"==this.getApiParam("analysis")&&3==this.getCorpus().getDocumentsCount())return!1;this.setApiParam("dimensions",a);this.loadFromApis(!0)}},
scope:this}}},{itemId:"reloadButton",text:this.localize("reload"),glyph:"xf021@FontAwesome",handler:function(){this.loadFromApis()},scope:this}]},{itemId:"termsGrid",xtype:"grid",title:this.localize("terms"),region:"east",width:250,split:!0,collapsible:!0,collapseMode:"header",forceFit:!0,features:[{ftype:"grouping",hideGroupedHeader:!0,enableGroupingMenu:!1}],bbar:{overflowHandler:"scroller",items:[{itemId:"nearbyButton",xtype:"button",text:this.localize("nearby"),glyph:"xf0b2@FontAwesome",flex:1,
handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):(a=b.get("term"),this.getNearbyForTerm(a))},scope:this},{itemId:"removeButton",xtype:"button",text:this.localize("remove"),glyph:"xf068@FontAwesome",flex:1,handler:function(a){var b=a.up("panel").getSelection()[0];void 0===b?this.toastError({html:this.localize("noTermSelected"),anchor:a.up("panel").getTargetEl()}):(a=b.get("term"),this.removeTerm(a))},
scope:this}]},tbar:{overflowHandler:"scroller",items:[{xtype:"querysearchfield",itemId:"addTerms",multiSelect:!1,flex:1},{xtype:"button",text:this.localize("addTerm"),handler:function(a){a=this.queryById("addTerms");var b=a.getValue();null!==b&&-1===this.getTermStore().findExact("term",b)?(this.setNewTerm(b),this.loadFromApis()):this.setNewTerm(null);a.setValue("")},scope:this}]},columns:[{text:this.localize("term"),dataIndex:"term",flex:1,sortable:!0},{text:this.localize("rawFreq"),dataIndex:"rawFreq",
...
this.selectTerm()},scope:this}}},store:this.getTermStore(),listeners:{expand:function(a){a.getView().refresh()},scope:this}}]});this.on("boxready",function(a,b,c){400>b&&(this.queryById("optionsPanel").collapse(),this.queryById("termsGrid").collapse());this.config.storeClass&&this.config.storeData&&this.loadStoreFromJson(this.config.storeClass,this.config.storeData)},this);this.on("beforedestroy",function(a){a=this.queryById("chart");null!==a&&this.queryById("chartParent").remove(a)},this);this.on("loadedCorpus",
function(a,b){a=function(c){var d=this.getApiParam(c);this.queryById(c).down("#"+c+"_"+d).setChecked(!0)}.bind(this);a("analysis");this.doAnalysisChange(this.getApiParam("analysis"));a("comparisonType");a("clusters");this.queryById("perplexity").setValue(this.getApiParam("perplexity"));this.queryById("iterations").setValue(this.getApiParam("iterations"));3==b.getDocumentsCount()&&this.setApiParam("dimensions",2);a("dimensions");this.getCaStore().setCorpus(b);this.getPcaStore().setCorpus(b);this.getDocSimStore().setCorpus(b);
this.loadFromApis()},this);this.on("documentsSelected",function(a,b){this.setApiParam("docId",b);this.loadFromApis()},this);this.callParent(arguments)},doAnalysisChange:function(a){this.setApiParam("analysis",a);this.queryById("nearbyButton").setDisabled("tsne"===a);this.queryById("reloadButton").setVisible("tsne"===a);this.queryById("perplexity").setVisible("tsne"===a);this.queryById("iterations").setVisible("tsne"===a);this.queryById("limit").setDisabled("docSim"===a);"ca"===a&&3==this.getCorpus().getDocumentsCount()&&
(this.setApiParam("dimensions",2),this.queryById("dimensions").menu.items.get(0).setChecked(!0))},loadStoreFromJson:function(a,b){"Voyant.data.store.CAAnalysis"==a?(this.getCaStore().loadRawData(b),this.doAnalysisChange("ca"),this.maskAndBuildChart.call(this,this.getCaStore())):"Voyant.data.store.PCAAnalysis"==a?(this.getPcaStore().loadRawData(b),this.doAnalysisChange("pca"),this.maskAndBuildChart.call(this,this.getPcaStore())):"Voyant.data.store.TSNEAnalysis"==a?(this.getTsneStore().loadRawData(b),
this.doAnalysisChange("tsne"),this.maskAndBuildChart.call(this,this.getTsneStore())):"Voyant.data.store.DocSimAnalysis"==a&&(this.getDocSimStore().loadRawData(b),this.doAnalysisChange("docSim"),this.maskAndBuildChart.call(this,this.getDocSimStore()))},maskAndBuildChart:function(a){this.queryById("chartParent").mask(this.localize("plotting"));Ext.defer(this.buildChart,50,this,[a])},buildChart:function(a){var b=this,c=this.queryById("chart");null!==c&&this.queryById("chartParent").remove(c);this.queryById("termsGrid").getSelectionModel().deselectAll();
c=a.getAt(0);var d=this.getApiParam("dimensions");a="";if("pca"===this.getApiParam("analysis")){for(var e=c.getPrincipalComponents(),f=0,g=0;g<e.length;g++)f+=parseFloat(e[g].get("eigenValue"));if(0!=f){a=this.localize("pcTitle")+"\n";var h=["xAxis","yAxis","fill"];for(g=0;g<e.length&&!(g>=d);g++){var k=e[g].get("eigenValue")/f*100;a+=this.localize("pc")+" "+(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n"}}}else if("tsne"!==this.getApiParam("analysis"))for(a=this.localize("caTitle")+
"\n",h=["xAxis","yAxis","fill"],e=c.getDimensions(),g=0;g<e.length&&!(g>=d);g++)k=e[g].get("percentage"),a+=this.localize("dimension")+" "+(g+1)+" ("+this.localize(h[g])+"): "+Math.round(100*k)/100+"%\n";var l=0,m=Number.MAX_VALUE,n=0,r=Number.MAX_VALUE;this.getTermStore().removeAll();var w=[],p=[];c.getTokens().forEach(function(q){var u=q.get("rawFreq"),x=q.get("category");void 0===x&&(x="term",q.set("category","term"));var z="term"===x;z&&(u>l&&(l=u),u<m&&(m=u));this.getTermStore().findExact("term",
-1===q.get("term"))&&this.getTermStore().addSorted(q);if(3===d){var H=q.get("vector")[2];void 0!==H&&(H<r&&(r=H),H>n&&(n=H))}u={x:q.get("vector")[0],y:q.get("vector")[1]||0,z:q.get("vector")[2]||0,term:q.get("term"),rawFreq:u,relativeFreq:q.get("relativeFreq"),cluster:q.get("cluster"),category:x,disabled:!1};z?w.push(u):("bin"===q.get("category")?u.term=u.title="Bin "+q.get("docIndex"):(u.docIndex=q.get("docIndex"),q=this.getCorpus().getDocument(u.docIndex),null!==q&&(u.term=q.getShortTitle(),u.title=
q.getTitle())),p.push(u))},this);this.updateLimit();c=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex disabled".split(" "),data:w});g=Ext.create("Ext.data.JsonStore",{fields:"term x y z rawFreq relativeFreq cluster category docIndex disabled".split(" "),data:p});a={itemId:"chart",xtype:"cartesian",interactions:["crosszoom","panzoom","itemhighlight"],plugins:{ptype:"chartitemevents"},axes:[{type:"numeric",position:"bottom",fields:["x"],label:{rotate:{degrees:-30}}},
{type:"numeric",position:"left",fields:["y"]}],sprites:[{type:"text",text:a,x:70,y:70}],innerPadding:{top:25,right:25,bottom:25,left:25},series:[{type:"customScatter",xField:"x",yField:"y",store:c,label:{font:"14px Helvetica",field:"term",display:"over"},tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(q,u,x){q.setHtml(b.tokenFreqTipTemplate.apply([u.get("term"),u.get("rawFreq"),u.get("relativeFreq")]))}},marker:{type:"circle"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(q,
u,x,z){q=x.store.getAt(z);if(null!==q){var H=q.get("cluster");-1===H&&(H=0);x=.65;z=1;!0===q.get("disabled")?z=x=.1:3===d&&q.get("z")&&(x=b.interpolate(q.get("z"),r,n,0,1));H=b.getApplication().getColor(H);u.fillStyle="rgba("+H.join(",")+","+x+")";u.strokeStyle="rgba("+H.join(",")+","+z+")";q=q.get("rawFreq");q=b.interpolate(q,m,l,2,20);u.radius=q}},scope:this},{type:"customScatter",xField:"x",yField:"y",store:g,label:{font:"14px Helvetica",field:"term",display:"over",color:this.getDefaultDocColor(!0)},
tooltip:{trackMouse:!0,style:"background: #fff",renderer:function(q,u,x){q.setHtml(b.docFreqTipTemplate.apply([u.get("title"),u.get("rawFreq")]))}},marker:{type:"diamond"},highlight:{fillStyle:"yellow",strokeStyle:"black"},renderer:function(q,u,x,z){q=x.store.getAt(z);null!==q&&(x=q.get("cluster"),x=-1===x||"docSim"!==b.getApiParam("analysis")?b.getDefaultDocColor():b.getApplication().getColor(x),z=.65,3===d&&q.get("z")&&(z=b.interpolate(q.get("z"),r,n,0,1)),u.fillStyle="rgba("+x.join(",")+","+z+
")",u.strokeStyle="rgba("+x.join(",")+",1)",u.radius=5)},scope:this}],listeners:{itemclick:function(q,u,x){q=u.record.data;"doc"===q.category?(q=this.getCorpus().getDocument(q.docIndex),this.getApplication().dispatchEvent("documentsClicked",this,[q])):"term"===q.category&&(q=Ext.create("Voyant.data.model.CorpusTerm",q),this.getApplication().dispatchEvent("corpusTermsClicked",this,[q]))},render:function(q){q.body.on("contextmenu",function(u,x){u.preventDefault();u=u.getXY();var z=Ext.fly(x).getXY();
x=u[0]-z[0];z=u[1]-z[1];var H=this.down("#chart").getItemForPoint(x,z);null!=H&&"term"===H.record.get("category")&&(x=this.down("#chart").getSeries(),x[0].disableToolTips(),x[1].disableToolTips(),z=H.record.get("term"),x=(new Ext.Template(this.localize("removeTerm"))).apply([z]),this.getChartMenu().queryById("remove").setText(x),x=(new Ext.Template(this.localize("nearbyTerm"))).apply([z]),z=this.getChartMenu().queryById("nearby"),z.setText(x),z.setDisabled("tsne"===this.getApiParam("analysis")),this.getChartMenu().on("click",
function(I,F){void 0!==F&&(I=H.record.get("term"),"nearby"===F.getItemId()?this.getNearbyForTerm(I):this.removeTerm(I))},this,{single:!0}),this.getChartMenu().showAt(u))},this)},scope:this}};a=Ext.create("Ext.chart.CartesianChart",a);this.queryById("chartParent").insert(0,a);this.queryById("chartParent").unmask();this.doLabels();var v=this.getNewTerm();null!==v&&setTimeout(function(){this.selectTerm(v);this.setNewTerm(null)}.bind(this),0)},updateLimit:function(){var a=this.getCurrentTerms().length;
this.setIgnoreTermsLimitChange(!0);this.queryById("limit").setValue(a);this.setIgnoreTermsLimitChange(!1);this.setApiParam("limit",a)},getDefaultDocColor:function(a){return this.getApplication().getColor(6,a)},doLabels:function(){var a=this.queryById("chart"),b=a.getSeries();a=a.getSurface("chart").getItems()[0];var c=this.getApiParam("label");-1<c.indexOf("summary")?a.show():a.hide();-1<c.indexOf("terms")?b[0].getLabel().show():b[0].getLabel().hide();-1<c.indexOf("docs")?b[1].getLabel().show():b[1].getLabel().hide()},
selectTerm:function(a,b){var c=this.down("#chart");if(null!==c)if(void 0===a)c.getSeries()[0].setHighlightItem(null),c.getSeries()[1].setHighlightItem(null);else{if(!0===b){var d=c.getSeries()[1];a=d.getStore().findExact("title",a)}else d=c.getSeries()[0],a=d.getStore().findExact("term",a);if(-1!==a){var e=d.getStore().getAt(a),f=d.getSprites()[0];e={series:d,category:d.getItemInstancing()?"items":"markers",index:a,record:e,field:d.getYField(),sprite:f};d.setHighlightItem(e);b?c.getSeries()[0].setHighlightItem(null):
c.getSeries()[1].setHighlightItem(null);b=this.getPointFromIndex(d,a);this.setHighlightData({x:b[0],y:b[1],r:50});null==this.getHighlightTask()&&this.setHighlightTask(Ext.TaskManager.newTask({run:this.doHighlight,scope:this,interval:25,repeat:this.getHighlightData().r}));this.getHighlightTask().restart()}}},getPointFromIndex:function(a,b){a=a.getSprites()[0];return null!==a.surfaceMatrix?a.attr.matrix.clone().prependMatrix(a.surfaceMatrix).transformPoint([a.attr.dataX[b],a.attr.dataY[b]]):[0,0]},
doHighlight:function(){var a=this.down("#chart");if(0<this.getHighlightData().r){for(var b=a.getSurface(),c=null,d=b.getItems(),e=0;e<d.length;e++){var f=d[e];if("customHighlight"==f.id){c=f;break}}null==c?b.add({id:"customHighlight",type:"circle",strokeStyle:"red",fillStyle:"none",radius:this.getHighlightData().r,x:this.getHighlightData().x,y:this.getHighlightData().y}):(c.setAttributes({x:this.getHighlightData().x,y:this.getHighlightData().y,radius:this.getHighlightData().r}),this.getHighlightData().r-=
1.5,0>=this.getHighlightData().r&&(this.getHighlightData().r=0,b.remove(c,!0)));a.redraw()}},filterChart:function(a){Ext.isString(a)&&(a=[a]);for(var b=[],c=0;c<a.length;c++)b.push(new RegExp(a[c]));a=this.queryById("chart");c=a.getSeries()[0];var d=c.getLabel();c.getStore().each(function(e){var f=!1;if(0==b.length)f=!0;else for(var g=0;g<b.length&&!(f=f||b[g].test(e.get("term")));g++);e.set("disabled",!f);e=e.store.indexOf(e);d.setAttributesFor(e,{hidden:!f})},this);a.redraw()},getCurrentTerms:function(){var a=
[];this.getTermStore().each(function(b){"term"===b.get("category")&&a.push(b.get("term"))});return a},getNearbyForTerm:function(a){var b=Math.max(2E3,Math.round(this.getCorpus().getWordTokensCount()/100));this.setApiParams({limit:b,target:a});this.loadFromApis();this.setApiParam("target",void 0)},removeTerm:function(a){var b=this.down("#chart").getSeries()[0],c=b.getStore().findExact("term",a);b.getStore().removeAt(c);c=this.getTermStore().findExact("term",a);this.getTermStore().removeAt(c);this.updateLimit()},
...
(b>a?1:e)*Math.sin(2*Math.PI*f/c)}),f++==c&&(f=0)})},draw:function(a,b){if(!1!==this.rendered&&(a=a||this.getTargetEl().dom.querySelector("canvas"),b=b||a.getContext("2d"),b.clearRect(0,0,a.width,a.height),b.fillStyle="rgba(0,0,0,.1)",this.getPerim().forEach(function(d,e){0==e%3&&b.fillRect(d.x-5,d.y,10,1)}),this.documentTerms&&(this.drawTerms(a,b),this.drawReading(a,b),this.isReading))){var c=this;setTimeout(function(){c.draw()},10)}},drawReading:function(a,b){b=b||this.getTargetEl().dom.querySelector("canvas").getContext("2d");
...
function(a,b){0<b.length&&this.doLoad(b)},this);this.callParent(arguments)},listeners:{boxready:function(){this.initVisLayout()},resize:function(a,b,c){this.getVisLayout()&&this.getCorpus()&&(a=this.getLayout().getRenderTarget(),b=a.getWidth(),c=a.getHeight(),a.down("svg").set({width:b,height:c}),this.getVisLayout().size([b,c]),this.reload())},loadedCorpus:function(a,b){this.isVisible()&&this.doLoad(this.getApiParam("query"))},activate:function(){this.getCorpus()&&this.doLoad(this.getApiParam("query"))}},
doLoad:function(a){this.resetVis();void 0===a&&(this.resetMinMax(),this.setCurrentData({}));this.getMode()===this.MODE_DISTINCT?this.getDistinctTerms(a):this.getTopTerms(a)},reload:function(){var a=this.processCollocates([]);0<a.length&&(this.resetVis(),this.buildVisFromData(a))},resetMinMax:function(){this.setMinRawFreq(void 0);this.setMaxRawFreq(void 0);this.setMaxCollocateValue(void 0);this.setMinFillValue(void 0);this.setMaxFillValue(void 0)},resetVis:function(){var a=this.getVis();a&&a.selectAll(".node").remove()},
getTopTerms:function(a){var b=parseInt(this.getApiParam("numInitialTerms")),c=this.getApiParam("stopList"),d=this.getApiParam("categories");void 0!==a&&(c=b=void 0);this.getCorpus().getCorpusTerms({parentPanel:this}).load({params:{query:a,categories:d,limit:b,stopList:c},callback:function(e,f,g){g&&this.loadFromRecords(e)},scope:this})},getDistinctTerms:function(a){var b=parseInt(this.getApiParam("numInitialTerms")),c=this.getApiParam("stopList"),d=this.getApiParam("categories");void 0!==a&&(c=b=
void 0);var e=Math.ceil(parseInt(this.getApiParam("numInitialTerms"))/this.getCorpus().getDocumentsCount());this.getCorpus().getDocumentTerms({parentPanel:this}).load({params:{query:a,categories:d,limit:b,perDocLimit:e,stopList:c,sort:"TFIDF",dir:"DESC"},callback:function(f,g,h){h&&this.loadFromRecords(f)},scope:this})},loadFromQuery:function(a){this.getCorpus().getCorpusTerms({parentPanel:this}).load({params:{query:a},callback:function(b,c,d){d&&this.loadFromRecords(b)},scope:this})},loadFromRecords:function(a){if(Ext.isArray(a)&&
0<a.length){var b=this.getMaxRawFreq(),c=this.getMinRawFreq(),d=this.getMinFillValue(),e=this.getMaxFillValue(),f=[];a.forEach(function(g){var h=g.getTerm();if(!this.getBlacklist()[h]){var k=g.getRawFreq(),l=this.getMode()===this.MODE_DISTINCT?g.get("tfidf"):g.getInDocumentsCount();if(void 0===b||k>b)b=k;if(void 0===c||k<c)c=k;if(void 0===e||l>e)e=l;if(void 0===d||l<d)d=l;this.getCurrentData()[h]={term:h,rawFreq:k,relativeFreq:g.get("relativeFreq"),fillValue:l,collocates:[]};f.push(h)}},this);this.setMaxRawFreq(b);
this.setMinRawFreq(c);this.setMinFillValue(d);this.setMaxFillValue(e);this.getCollocatesForQuery(f)}},getCollocatesForQuery:function(a){var b=[];for(c in this.getCurrentData())b.push(c);this.setApiParams({mode:"corpus"});var c=this.getApiParams();this.getCorpus().getCorpusCollocates({parentPanel:this}).load({params:Ext.apply(Ext.clone(c),{query:a,collocatesWhitelist:b,limit:this.COLLOCATES_LIMIT}),callback:function(d,e,f){f&&this.buildVisFromData(this.processCollocates(d))},scope:this})},processCollocates:function(a){for(var b=
this.getCurrentData(),c=this.getMaxCollocateValue(),d=0;d<a.length;d++){var e=a[d],f=e.getTerm(),g=e.getContextTerm();e=e.getContextTermRawFreq();if(void 0===c||e>c)c=e;void 0!==b[f]&&f!=g&&b[f].collocates.push({term:g,value:e})}this.setMaxCollocateValue(c);a=[];for(f in b)a.push(b[f]);return a},buildVisFromData:function(a){var b=this;if(this.getVis()){a.push({term:"$$$root$$$",collocates:[],rawFreq:1});var c=d3.stratify().id(function(h){return h.term}).parentId(function(h){return"$$$root$$$"!==h.term?
"$$$root$$$":""})(a).sort(function(h,k){return h.rawFreq<k.rawFreq?1:h.rawFreq>k.rawFreq?-1:0}).sum(function(h){return Math.pow(h.rawFreq,1/b.getScalingFactor())});this.getVisLayout()(c);c=this.getVis().selectAll(".node").data(c.descendants());c.attr("transform",function(h){return"translate("+h.x+","+h.y+")"});c.selectAll("circle").attr("r",function(h){return h.r});var d=d3.scalePow().exponent(1/3).domain([0,this.getMaxCollocateValue()]).range(["#fff","#bd3163"]);var e=this.getMode()===this.MODE_DISTINCT?
d3.scalePow().exponent(.2).domain([this.getMinFillValue(),this.getMaxFillValue()]).range(["#dedede","#fff"]):d3.scaleLinear().domain([this.getMaxFillValue(),this.getMinFillValue()]).range(["#dedede","#fff"]);var f=this.getVisLayout().size();f=Math.min(f[0],f[1])/2;a=Math.sqrt(Math.PI*f*f/a.length/Math.PI)/3;f=Math.abs(this.getScalingFactor()-(this.MAX_SCALING+1));f=Math.max(1,f-1);f*=a;var g=d3.scaleLinear().domain([this.getMinRawFreq(),this.getMaxRawFreq()]).range([a,f]);a=c.enter().append("g").attr("class",
"node").style("visibility",function(h){return 0<h.depth?"visible":"hidden"}).attr("transform",function(h){return"translate("+h.x+","+h.y+")"}).on("click",function(h,k){b.dispatchEvent("termsClicked",b,[k.data.term])}).on("mouseover",function(h,k){b.setCurrentNode(k);b.getVis().selectAll("circle").style("stroke-width",1).style("stroke","#111").style("fill",function(n){return e(n.data.fillValue)});d3.select(this).select("circle").style("fill","#89e1c2").style("stroke","#26926c").style("stroke-opacity",
b.MAX_STROKE_OPACITY);h=b.getMode()===b.MODE_DISTINCT?b.localize("tfidf"):b.localize("inDocs");if(!b.getContextMenu().isVisible()){h="\x3cb\x3e"+k.data.term+"\x3c/b\x3e ("+k.data.rawFreq+")\x3cbr/\x3e"+h+": "+k.data.fillValue;var l=b.getTip();l.update(h);l.show()}for(h=0;h<k.data.collocates.length;h++){var m=k.data.collocates[h];l=b.getVis().selectAll(".node").filter(function(n){return n.data.term===m.term});l.select("circle").style("fill",function(n){return d(m.value)}).style("stroke","#bd3163").style("stroke-opacity",
b.MAX_STROKE_OPACITY);l.select("tspan.value").text(function(n){return m.value})}}).on("mousemove",function(h){b.getTip().setPosition(h.pageX+5,h.pageY-50)}).on("mouseout",function(h){b.getContextMenu().isVisible()||b.setCurrentNode(void 0);b.getVis().selectAll("circle").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke","#111").style("fill",function(k){return e(k.data.fillValue)});b.getVis().selectAll("tspan.value").text("");b.getTip().hide()}).on("contextmenu",function(h,k){h.preventDefault();
b.getTip().hide();var l=b.getContextMenu();l.queryById("label").setHtml(k.data.term);l.showAt(h.pageX+5,h.pageY-50)});a.append("circle").attr("id",function(h){return h.data.term.replace(/\W/g,"_")}).attr("r",function(h){return h.r}).style("fill",function(h){return e(h.data.fillValue)}).style("stroke","#111").style("stroke-opacity",b.MIN_STROKE_OPACITY).style("stroke-width",1);a.append("clipPath").attr("id",function(h){return"clip-"+h.data.term.replace(/\W/g,"_")}).append("use").attr("xlink:href",
function(h){return"#"+h.data.term.replace(/\W/g,"_")});a=a.append("text").attr("clip-path",function(h){return"url(#clip-"+h.data.term.replace(/\W/g,"_")+")"}).style("font-family",function(h){return b.getApplication().getCategoriesManager().getFeatureForTerm("font",h.data.term)}).style("text-anchor","middle").style("cursor","default");a.append("tspan").attr("class","term").attr("font-size",function(h){return g(h.data.rawFreq)}).attr("x",0).attr("y",function(h){return g(h.data.rawFreq)/4}).text(function(h){return h.data.term});
a.append("tspan").attr("class","value").attr("font-size",function(h){return.75*g(h.data.rawFreq)}).attr("x",0).attr("y",function(h){return g(h.data.rawFreq)+1});c.exit().remove()}},initVisLayout:function(){var a=this.getLayout().getRenderTarget();a.update("");var b=a.getWidth(),c=a.getHeight();this.setVisLayout(d3.pack().size([b,c]).padding(1.5));a=d3.select(a.dom).append("svg").attr("id",this.getVisId()).attr("width",b).attr("height",c);this.setVis(a.append("g"));this.setVisInfo(a.append("text").attr("x",
10).attr("y",10));void 0===this.getTip()&&this.setTip(Ext.create("Ext.tip.Tip",{}))}});Ext.define("Voyant.panel.TermsRadio",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.termsradio",config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"}],speed:50,termsRadio:void 0},statics:{i18n:{},api:{bins:5,visibleBins:5,docIdType:null,limit:50,mode:null,position:0,selectedWords:[],stopList:"auto",query:null,yAxisScale:"log",speed:50,slider:void 0},glyph:"xf201@FontAwesome"},constructor:function(a){var b=function(c,d,e,f,g){this.setApiParams({mode:c});this.getTermsRadio().loadRecords(e);
(c=this.getApiParam("query"))&&-1===c.indexOf(",")&&(0==e.length||1==e.length&&0==e[0].getRawFreq()?this.toastInfo({html:this.localize("termNotFound"),align:"bl"}):this.getTermsRadio().highlightQuery(c,!0))};Ext.apply(a,{title:this.localize("title"),legendMenu:Ext.create("Ext.menu.Menu",{items:[{text:"",itemId:"remove",glyph:"xf068@FontAwesome"}]}),tbar:new Ext.Toolbar({overflowHandler:"scroller",items:{xtype:"legend",store:new Ext.data.JsonStore({fields:["name","mark","selector"]}),listeners:{itemclick:function(c,
d,e,f){c=d.get("name");this.getTermsRadio().isTermSelected(c)?this.getTermsRadio().doTermDeselect(c):this.getTermsRadio().doTermSelect(c)},itemcontextmenu:function(c,d,e,f,g){g.preventDefault();c=g.getXY();var h=d.get("name");d=(new Ext.Template(this.localize("removeTerm"))).apply([h]);this.legendMenu.queryById("remove").setText(d);this.legendMenu.on("click",function(k,l){void 0!==l&&this.getTermsRadio().doTermDeselect(h,!0)},this,{single:!0});this.legendMenu.showAt(c)},scope:this}}}),bbar:{overflowHandler:"scroller",
items:[{xtype:"querysearchfield"},{glyph:"xf04b@FontAwesome",itemId:"play",handler:function(c){"xf04c@FontAwesome"==c.glyph?(this.getTermsRadio().continueTransition=!1,this.mask(this.localize("completingTransition")),c.setPlaying(!1)):(this.getTermsRadio().toggleRightCheck(),c.setPlaying(!0))},scope:this,setPlaying:function(c){this.setGlyph(c?"xf04c@FontAwesome":"xf04b@FontAwesome")}},{glyph:"xf0e2@FontAwesome",tooltip:this.localize("resetTip"),listeners:{click:{fn:function(){this.queryById("play").setPlaying(!1);
this.getTermsRadio().shiftCount=0;this.getTermsRadio().prepareData();this.getTermsRadio().redraw()},scope:this}}},{xtype:"label",forId:"terms",text:this.localize("terms")},{xtype:"slider",itemId:"terms",hideLabel:!0,width:60,increment:5,minValue:5,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("limit")))},changecomplete:function(c,d){this.setApiParams({limit:d});this.loadStore()},scope:this}},{xtype:"label",forId:"speed",text:this.localize("speed")},{xtype:"slider",
itemId:"speed",hideLabel:!0,width:60,increment:5,minValue:5,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("speed")));this.setSpeed(c.getValue())},changecomplete:function(c,d){this.setApiParams({speed:d});this.setSpeed(d)},scope:this}},{xtype:"label",itemId:"visibleSegmentsLabel",forId:"visibleBins",text:this.localize("visibleSegments")},{xtype:"slider",itemId:"visibleBins",hideLabel:!0,width:60,increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("visibleBins")))},
changecomplete:function(c,d){this.setApiParams({visibleBins:d});this.numVisPoints=d;this.loadStore();this.numVisPoints==this.getCorpus().getDocumentsCount()?this.getTermsRadio().hideSlider():"false"!=this.getApiParam("slider")&&this.getTermsRadio().showSlider()},scope:this}},{xtype:"label",itemId:"segmentsLabel",forId:"segments",text:this.localize("segments")},{xtype:"slider",itemId:"segments",hideLabel:!0,width:60,increment:1,minValue:1,maxValue:100,listeners:{afterrender:function(c){c.setValue(parseInt(this.getApiParam("bins")))},
changecomplete:function(c,d){this.setApiParams({bins:d});this.numDataPoints=d;this.loadStore();this.queryById("visibleBins").setMaxValue(d)},scope:this}}]}});this.config.options.push({xtype:"combo",queryMode:"local",triggerAction:"all",forceSelection:!0,editable:!1,fieldLabel:this.localize("yScale"),labelAlign:"right",name:"yAxisScale",valueField:"value",displayField:"name",store:new Ext.data.JsonStore({fields:["name","value"],data:[{name:this.localize("linear"),value:"linear"},{name:this.localize("log"),
value:"log"}]}),listeners:{afterrender:function(c){c.setValue(this.getApiParam("yAxisScale"))},scope:this}});this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments);this.corpusStore=Ext.create("Voyant.data.store.CorpusTerms",{parentPanel:this,listeners:{load:{fn:b.bind(this,"corpus"),scope:this}}});this.documentStore=Ext.create("Voyant.data.store.DocumentTerms",{parentPanel:this,listeners:{load:{fn:b.bind(this,"document"),scope:this}}});this.on("boxready",function(c){c=
this.getApiParam("slider");this.setTermsRadio(new TermsRadio({parent:this,container:this.body,showSlider:void 0===c?!0:"true"===c}))},this);this.addListener("corpusTermsClicked",function(c,d){1<this.getCorpus().getDocumentsCount()&&d.forEach(function(e){e=e.getTerm();this.setApiParams({query:e});this.loadStore()},this)});this.addListener("documentTermsClicked",function(c,d){if(c&&c.xtype==this.xtype)return!1;d.forEach(function(e){e=e.getTerm();this.setApiParams({query:e});this.loadStore()},this)});
this.on("query",function(c,d){this.fireEvent("termsClicked",c,d)});this.on("termsClicked",function(c,d){d.forEach(function(e){var f;Ext.isString(e)?f=e:e.term?f=e.term:e.getTerm&&(f=e.getTerm());this.setApiParams({query:f});this.loadStore()},this)});this.on("loadedCorpus",function(c,d){this.documentStore.setCorpus(d);this.corpusStore.setCorpus(d);c=this.getApiParams();c.withDistributions=!0;c.type&&delete c.limit;var e=this.getCorpus().getDocumentsCount(),f=this.queryById("segments"),g=this.queryById("visibleBins");
"document"==c.mode||1==e?(this.setApiParam("mode","document"),d=this.documentStore,g.setMaxValue(f.getValue())):(this.setApiParam("mode","corpus"),delete c.bins,d=this.corpusStore,f.hide(),this.queryById("segmentsLabel").hide(),g=this.queryById("visibleBins"),g.setMaxValue(e),parseInt(this.getApiParam("visibleBins")>e)&&g.setValue(e));d.on("load",function(h,k){for(h=0;3>h;h++){var l=k[h];l&&this.getTermsRadio().highlightRecord(l,!0)}},this,{single:!0});d.load({params:c})},this)},loadStore:function(){this.queryById("play").setPlaying(!1);
var a=this.getApiParams();a.withDistributions=!0;"document"===this.getApiParam("mode")&&this.documentStore.load({params:a});"corpus"===this.getApiParam("mode")&&(delete a.bins,this.corpusStore.load({params:a}))}});Ext.define("Voyant.panel.Trends",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],requires:["Voyant.data.store.Documents"],alias:"widget.trends",config:{options:[{xtype:"stoplistoption"},{xtype:"categoriesoption"},{name:"bins",xtype:"slider",labelAlign:"right",width:200,minValue:2,maxValue:100,listeners:{afterrender:function(a){var b=a.up("window").panel;a.setFieldLabel(b.localize("segmentsSlider"))}}},{xtype:"radiogroup",labelAlign:"right",columns:3,vertical:!0,name:"withDistributions",items:[{boxLabel:"raw",
...
[],d=[];this.getCorpus().each(function(e){c.push(e.getTinyTitle());d.push(e.getTitle())});Ext.Array.unique(c).length<c.length&&(c=c.map(function(e,f){return f+1+")"+e}));Ext.applyIf(a,this.getApiParams());this.getCorpus().getCorpusTerms({parentPanel:this}).load({params:a,callback:function(e,f,g){var h=[],k=[],l=this.getApiParam("chartType");e.forEach(function(m,n){var r=m.get("term"),w=this.getApplication().getColorForTerm(r,!0);m.get("distributions").forEach(function(p,v){h[v]||(h[v]={index:c[v],
docTitle:d[v]});h[v]["_"+n]="relative"==b?p.toFixed(7):p;h[v]["term"+n]=r},this);"bar"!=l&&("barline"==l?["bar","line"]:[l]).forEach(function(p){k.push({type:"stacked"==p?"bar":p,title:r,xField:"index",yField:"_"+n,term:r,colors:[w],label:"barline"==l&&"bar"==p?{display:"none"}:{field:"term"+n}})},this)},this);f=e.map(function(m){return m.getTerm()});g=f.map(function(m){return this.getApplication().getColorForTerm(m,!0)},this);"bar"==l&&k.push({type:"bar",title:f,colors:g,xField:"index",yField:0<
h.length?Object.keys(h[0]).filter(function(m){return"_"==m.charAt(0)}):void 0,label:{field:e.map(function(m,n){return"term"+n})}});e=Ext.create("Ext.data.JsonStore",{fields:0<h.length?Object.keys(h[0]):void 0,data:h});this.buildChart({store:e,series:k,axes:[{type:"numeric",position:"left",increment:1,title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("corpusTitle")}}]})},scope:this})}else this.getCorpus().getCorpusTerms({parentPanel:this}).load({params:{limit:this.getApiParam("limit"),
stopList:this.getApiParam("stopList")},callback:function(e,f,g){0==e.length?f&&f.error?this.showError(this.localize("noResults")+"\x3cp style\x3d'color: red'\x3e"+f.error+"\x3c/p\x3e"):this.showError(this.localize("noResults")):(this.setApiParam("query",e.map(function(h){return h.getTerm()})),this.loadCorpusTerms())},scope:this})},loadDocumentTerms:function(a){if(this.getApiParam("query")){this.setApiParam("mode","document");a=a||{};var b=this.getApiParam("withDistributions");Ext.applyIf(a,{limit:0,
sort:"termasc",stopList:void 0});var c=1==this.getCorpus().getDocumentsCount()?this.getCorpus().getDocument(0):this.getCorpus().getDocument(this.getApiParam("docIndex"));Ext.applyIf(a,this.getApiParams());this.getCorpus().getDocumentTerms({parentPanel:this}).load({params:a,callback:function(d,e,f){var g=[],h=[],k=this.getApiParam("chartType");c||d.sort(function(m,n){return m.getTerm()==n.getTerm()?m.getDocIndex()-n.getDocIndex():m.getTerm().localeCompare(n.getTerm())});d.forEach(function(m,n){var r=
m.get("term"),w=m.get("docIndex"),p=c?this.getApplication().getColorForTerm(r,!0):this.getApplication().getColor(w,!0);m.get("distributions").forEach(function(v,q){g[q]||(g[q]={index:q+1});g[q]["_"+n+"_"+w]="relative"==b?v.toFixed(7):v;g[q]["term"+n]=r},this);"bar"!=k&&("barline"==k?["bar","line"]:[k]).forEach(function(v){h.push({type:"stacked"==v?"bar":v,title:c?r:w+1+") "+r,xField:"index",yField:"_"+n+"_"+w,term:r,colors:[p],label:"barline"==k&&"bar"==v?{display:"none"}:{field:"term"+n}})},this)},
this);if("bar"==k){var l=1===Ext.Array.unique(d.map(function(m){return m.getTerm()})).length;e=d.map(function(m){return 1+m.get("docIndex")+") "+m.getTerm()});d=d.map(function(m){return l?this.getApplication().getColor(m.get("docIndex"),!0):this.getApplication().getColorForTerm(m.getTerm(),!0)},this);h.push({type:"bar",title:0<e.length?e:this.localize("noResults"),colors:d,xField:"index",yField:0<g.length?Object.keys(g[0]).filter(function(m){return"_"==m.charAt(0)}):void 0,label:{field:e}})}d=Ext.create("Ext.data.JsonStore",
{fields:0<g.length?Object.keys(g[0]):void 0,data:g});this.buildChart({store:d,series:h,axes:[{type:"numeric",position:"left",title:{text:this.localize(this.getApiParam("withDistributions")+"Title")}},{type:"category",position:"bottom",title:{text:this.localize("segmentsTitle")+(c?" ("+c.getTitle()+")":"")}}]})},scope:this})}else this.getCorpus().getCorpusTerms({parentPanel:this}).load({params:{limit:this.getApiParam("limit"),stopList:this.getApiParam("stopList")},callback:function(d,e,f){this.setApiParam("query",
d.map(function(g){return g.getTerm()}));this.loadDocumentTerms()},scope:this})},getItemToolTip:function(a,b,c){var d=c.field.split("_"),e=2==d.length?c.index:d[2];d=parseInt(d[1]);var f=c.series.getTitle();f=Ext.isArray(f)?f[d]:f;var g=c.series.getColors();b="\x3cspan class\x3d'x-legend-item-marker' style\x3d'background:"+(1==g.length?g[0]:g[d])+"; left: 2px;'\x3e\x3c/span\x3e \x3cspan style\x3d'padding-left: 1.2em; font-weight: bold;'\x3e"+f+"\x3c/span\x3e: "+b.get(c.field)+"\x3cbr/\x3e\x3ci\x3e"+
this.getCorpus().getDocument(e).getShortTitle()+"\x3c/i\x3e";b="corpus"==this.getApiParam("mode")?b+("\x3cdiv style\x3d'font-size: smaller'\x3e"+this.localize("dblClickItem")):b+("\x3cbr/\x3e"+this.localize("segment")+" "+(c.index+1));a.setHtml(b)},buildChart:function(a){var b=this.getApiParam("chartType"),c=!1;if(!0===this.getApiParam("labels")||"true"==this.getApiParam("labels"))c=!0;Ext.applyIf(a,{cls:this.getApiParam("mode")});a.series.forEach(function(e){Ext.applyIf(e,{stacked:"bar"==e.type?
!1:!0,showInLegend:"barline"==b&&"line"==e.type?!1:!0,smooth:!0,showMarkers:"bar"==e.type?!1:!0,marker:"barline"==b&&"line"==e.type?null:{type:"circle",radius:2},style:{lineWidth:1,fillOpacity:"barline"==b&&"bar"==e.type?.01:1,strokeOpacity:"barline"==b&&"bar"==e.type?.1:1},highlight:!0,highlightCfg:{scaling:"bar"==e.type?1.1:2},label:{},tooltip:{trackMouse:!0,renderer:this.getItemToolTip,scope:this},listeners:{itemclick:function(f,g,h,k){this.clickTimer&&clearTimeout(this.clickTimer);if(!this.blockClick)if(this.blockClick=
!0,Ext.defer(function(){this.blockClick=!1},1E3,this),"document"==this.getApiParam("mode"))f=g.field.split("_"),f=parseInt(f[2]),h=this.getCorpus().getDocument(f).get("tokensCount-lexical"),h=parseInt(g.index*h/parseInt(this.getApiParam("bins"))),this.dispatchEvent("documentIndexTermsClicked",this,[{term:g.series.term,docIndex:f,position:h}]);else{this.clickTimer&&clearTimeout(this.clickTimer);var l=this;this.clickTimer=setTimeout(function(){l.dispatchEvent("documentIndexTermsClicked",l,[{term:g.series.term,
docIndex:g.index}])},300)}},itemdblclick:function(f,g,h,k){this.clickTimer&&clearTimeout(this.clickTimer);this.blockClick=!0;Ext.defer(function(){this.blockClick=!1},1E3,this);"document"!=this.getApiParam("mode")&&Ext.create("Ext.menu.Menu",{items:[{text:this.localize("drillTerm"),tooltip:this.localize("drillTermTip"),handler:function(){this.setApiParams({mode:"document",query:g.series.term});this.loadDocumentTerms()},scope:this},{text:this.localize("drillDocument"),tooltip:this.localize("drillDocumentTip"),
handler:function(){this.setApiParams({mode:"document",docIndex:g.index});this.loadDocumentTerms()},scope:this}],listeners:{hide:function(l){Ext.defer(function(){this.destroy()},200,l)},scope:this}}).showAt(h.pageX,h.pageY)},scope:this}});Ext.applyIf(e.label,{display:"over",field:"index",fontSize:11,translateY:"line"==b?9:void 0});c||(e.label.display="none")},this);Ext.applyIf(a,{animation:!0,plugins:{ptype:"chartitemevents",moveEvents:!0},legend:{docked:"top",listeners:{itemclick:function(e,f,g,h){if(e.getStore().getCount()<
e.chart.series.length&&"barline"==this.getApiParam("chartType")){var k=f.get("name"),l=f.get("disabled");e.chart.series.forEach(function(m){m.getTitle()==k&&m.setHidden(l)});e.chart.redraw()}},scope:this}},interactions:["itemhighlight","crosszoom"],listeners:{}});Ext.applyIf(a.listeners,{itemhighlightchange:function(e,f){e.el.dom.style.cursor=f?"pointer":""},afterrender:function(){},scope:this});a.axes.forEach(function(e){Ext.applyIf(e,{title:{},label:{}});Ext.applyIf(e.title,{scaling:.75});Ext.applyIf(e.label,
{scaling:.75});if("category"==e.type){var f="";a.store.each(function(g){f+=g.get("index")});f.length>this.getTargetEl().getWidth()/9&&Ext.applyIf(e.label,{rotate:{degrees:-30}});Ext.applyIf(e,{labelInSpan:!0})}},this);this.query("chart").forEach(function(e){this.remove(e,!0)},this);var d=Ext.create("Ext.chart.CartesianChart",a);this.add(d)},reloadFromChart:function(){var a=this.down("chart");if(a){var b=[];a.series.forEach(function(c){b.push(c.getTitle())});this.fireEvent("termsClicked",this,b)}},
getExtraDataExportItems:function(){return[{name:"export",inputValue:"dataAsTsv",boxLabel:this.localize("exportGridCurrentTsv")}]},exportDataAsTsv:function(a,b){var c="";b=a.down("chart").getStore();var d=b.first().getData(),e=["Index"],f=[];Object.keys(d).filter(function(h){return 0===h.indexOf("term")}).sort().forEach(function(h){f.push(d[h])});e=e.concat(f);c+=e.join("\t")+"\n";var g=Object.keys(d).filter(function(h){return 0===h.indexOf("_")}).sort();b.each(function(h){d=h.getData();var k=[];void 0!==
d.docTitle?k.push(d.docTitle):k.push(d.index);g.forEach(function(l){k.push(d[l])});c+=k.join("\t")+"\n"},a);Ext.Msg.show({title:a.localize("exportDataTitle"),message:a.localize("exportDataTsvMessage"),buttons:Ext.Msg.OK,icon:Ext.Msg.INFO,prompt:!0,multiline:!0,value:c})}});Ext.define("Voyant.panel.NoTool",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.notool",statics:{i18n:{},api:{tool:void 0}},config:{html:void 0,notYetImplemented:"Centroid DocumentInputAdd DocumentTypeCollocateFrequenciesGrid EntitiesBrowser Equalizer FeatureClusters Flowerbed KwicsTagger Lava Mandala MicroSearch NetVizApplet PaperDrill RezoViz Sunburst Termometer Ticker TokensViz ToolBrowser ToolBrowserLarge VoyeurTagline WordCloud VoyeurTagline WordCountFountain".split(" ")},
...
(d="CollocatesGraph"==d?"Links":"CorpusGrid"==d?"Documents":"CorpusSummary"==d?"Summary":"CorpusTypeFrequenciesGrid"==d?"CorpusTerms":"DocumentInputAdd"==d?"CorpusTerms":"DocumentTypeCollocateFrequenciesGrid"==d?"CorpusTerms":"DocumentTypeFrequenciesGrid"==d?"DocumentTerms":"DocumentTypeKwicsGrid"==d?"Contexts":"TypeFrequenciesChart"==d?"Trends":"VisualCollocator"==d?"Links":"NoTool");return'"xtype":"'+d.toLowerCase()+'"'+("NoTool"==d?',"html":"'+(new Ext.Template(panel.localize("noSuchTool"))).applyTemplate([d])+
...
params:{forTool:"veliza",tool:"corpus.Veliza",script:a.getApiParam("script"),corpus:c}}).then(function(d){(d=Ext.decode(d.responseText))&&d.veliza&&d.veliza.script?(b.setValue(d.veliza.script),b.resetOriginalValue()):d&&d.veliza&&d.veliza.id?a.setApiParam("script",d.veliza.id):a.showError(a.localize("unableFetchScript"));b.unmask()},function(d){a.showError(d)}))},scope:this}}],collapsed:!0,collapsible:!0,flex:1}],dockedItems:[{dock:"bottom",xtype:"toolbar",overflowHandler:"scroller",items:[{xtype:"textfield",
itemId:"chatfield",emptyText:this.localize("typeAndEnter"),flex:1,listeners:{specialkey:function(b,c){c.getKey()==c.ENTER&&(a.handleUserSentence(b.getValue()),b.setValue(""))}}},{xtype:"button",text:this.localize("send"),handler:function(){var b=this.up("toolbar").down("textfield");a.handleUserSentence(b.getValue(),!1);b.setValue("")}},{xtype:"button",text:this.localize("fromCorpus"),handler:function(){a.handleUserSentence("",!0)}}]}]});this.callParent();this.on("boxready",function(b){b.addSentence("fromThem",
"Hello, I'm Veliza, and I'm here to talk to you about your texts (you may know my sister \x3ca href\x3d'https://en.wikipedia.org/wiki/ELIZA' target\x3d'_blank'\x3eEliza\x3c/a\x3e she's a famous psychotherapist). I'm just learning to talk about text documents, but please, let me know about any anxieties you're feeling about your texts. Type a message in the box below and hit enter. Or, if you're feeling playful, hit the \x3ci\x3efrom text\x3c/i\x3e bottom in the lower right-hand corner to fetch a sentence from the corpus.");
...
params:{forTool:"veliza",corpus:d.getCorpus()?d.getCorpus().getId():void 0,tool:"corpus.Veliza",sentence:a,fromCorpus:b?!0:!1,script:e.isDirty()?e.getValue():this.getApiParam("script"),noCache:Ext.id()},success:function(f,g){d.unmask();f=Ext.decode(f.responseText);f.veliza.id&&(d.setApiParam("script",f.veliza.id),e.resetOriginalValue());var h=f.veliza.response;if(g=h.match(/\x3c!-- (.+?) --\x3e/)){g=Ext.decode(g[1]);for(key in g.params)g.params[key]=g.params[key].trim();h+="\x3cbr/\x3e\x3ciframe width\x3d'"+
(g.width?g.width:"100%")+"' height\x3d'"+(g.height?g.height:"250px")+"' src\x3d'"+d.getApplication().getBaseUrl()+"tool/"+g.tool+"/?corpus\x3d"+d.getCorpus().getId()+"\x26minimal\x3dtrue\x26"+Ext.Object.toQueryString(g.params)+"'\x3e\x3c/iframe\x3e"}g=f.veliza.sentence;d.setPrevious(f.veliza.previous);b?(meta=-1<f.veliza.docIndex?d.getCorpus().getDocument(f.veliza.docIndex).getShortLabel():void 0,d.addSentence("myMessage",g,meta),Ext.Function.defer(function(){this.addSentence("fromThem",h);c||this.body.scroll("b",
...
1;a.forTool="topics";var b=this.getApiParam("iterations"),c=Ext.MessageBox.progress({title:this.localize("runningIterations"),message:(new Ext.Template(this.localize("runningIterationsCount"))).apply([b])});Ext.Ajax.request({url:this.getTromboneUrl(),params:a,success:function(d,e){c.close();d=JSON.parse(d.responseText);this.down("#topicsView").getStore().loadData(d.topicModeling.topics.map(function(f,g){var h=f.words.map(function(k){return k.word});f=Object.assign({},f);delete f.words;return[g,h,
0,f]}));d.topicModeling.topicDocuments.sort(function(f,g){f=this.getCorpus().getDocument(f.docId).getIndex();g=this.getCorpus().getDocument(g.docId).getIndex();return f-g}.bind(this));this.down("#docsView").getStore().loadData(d.topicModeling.topicDocuments);this.down("#docsView").refresh()},scope:this})},getColorForTopic:function(a){return this.getApplication().getColor(a)},onQuery:function(a,b){a=this.down("#topicsView");a.getEl().query(".highlighted").forEach(function(g){g.classList.remove("highlighted")});
if(""!==b.trim()){var c=new RegExp(b,"gi"),d=a.getStore(),e=[],f=[];d.each(function(g){for(var h=g.get("terms"),k=[],l=0;l<h.length;l++)-1!==h[l].search(c)&&k.push(l);0<k.length&&e.push(g.get("index"));f.push(k)});0<e.length?(a.setSelection(e.map(function(g){return d.findRecord("index",g)})),a.getNodes().forEach(function(g,h){h=f[h];if(0<h.length){var k=g.querySelectorAll(".term");h.forEach(function(l){k[l].classList.add("highlighted")})}})):(this.setCurrentTopics([]),a.getSelectionModel().deselectAll(!0),
this.down("#docsView").refresh())}else this.setCurrentTopics([]),a.getSelectionModel().deselectAll(!0),this.down("#docsView").refresh()},initialize:function(){this.runIterations()},getExtraDataExportItems:function(){return[{name:"export",inputValue:"dataAsTsv",boxLabel:this.localize("exportGridCurrentTsv")}]},exportDataAsTsv:function(a,b){var c="Topic\t",d="Document Title",e=[],f=this.down("#topicsView").hasCls("showDiagnostics");this.down("#topicsView").getStore().getData().each(function(g,h){0===
h&&(c+=g.get("terms").map(function(k,l){return"Term "+l}).join("\t"),f&&(c+="\t"+Object.keys(g.get("diagnostics")).join("\t")));e.push(g.get("index"));c+="\nTopic "+g.get("index")+"\t"+g.get("terms").join("\t");f&&(c+="\t"+Object.values(g.get("diagnostics")).join("\t"));d+="\tTopic "+g.get("index")+" Weight"});this.down("#docsView").getStore().getData().each(function(g){var h=this.getCorpus().getDocument(g.get("docId")).getTitle(),k=e.map(function(l){l=g.get("weights")[l];return Ext.util.Format.number(100*
l,"00.######")}).join("\t");d+="\n"+h+"\t"+k},this);Ext.create("Ext.window.Window",{title:a.localize("exportDataTitle"),height:290,width:450,bodyPadding:10,layout:{type:"vbox",pack:"start",align:"stretch"},modal:!0,defaults:{margin:"0 0 5px 0"},items:[{html:a.localize("exportDataTsvMessage")},{html:'\x3ctextarea class\x3d"x-form-text-default x-form-textarea" style\x3d"height: 76px; width: 100%"\x3e'+c+"\x3c/textarea\x3e"},{html:'\x3ctextarea class\x3d"x-form-text-default x-form-textarea" style\x3d"height: 76px; width: 100%"\x3e'+
d+"\x3c/textarea\x3e"}],buttonAlign:"center",buttons:[{text:"OK",handler:function(g){g.up("window").close()}}]}).show()}});Ext.define("Voyant.panel.Via",{extend:"Ext.panel.Panel",mixins:["Voyant.panel.Panel"],alias:"widget.via",statics:{i18n:{},api:{stopList:"auto",limit:100,docIndex:void 0},glyph:"xf06e@FontAwesome"},config:{mode:void 0,options:[{xtype:"stoplistoption"},{xtype:"listeditor",name:"whiteList"},{xtype:"categoriesoption"}]},layout:"fit",constructor:function(a){this.callParent(arguments);this.mixins["Voyant.panel.Panel"].constructor.apply(this,arguments)},initComponent:function(a){Ext.apply(this,{title:this.localize("title"),
...
outlineApi:"Here is a list of the Spyral classes that can be used in your notebook:",loadingDocs:"Loading Docs",copyToClipboard:"Copy Example to Clipboard",goBack:"Go Back",goForward:"Go Forward"}},history:[],historyPos:-1,inlineDocsUrl:void 0,fullDocsUrl:void 0,constructor:function(a){this.mixins["Voyant.util.Localization"].constructor.apply(this,arguments);a=a||{};Ext.apply(a,{dockedItems:[{itemId:"toolbar",xtype:"toolbar",dock:"top",items:[{itemId:"navBtn",glyph:"xf0c9@FontAwesome",menu:{items:[{text:this.localize("home"),
glyph:"xf015@FontAwesome",handler:function(b){this.showDocs()}.bind(this)},{text:this.localize("classes"),itemId:"classesMenu",glyph:"xf02d@FontAwesome",menu:{items:[],listeners:{click:function(b,c){this.loadDocsEntry("Spyral."+c.itemId+".html")},scope:this}}},{text:this.localize("tools"),itemId:"toolsMenu",glyph:"xf0ad@FontAwesome",menu:{items:[],listeners:{click:function(b,c){this.loadDocsEntry("Tools."+c.itemId+".html")},scope:this}}},{text:this.localize("globals"),itemId:"globalsMenu",glyph:"xf0ad@FontAwesome",
menu:{items:[],listeners:{click:function(b,c){this.loadDocsEntry("window.html#"+c.itemId)},scope:this}}}]}},{itemId:"backBtn",tooltip:this.localize("goBack"),glyph:"xf060@FontAwesome",disabled:!0,handler:function(b){this._goBack()}.bind(this)},{itemId:"forwardBtn",tooltip:this.localize("goForward"),glyph:"xf061@FontAwesome",disabled:!0,handler:function(b){this._goForward()}.bind(this)}," ",{text:this.localize("overview"),itemId:"overviewBtn",glyph:"xf05a@FontAwesome",handler:function(b){this._showDocEntry()}.bind(this)},
{text:this.localize("methods"),itemId:"methodsBtn",glyph:"xf1b2@FontAwesome",menu:{items:[],listeners:{click:function(b,c){c&&(b=c.itemId.replace(/^_/,""),this._showDocEntry(this.history[this.history.length-1][0],b))},scope:this}}},{text:this.localize("configs"),itemId:"configsBtn",glyph:"xf013@FontAwesome",width:100,menu:{items:[],listeners:{click:function(b,c){c&&this._showDocEntry(this.history[this.history.length-1][0],c.itemId)},scope:this}}},"-\x3e",{tooltip:this.localize("openFull"),itemId:"openfullBtn",
glyph:"xf128@FontAwesome",handler:function(b){this.openFullDocumentation()}.bind(this)}]}],layout:"fit",items:[{itemId:"main",cls:"docsWindowContent",scrollable:"y",html:""}],listeners:{boxready:function(b){b.body.addListener("click",function(c){if("a"===c.target.tagName.toLowerCase()){c.preventDefault();c.stopPropagation();var d=c.target.getAttribute("href");c=c.target.getAttribute("rel");this.handleDocLink(d,c)}},this)},scope:this}});this.callParent([a]);this.inlineDocsUrl=Voyant.application.getBaseUrlFull()+
"docs/inline/";this.fullDocsUrl=Voyant.application.getBaseUrlFull()+"docs/";this._populateNavMenu("classesMenu","Spyral.html");this._populateNavMenu("toolsMenu","Tools.html");this._populateNavMenu("globalsMenu","window.html")},showDocs:function(){this.history=[];this.historyPos=-1;this._updateNavBtns();this.up().setTitle(this.localize("docs")+" "+this.localize("home"));this.down("#overviewBtn").hide();this.down("#methodsBtn").hide();this.down("#configsBtn").hide();var a="\x3cp\x3e"+this.localize("outlineIntro")+
"\x3c/p\x3e";this._setHtmlForCard("main",a);this.up().show().expand();this._resetScrollTop()},handleDocLink:function(a,b){console.log("handleDocLink",a,b);null!==b&&"opener"!==b&&(a=a.replace(/^https:\/\/voyant-tools.org\//,""));0===a.indexOf("spyral")?(a=a.replace(/^spyral\//,"").replace(/\/$/,"").replace(/\//,"_"),b=this.findParentByType("notebook"),b.fireEvent("notebookSelected",b,a,null)):0===a.indexOf("http")?window.open(a,"_external"):0===a.indexOf("tutorial")||"help"===b?window.open(this.fullDocsUrl+
a,"_spyral_docs"):(this.up().show().expand(),this.loadDocsEntry(a))},openFullDocumentation:function(){var a=this.fullDocsUrl,b=this.history[this.historyPos];void 0!==b&&(a+=b[0]);void 0!==b[1]&&(a+="#"+b[1]);window.open(a,"_spyral_docs")},loadDocsEntry:function(a,b){var c=a.split("#");console.log("loadDocsEntry",a,"member",c[1]);void 0===b&&this._addToHistory(c[0],c[1]);this.getLayout().getRenderTarget().mask(this.localize("loadingDocs"));Ext.Ajax.request({url:this.inlineDocsUrl+c[0]}).then(function(d){this.getLayout().getRenderTarget().unmask();
this._processDocEntry(d.responseText);c[1]&&this._showDocEntry(c[0],c[1],!0);this._resetScrollTop()}.bind(this),function(d){void 0===b&&this.history.pop();this.getLayout().getRenderTarget().unmask();console.log(d)}.bind(this))},_processDocEntry:function(a){var b=(new DOMParser).parseFromString(a,"text/html"),c=null===b.querySelector("header h2 .ancestors"),d=!1;c||(d="Tools"===b.querySelector("header h2 .ancestors a").textContent);var e="";e=c?b.querySelector("h2").textContent:b.querySelector("h2 .ancestors").textContent+
b.querySelector("h2 .ancestors").nextSibling.textContent;this.up().setTitle(this.localize("docs")+": "+e);this._setHtmlForCard("main",a);this.down("#overviewBtn").show();a=this.down("#main").getEl().dom;a.querySelectorAll("article \x3e *").forEach(function(k){k.hidden=!c&&!d});b=Array.from(a.querySelectorAll("article \x3e dl.methods \x3e dt \x3e h4")).map(function(k){return k.getAttribute("id")});c||d||null===a.querySelector("article .container-overview")||b.unshift("constructor");e=this.down("#methodsBtn");
if(0<b.length){var f=e.getMenu(),g=[];f.items.eachKey(function(k){g.push(k)});g.forEach(function(k){f.remove(k)});b.forEach(function(k){var l=k.replace(/^\./,'\x3cspan class\x3d"green icon"\x3estatic\x3c/span\x3e ');l=l.replace(/^_/,"");f.add({text:l,itemId:"_"+k,margin:"0 0 0 -20px"})});e.show()}else e.hide();b=Array.from(a.querySelectorAll("article \x3e dl.typedefs \x3e dt \x3e h4")).map(function(k){return k.getAttribute("id")});e=this.down("#configsBtn");if(0<b.length){var h=e.getMenu();g=[];h.items.eachKey(function(k){g.push(k)});
g.forEach(function(k){h.remove(k)});b.forEach(function(k){h.add({text:k,itemId:k,margin:"0 0 0 -20px"})});e.show()}else e.hide();a.querySelectorAll("article .container-overview pre").forEach(function(k){Ext.fly(k).insertHtml("afterBegin",'\x3cbutton class\x3d"copyToClipboard" title\x3d"'+this.localize("copyToClipboard")+'"\x3e\x3ci class\x3d"fa fa-clipboard" aria-hidden\x3d"true"\x3e\x3c/i\x3e\x3c/button\x3e',!0).on("click",this._copyToClipboard,this)},this)},_showDocEntry:function(a,b,c){console.log("showDocEntry",
a,"member",b);void 0===c&&this._addToHistory(a,b);a=this.down("#main").getEl().dom;var d=null===a.querySelector("header h2 .ancestors");a.querySelectorAll("article \x3e *").forEach(function(e){e.hidden=!d});void 0===b?a.querySelector("header").hidden=!1:"constructor"===b?(a.querySelector("header").hidden=!0,a.querySelector("article \x3e .container-overview").hidden=!1):(a.querySelector("header").hidden=!0,b=a.querySelector("#"+b.replace(".","\\.").replace("~","\\~")).parentElement,a=b.closest("dl"),
a.children.forEach(function(e){e.hidden=!0}),b.hidden=!1,b.nextElementSibling.hidden=!1,a.hidden=!1);this._resetScrollTop()},_setHtmlForCard:function(a,b){this.down("#"+a).setHtml(b);a=this.down("#"+a).getEl().dom;Ext.fly(a).selectable()},_populateNavMenu:function(a,b){Ext.Ajax.request({url:this.inlineDocsUrl+b}).then(function(c){c=(new DOMParser).parseFromString(c.responseText,"text/html").querySelector("article \x3e dl:first-of-type");var d=[];d=-1!==c.className.indexOf("methods")?Array.from(c.querySelectorAll("h4")).map(function(e){return{text:e.id.replace(/^\./,
'\x3cspan class\x3d"green icon"\x3estatic\x3c/span\x3e '),itemId:e.id,margin:"0 0 0 -20px"}}):Array.from(c.querySelectorAll("a")).map(function(e){return{text:e.textContent,itemId:e.textContent,margin:"0 0 0 -20px"}});this.down("#"+a).getMenu().add(d)}.bind(this))},_resetScrollTop:function(){this.down("#main").body.scrollTo("top",0,!1)},_copyToClipboard:function(a,b){navigator.clipboard.writeText(("BUTTON"===b.nodeName?b:b.parentElement).nextElementSibling.innerText)},_addToHistory:function(a,b){50<=
this.history.length&&this.history.shift();this.history.splice(this.historyPos+1,this.history.length-this.historyPos,[a,b]);console.log(JSON.stringify(this.history));this.historyPos=this.history.length-1;this._updateNavBtns()},_goBack:function(){this.historyPos=Math.max(0,this.historyPos-1);this._loadEntryFromHistoryPos()},_goForward:function(){this.historyPos=Math.min(this.history.length-1,this.historyPos+1);this._loadEntryFromHistoryPos()},_loadEntryFromHistoryPos:function(){var a=this.history[this.historyPos];
a&&this.loadDocsEntry(a[0]+(a[1]?"#"+a[1]:""),!0);this._updateNavBtns()},_updateNavBtns:function(){this.down("#backBtn").setDisabled(0>=this.historyPos);this.down("#forwardBtn").setDisabled(this.historyPos>=this.history.length-1)}});Ext.define("Voyant.notebook.Catalogue",{extend:"Ext.Component",mixins:["Voyant.util.Localization","Voyant.notebook.util.NotebooksList"],alias:"widget.notebookcatalogue",statics:{i18n:{title:"Spyral Notebooks Catalogue",browse:"Browse Notebooks",keywords:"Keywords",author:"Author",language:"Language",license:"License",search:"Search within notebooks",noResults:"No matching notebooks",suggested:"Suggested Notebooks",load:"Open Selected Notebook",new:"New Notebook",close:"Close"}},window:void 0,gettingFacets:!1,
...
{i18n:"moreToolsScaleDocument",glyph:"xf066@FontAwesome",items:"bubbles cirrus contexts documentterms reader textualarc trends knots topics".split(" ")},{i18n:"moreToolsTypeViz",glyph:"xf06e@FontAwesome",items:"cirrus bubblelines bubbles constellation links dreamscape loom knots mandala microsearch streamgraph scatterplot textualarc trends termsberry termsradio wordtree".split(" ")},{i18n:"moreToolsTypeGrid",glyph:"xf0ce@FontAwesome",items:"corpusterms corpuscollocates correlations phrases contexts documentterms documents topics".split(" ")},
...
Ext.define("Voyant.VoyantCorpusToolsetApp",{extend:"Voyant.VoyantCorpusApp",requires:["Voyant.panel.Contexts","Voyant.panel.Links","Voyant.panel.Trends"],name:"VoyantCorpusToolsetApp",launch:function(){Ext.create("Ext.container.Viewport",{layout:"border",items:[{region:"south",xtype:"voyantfooter"},{xtype:"tabpanel",region:"center",split:!0,items:[{xtype:"cirrus",collapsible:!0},{xtype:"corpusterms",collapsible:!0},{xtype:"documents",collapsible:!0},{xtype:"rezoviz",collapsible:!0},{xtype:"trends",
...
itemId:"toolsContainer-main",items:{xtype:c}}]}]});"true"===this.getShowServerMessage()&&this.getServerMessage();this.callParent(arguments)},getServerMessage:function(){var a=this.getServerMessageURL();$.get("trombone",{fetchData:a,forTool:"ServerMessage"},function(b){b=(new showdown.Converter).makeHtml(b);b=DOMPurify.sanitize(b);$("#voyantServerMessage").html(b)},"text").fail(function(){console.log("failed to fetch server message")})}});Ext.define("Voyant.panel.MoreLikeThis",{extend:"Ext.panel.Panel",alias:"widget.morelikethis",title:"More Like this"});
Ext.define("Voyant.VoyantDocumentToolsetApp",{extend:"Voyant.VoyantCorpusApp",requires:["Voyant.panel.Contexts","Voyant.panel.Links","Voyant.panel.Trends"],name:"VoyantDocumentToolsetApp",launch:function(){Ext.create("Ext.container.Viewport",{layout:"border",items:[{region:"south",xtype:"voyantfooter"},{xtype:"tabpanel",region:"center",split:!0,items:[{xtype:"cirrus",collapsible:!0},{xtype:"documentterms",collapsible:!0},{xtype:"contexts",collapsible:!0},{xtype:"links",collapsible:!0},{xtype:"trends",
collapsible:!0},{xtype:"morelikethis",collapsible:!0}],flex:6}]});this.callParent(arguments)}});Ext.define("Voyant.VoyantNotebookApp",{extend:"Voyant.VoyantApp",requires:["Voyant.panel.VoyantFooter","Voyant.notebook.Notebook","Voyant.data.model.Corpus"],name:"VoyantNotebookApp",launch:function(){Ext.create("Ext.container.Viewport",{layout:"border",items:[{xtype:"notebook",region:"center"},{xtype:"voyantfooter",region:"south"}]});this.callParent(arguments)}});Ext.define("Voyant.VoyantToolApp",{extend:"Voyant.VoyantCorpusApp",name:"VoyantToolApp",statics:{api:{minimal:void 0,embeddedApiId:void 0}},launch:function(){var a=[],b=this;this.getApiParam("minimal")||a.push({region:"south",xtype:"voyantfooter"});a.push({region:"center",layout:"fit",itemId:"toolcontainer",items:{xtype:this.getApiParam("embeddedApiId")?"container":this.getTool()},listeners:{afterrender:function(c){if(b.getApiParam("embeddedApiId")){var d=new Ext.Deferred;c.mask(this.localize("loadingConfiguration"));
...
//# sourceMappingURL=voyant.9eda2fb805c18edf0d35de14d746ebed.min.js.map